...
// lid: 256 1 1
// Original:
// X_T316[n, x0, x1, c : _T467, _T468, _T469, _T470] = +(X_T248[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T316[n, x0, x1, c : _T467, _T468, _T469, _T470] = +(X_T248[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c42_sdk_106(__global float* restrict  X_T316, __global const float* restrict  in1)
{
