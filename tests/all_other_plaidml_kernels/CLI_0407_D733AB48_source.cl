...
// lid: 256 1 1
// Original:
// X_T1029[n0, n1, n2, 800 + a : _T1421, _T1422, _T1423, _T1424] = =(X_T1028[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1029[n0, n1, n2, 800 + a : _T1421, _T1422, _T1423, _T1424] = =(X_T1028[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c124_sdk_340(__global float* restrict  X_T1029, __global const float* restrict  in1)
{
  X_T1029 = (X_T1029 + 800);
