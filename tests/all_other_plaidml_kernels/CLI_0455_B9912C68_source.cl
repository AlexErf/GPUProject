...
// lid: 256 1 1
// Original:
// X_T1321[n0, n1, n2, 1184 + a : _T1865, _T1866, _T1867, _T1868] = =(X_T1320[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1321[n0, n1, n2, 1184 + a : _T1865, _T1866, _T1867, _T1868] = =(X_T1320[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c108_sdk_448(__global float* restrict  X_T1321, __global const float* restrict  in1)
{
  X_T1321 = (X_T1321 + 1184);
