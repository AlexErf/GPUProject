...
// lid: 256 1 1
// Original:
// X_T376[n0, n1, n2, 256 + a : _T465, _T466, _T467, _T468] = =(X_T375[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T376[n0, n1, n2, 256 + a : _T465, _T466, _T467, _T468] = =(X_T375[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= a < 32, 0 <= 256 + a < 288, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c108_sdk_109(__global float* restrict  X_T376, __global const float* restrict  in1)
{
  X_T376 = (X_T376 + 256);
  ...
  for (int n1_lid = 0; n1_lid < 4; n1_lid += 1)
  {
    ...
    {
      int n1 = ((8 * n1_lid) + n1_tid);
      float LX_T376 = agg[n1_lid];
      int gout_idx = ((a_tid + (8064 * n1)) + (288 * n2_gid));
      X_T376[gout_idx] = LX_T376;
    }
  }
}
