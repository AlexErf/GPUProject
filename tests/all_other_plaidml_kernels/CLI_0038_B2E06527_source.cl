...
// Ranges: { 13824 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(3, 3, 1536, 1):(4608, 1536, 1, 1):54 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 512 }
// Contraction output var shape: fp32(3, 3, 1536, 1):(4608, 1536, 1, 1):54 KiB
...
__kernel void kernel_c23_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i1_i2_i3_i4_lid = 0; i1_i2_i3_i4_lid < 2; i1_i2_i3_i4_lid += 1)
  {
    ...
    float LX_T8 = (0.041653111577034f * LX_T7);
    float LX_T9 = (-0.020826555788517f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
