...
// Ranges: { 131072 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 512, 256):(131072, 131072, 256, 1):512 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 4096 }
// Contraction output var shape: fp32(1, 1, 512, 256):(131072, 131072, 256, 1):512 KiB
...
// lwork = 256, 1, 1
// gwork = 8192, 1, 1
__kernel void kernel_c32_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
