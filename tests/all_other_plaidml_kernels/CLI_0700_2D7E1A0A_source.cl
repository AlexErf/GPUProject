...
// lid: 256 1 1
// Original:
// X_T2324[n0, n1, n2, 1536 + a : _T3339, _T3340, _T3341, _T3342] = =(X_T2323[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2324[n0, n1, n2, 1536 + a : _T3339, _T3340, _T3341, _T3342] = =(X_T2323[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1536 + a < 1568, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2324[n0, n1, n2, 1536 + a : _T3339, _T3340, _T3341, _T3342] = =(X_T2323[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2324   X_T2323  
//        a        32         1         1  
//       n1         7     10976       224  
//       n2         7      1568        32  
//      off                1536         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_805(__global float* restrict  X_T2324, __global const float* restrict  in1)
{
  X_T2324 = (X_T2324 + 1536);
  ...
  if (n2_cond)
  {
    float LX_T2324 = agg[0];
    int gout_idx = ((a_tid + (10976 * n1_gid)) + (1568 * n2_tid));
    X_T2324[gout_idx] = LX_T2324;
  }
}
