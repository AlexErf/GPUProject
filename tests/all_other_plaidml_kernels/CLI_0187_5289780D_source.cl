...
// lid: 256 1 1
// Original:
// X_T1258[n0, n1, n2, a : _T1965, _T1966, _T1967, _T1968] = =(X_T1257[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1258[n0, n1, n2, a : _T1965, _T1966, _T1967, _T1968] = =(X_T1257[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88, 0 <= a < 352, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88 }
// Defracted:
// X_T1258[n0, n1, n2, a : _T1965, _T1966, _T1967, _T1968] = =(X_T1257[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1258   X_T1257  
//        a        88         1         1  
//       n1        14      4928      1232  
//       n2        14       352        88  
//      off                   0         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c42_sdk_471(__global float* restrict  X_T1258, __global const float* restrict  in1)
{
