...
// Ranges: { 56448 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(1, 1, 336, 168):(56448, 56448, 168, 1):220.5 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 256 }
// Contraction output var shape: fp32(1, 1, 336, 168):(56448, 56448, 168, 1):220.5 KiB
// Computed true ops: 56448
// Computed work groups: 221
...
__kernel void kernel_c19_sdk_0(__global float* restrict  X_T0, __global const float* restrict  X_I_0)
{
  ...
  int i3_i4_cond = ((i3_i4_gid != 56320) || (i3_i4_tid < 128));
  if (i3_i4_cond)
  {
