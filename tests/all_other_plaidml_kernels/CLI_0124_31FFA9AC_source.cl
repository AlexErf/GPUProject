...
// lid: 256 1 1
// Original:
// X_T135[n0, n1, n2, 128 + a : _T137, _T138, _T139, _T140] = =(X_T134[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T135[n0, n1, n2, 128 + a : _T137, _T138, _T139, _T140] = =(X_T134[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_31(__global float* restrict  X_T135, __global const float* restrict  in1)
{
  X_T135 = (X_T135 + 128);
  ...
  {
    int n1 = ((4 * n1_lid) + n1_tid);
    float LX_T135 = agg[n1_lid];
    int gout_idx = ((a_tid + (8960 * n1)) + (160 * (n2_gid + n2_tid)));
    X_T135[gout_idx] = LX_T135;
  }
}
