...
// lid: 256 1 1
// Original:
// X_T603[n0, n1, n2, a : _T834, _T835, _T836, _T837] = =(X_T602[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T603[n0, n1, n2, a : _T834, _T835, _T836, _T837] = =(X_T602[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 14, 1
__kernel void kernel_c68_sdk_198(__global float* restrict  X_T603, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 3; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T603 = agg[a_lid];
      int gout_idx = ((a + (4928 * (n1_gid + n1_tid))) + (352 * n2_gid));
      X_T603[gout_idx] = LX_T603;
    }
  }
}
