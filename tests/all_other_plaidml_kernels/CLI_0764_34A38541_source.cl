...
// lid: 256 1 1
// Original:
// X_T2626[i, 0 : _T3768, _T3769] = >(X_T2615[i, j])
// With Index Variables Made Integral:
// X_T2626[i, 0 : _T3768, _T3769] = >(X_T2615[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c124_sdk_910(__global float* restrict  X_T2626, __global const float* restrict  in1)
{
  ...
  if ((tid < 1))
  {
    float LX_T2626 = agg[0];
    LX_T2626 = select((float)LX_T2626, (float)0, (int)(LX_T2626 == (float)-FLT_MAX));
    X_T2626[0] = LX_T2626;
  }
}
