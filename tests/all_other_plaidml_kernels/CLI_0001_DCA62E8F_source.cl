...
// Ranges: { 1728 }
// Out stride: { 1 }
// Elementwise input X_T6 shape: fp32(3, 3, 3, 64):(576, 192, 64, 1):6.75 KiB
// Elementwise op: [[pid(RevMul)]] X_T7 = mul(X_T5, X_T6)
// Elementwise op: [[pid(Add)]] X_T8 = add(X_T4, X_T7)
// Tile size: { 256 }
// Contraction output var shape: fp32(3, 3, 3, 64):(576, 192, 64, 1):6.75 KiB
...
__kernel void kernel_c1_sdk_1(__global float* restrict  X_T8, __global const float* restrict  X_T6)
{
  ...
  if (i1_i2_i3_i4_cond)
  {
    ...
    float LX_T7 = (0.1995018720626831f * LX_T6);
    float LX_T8 = (-0.09975093603134155f + LX_T7);
    X_T8[gout_idx] = LX_T8;
  }
}
