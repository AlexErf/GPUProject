...
// lid: 256 1 1
// Original:
// X_T1140[i, 0 : _T1615, _T1616] = >(X_T1119[i, j])
// With Index Variables Made Integral:
// X_T1140[i, 0 : _T1615, _T1616] = >(X_T1119[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c56_sdk_394(__global float* restrict  X_T1140, __global const float* restrict  in1)
{
  ...
  if ((tid < 1))
  {
    float LX_T1140 = agg[0];
    LX_T1140 = select((float)LX_T1140, (float)0, (int)(LX_T1140 == (float)-FLT_MAX));
    X_T1140[0] = LX_T1140;
  }
}
