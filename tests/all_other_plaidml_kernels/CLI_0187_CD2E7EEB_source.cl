...
// lid: 256 1 1
// Original:
// X_T1605[n0, n1, n2, a : _T2521, _T2522, _T2523, _T2524] = =(X_T1604[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1605[n0, n1, n2, a : _T2521, _T2522, _T2523, _T2524] = =(X_T1604[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= a < 336, 0 <= a < 1344, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= a < 336 }
// Defracted:
// X_T1605[n0, n1, n2, a : _T2521, _T2522, _T2523, _T2524] = =(X_T1604[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1605   X_T1604  
//        a       336         1         1  
//       n1        21     28224      7056  
//       n2        21      1344       336  
//      off                   0         0  
...
// lwork = 256, 1, 1
// gwork = 768, 11, 11
__kernel void kernel_c42_sdk_609(__global float* restrict  X_T1605, __global const float* restrict  in1)
{
