...
// lid: 256 1 1
// Original:
// X_T929[n0, n1, n2, 672 + a : _T1273, _T1274, _T1275, _T1276] = =(X_T928[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T929[n0, n1, n2, 672 + a : _T1273, _T1274, _T1275, _T1276] = =(X_T928[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c124_sdk_304(__global float* restrict  X_T929, __global const float* restrict  in1)
{
  X_T929 = (X_T929 + 672);
