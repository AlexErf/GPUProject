...
// lid: 256 1 1
// Original:
// X_T2424[n0, n1, n2, 1664 + a : _T3487, _T3488, _T3489, _T3490] = =(X_T2423[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2424[n0, n1, n2, 1664 + a : _T3487, _T3488, _T3489, _T3490] = =(X_T2423[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1664 + a < 1696, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2424[n0, n1, n2, 1664 + a : _T3487, _T3488, _T3489, _T3490] = =(X_T2423[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2424   X_T2423  
//        a        32         1         1  
//       n1         7     11872       224  
//       n2         7      1696        32  
//      off                1664         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_841(__global float* restrict  X_T2424, __global const float* restrict  in1)
{
  X_T2424 = (X_T2424 + 1664);
  ...
  if (n2_cond)
  {
    float LX_T2424 = agg[0];
    int gout_idx = ((a_tid + (11872 * n1_gid)) + (1696 * n2_tid));
    X_T2424[gout_idx] = LX_T2424;
  }
}
