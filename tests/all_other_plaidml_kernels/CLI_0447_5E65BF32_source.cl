...
// lid: 256 1 1
// Original:
// X_T1571[n0, n1, n2, 992 + a : _T2266, _T2267, _T2268, _T2269] = =(X_T1570[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1571[n0, n1, n2, 992 + a : _T2266, _T2267, _T2268, _T2269] = =(X_T1570[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_544(__global float* restrict  X_T1571, __global const float* restrict  in1)
{
  X_T1571 = (X_T1571 + 992);
  ...
  if (n2_cond)
  {
    float LX_T1571 = agg[0];
    int gout_idx = ((a_tid + (7168 * n1_gid)) + (1024 * n2_tid));
    X_T1571[gout_idx] = LX_T1571;
  }
}
