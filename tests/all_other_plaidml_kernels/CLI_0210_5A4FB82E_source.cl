...
// lid: 256 1 1
// Original:
// X_T506[n0, n1, n2, 448 + a : _T687, _T688, _T689, _T690] = =(X_T505[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T506[n0, n1, n2, 448 + a : _T687, _T688, _T689, _T690] = =(X_T505[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_163(__global float* restrict  X_T506, __global const float* restrict  in1)
{
  X_T506 = (X_T506 + 448);
  ...
  for (int n1_lid = 0; n1_lid < 4; n1_lid += 1)
  {
    ...
    {
      int n1 = ((8 * n1_lid) + n1_tid);
      float LX_T506 = agg[n1_lid];
      int gout_idx = ((a_tid + (13440 * n1)) + (480 * n2_gid));
      X_T506[gout_idx] = LX_T506;
    }
  }
}
