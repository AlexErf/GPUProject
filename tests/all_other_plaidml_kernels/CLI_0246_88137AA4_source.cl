...
// lid: 256 1 1
// Original:
// X_T2224[n0, n1, n2, 176 + a : _T3523, _T3524, _T3525, _T3526] = =(X_T2223[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2224[n0, n1, n2, 176 + a : _T3523, _T3524, _T3525, _T3526] = =(X_T2223[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 176, 0 <= 176 + a < 704, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 768, 7, 1
__kernel void kernel_c42_sdk_850(__global float* restrict  X_T2224, __global const float* restrict  in1)
{
  X_T2224 = (X_T2224 + 176);
