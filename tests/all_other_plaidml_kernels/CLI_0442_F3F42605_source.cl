...
// lid: 256 1 1
// Original:
// X_T1546[n0, n1, n2, 960 + a : _T2229, _T2230, _T2231, _T2232] = =(X_T1545[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1546[n0, n1, n2, 960 + a : _T2229, _T2230, _T2231, _T2232] = =(X_T1545[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_535(__global float* restrict  X_T1546, __global const float* restrict  in1)
{
  X_T1546 = (X_T1546 + 960);
  ...
  if (n2_cond)
  {
    float LX_T1546 = agg[0];
    int gout_idx = ((a_tid + (6944 * n1_gid)) + (992 * n2_tid));
    X_T1546[gout_idx] = LX_T1546;
  }
}
