...
// lid: 256 1 1
// Original:
// X_T1098[n0, n1, n2, a : _T1537, _T1538, _T1539, _T1540] = =(X_T1097[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1098[n0, n1, n2, a : _T1537, _T1538, _T1539, _T1540] = =(X_T1097[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 29, 1
__kernel void kernel_c108_sdk_369(__global float* restrict  X_T1098, __global const float* restrict  in1)
{
