...
// lid: 256 1 1
// Original:
// X_T1566[n0, n1, n2, 832 + a : _T2229, _T2230, _T2231, _T2232] = =(X_T1565[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1566[n0, n1, n2, 832 + a : _T2229, _T2230, _T2231, _T2232] = =(X_T1565[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_535(__global float* restrict  X_T1566, __global const float* restrict  in1)
{
  X_T1566 = (X_T1566 + 832);
