...
// lid: 256 1 1
// Original:
// X_T1346[n0, n1, n2, 1216 + a : _T1902, _T1903, _T1904, _T1905] = =(X_T1345[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1346[n0, n1, n2, 1216 + a : _T1902, _T1903, _T1904, _T1905] = =(X_T1345[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c108_sdk_457(__global float* restrict  X_T1346, __global const float* restrict  in1)
{
  X_T1346 = (X_T1346 + 1216);
