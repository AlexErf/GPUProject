...
// lid: 256 1 1
// Original:
// X_T31[n, x0, x1, co : _T2, _T3, _T4, _T5] = +(X_I_52[n, k0 + 2*x0, k1 + 2*x1, ci] * X_I_53[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T31[n, x0, x1, co : _T2, _T3, _T4, _T5] = +(X_I_52[n, k0 + 2*x0, k1 + 2*x1, ci] * X_I_53[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise input X_I_51 shape: fp32(32):(1):128 bytes
// Elementwise op: [[pid(Sub)]] X_T32 = sub(X_T31, X_I_51)
...
// lwork = 256, 1, 1
// gwork = 2560, 19, 1
__kernel void kernel_c56_sdk_0(__global float* restrict  X_T32, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_51)
{
