...
// lid: 256 1 1
// Original:
// X_T334[n0, n1, n2, 192 + a : _T391, _T392, _T393, _T394] = =(X_T333[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T334[n0, n1, n2, 192 + a : _T391, _T392, _T393, _T394] = =(X_T333[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= a < 32, 0 <= 192 + a < 224, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c124_sdk_91(__global float* restrict  X_T334, __global const float* restrict  in1)
{
  X_T334 = (X_T334 + 192);
  ...
  for (int n1_lid = 0; n1_lid < 4; n1_lid += 1)
  {
    ...
    {
      int n1 = ((8 * n1_lid) + n1_tid);
      float LX_T334 = agg[n1_lid];
      int gout_idx = ((a_tid + (6272 * n1)) + (224 * n2_gid));
      X_T334[gout_idx] = LX_T334;
    }
  }
}
