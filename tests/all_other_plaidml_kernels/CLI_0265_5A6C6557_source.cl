...
// lid: 256 1 1
// Original:
// X_T3036[n0, n1, n2, a : _T4840, _T4841, _T4842, _T4843] = =(X_T3033[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T3036[n0, n1, n2, a : _T4840, _T4841, _T4842, _T4843] = =(X_T3033[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 11, 0 <= n2 < 11, 0 <= n1 < 11, 0 <= n2 < 11, 0 <= a < 336, 0 <= a < 672, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 11, 0 <= n2 < 11, 0 <= a < 336 }
// Defracted:
// X_T3036[n0, n1, n2, a : _T4840, _T4841, _T4842, _T4843] = =(X_T3033[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T3036   X_T3033  
//        a       336         1         1  
//       n1        11      7392      3696  
//       n2        11       672       336  
//      off                   0         0  
...
// lwork = 256, 1, 1
// gwork = 2816, 11, 1
__kernel void kernel_c42_sdk_1176(__global float* restrict  X_T3036, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 2; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T3036 = agg[a_lid];
      int gout_idx = ((a + (7392 * n1_gid)) + (672 * n2_gid));
      X_T3036[gout_idx] = LX_T3036;
    }
  }
}
