...
// lid: 256 1 1
// Original:
// X_T1414[n, x0, x1, c : _T2214, _T2215, _T2216, _T2217] = +(X_T1200[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 1, k1 < 1
// With Index Variables Made Integral:
// X_T1414[n, x0, x1, c : _T2214, _T2215, _T2216, _T2217] = +(X_T1200[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 1, k1 < 1, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 9, 1
__kernel void kernel_c42_sdk_532(__global float* restrict  X_T1414, __global const float* restrict  in1)
{
