...
// lid: 256 1 1
// Original:
// X_T2143[n0, n1, n2, a : _T3085, _T3086, _T3087, _T3088] = =(X_T2142[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2143[n0, n1, n2, a : _T3085, _T3086, _T3087, _T3088] = =(X_T2142[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c108_sdk_744(__global float* restrict  X_T2143, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 7; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T2143 = agg[a_lid];
      int gout_idx = ((a + (11424 * n1_gid)) + (1632 * n2_gid));
      X_T2143[gout_idx] = LX_T2143;
    }
  }
}
