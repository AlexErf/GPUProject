...
// lid: 256 1 1
// Original:
// X_T898[n0, n1, n2, a : _T1241, _T1242, _T1243, _T1244] = =(X_T897[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T898[n0, n1, n2, a : _T1241, _T1242, _T1243, _T1244] = =(X_T897[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 21, 1
__kernel void kernel_c108_sdk_297(__global float* restrict  X_T898, __global const float* restrict  in1)
{
