...
// lid: 256 1 1
// Original:
// X_T1999[n0, n1, n2, 1120 + a : _T2858, _T2859, _T2860, _T2861] = =(X_T1998[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1999[n0, n1, n2, 1120 + a : _T2858, _T2859, _T2860, _T2861] = =(X_T1998[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_688(__global float* restrict  X_T1999, __global const float* restrict  in1)
{
  X_T1999 = (X_T1999 + 1120);
