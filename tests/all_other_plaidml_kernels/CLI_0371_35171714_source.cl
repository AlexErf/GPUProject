...
// lid: 256 1 1
// Original:
// X_T879[n0, n1, n2, 608 + a : _T1199, _T1200, _T1201, _T1202] = =(X_T878[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T879[n0, n1, n2, 608 + a : _T1199, _T1200, _T1201, _T1202] = =(X_T878[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c124_sdk_286(__global float* restrict  X_T879, __global const float* restrict  in1)
{
  X_T879 = (X_T879 + 608);
