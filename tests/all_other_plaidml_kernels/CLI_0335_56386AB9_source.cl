...
// lid: 256 1 1
// Original:
// X_T706[n0, n1, n2, a : _T945, _T946, _T947, _T948] = =(X_T705[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T706[n0, n1, n2, a : _T945, _T946, _T947, _T948] = =(X_T705[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c124_sdk_225(__global float* restrict  X_T706, __global const float* restrict  in1)
{
