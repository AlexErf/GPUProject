...
// lid: 256 1 1
// Original:
// X_T531[n0, n1, n2, 480 + a : _T724, _T725, _T726, _T727] = =(X_T530[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T531[n0, n1, n2, 480 + a : _T724, _T725, _T726, _T727] = =(X_T530[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_172(__global float* restrict  X_T531, __global const float* restrict  in1)
{
  X_T531 = (X_T531 + 480);
  ...
  for (int n1_lid = 0; n1_lid < 4; n1_lid += 1)
  {
    ...
    {
      int n1 = ((8 * n1_lid) + n1_tid);
      float LX_T531 = agg[n1_lid];
      int gout_idx = ((a_tid + (14336 * n1)) + (512 * n2_gid));
      X_T531[gout_idx] = LX_T531;
    }
  }
}
