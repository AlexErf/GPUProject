...
// Ranges: { 9216 }
// Out stride: { 1 }
// Elementwise input X_T6 shape: fp32(3, 3, 32, 32):(3072, 1024, 32, 1):36 KiB
// Elementwise op: [[pid(RevMul)]] X_T7 = mul(X_T5, X_T6)
// Elementwise op: [[pid(Add)]] X_T8 = add(X_T4, X_T7)
// Tile size: { 512 }
// Contraction output var shape: fp32(3, 3, 32, 32):(3072, 1024, 32, 1):36 KiB
...
__kernel void kernel_c3_sdk_1(__global float* restrict  X_T8, __global const float* restrict  X_T6)
{
  ...
  for (int i1_i2_i3_i4_lid = 0; i1_i2_i3_i4_lid < 2; i1_i2_i3_i4_lid += 1)
  {
    ...
    float LX_T7 = (0.20412415266036987f * LX_T6);
