...
// lid: 256 1 1
// Original:
// X_T1471[n0, n1, n2, 864 + a : _T2118, _T2119, _T2120, _T2121] = =(X_T1470[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1471[n0, n1, n2, 864 + a : _T2118, _T2119, _T2120, _T2121] = =(X_T1470[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_508(__global float* restrict  X_T1471, __global const float* restrict  in1)
{
  X_T1471 = (X_T1471 + 864);
  ...
  if (n2_cond)
  {
    float LX_T1471 = agg[0];
    int gout_idx = ((a_tid + (6272 * n1_gid)) + (896 * n2_tid));
    X_T1471[gout_idx] = LX_T1471;
  }
}
