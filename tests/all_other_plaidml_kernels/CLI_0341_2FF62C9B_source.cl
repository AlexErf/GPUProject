...
// lid: 256 1 1
// Original:
// X_T1076[n0, n1, n2, 896 + a : _T1532, _T1533, _T1534, _T1535] = =(X_T1075[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1076[n0, n1, n2, 896 + a : _T1532, _T1533, _T1534, _T1535] = =(X_T1075[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c68_sdk_367(__global float* restrict  X_T1076, __global const float* restrict  in1)
{
  X_T1076 = (X_T1076 + 896);
