...
// lid: 256 1 1
// Original:
// X_T1586[n0, n1, n2, 352 + a : _T2506, _T2507, _T2508, _T2509] = =(X_T1585[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1586[n0, n1, n2, 352 + a : _T2506, _T2507, _T2508, _T2509] = =(X_T1585[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88, 0 <= 352 + a < 528, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88 }
// Defracted:
// X_T1586[n0, n1, n2, 352 + a : _T2506, _T2507, _T2508, _T2509] = =(X_T1585[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1586   X_T1585  
//        a        88         1         1  
//       n1        14      7392      1232  
//       n2        14       528        88  
//      off                 352         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c42_sdk_601(__global float* restrict  X_T1586, __global const float* restrict  in1)
{
  X_T1586 = (X_T1586 + 352);
