...
// Elementwise input X_T113 shape: fp32(1, 56, 56, 96):(301056, 5376, 96, 1):1176 KiB
// Elementwise input X_I_40 shape: fp32(96):(1):384 bytes
// Elementwise input X_I_39 shape: fp32(96):(1):384 bytes
// Elementwise op: [[pid(Concatenate)]] X_T114 = add(X_T85, X_T113)
// Elementwise op: [[pid(Sub)]] X_T116 = sub(X_T114, X_I_40)
// Elementwise op: [[pid(Mul)]] X_T117 = mul(X_T116, X_I_39)
// Tile size: { 1, 8, 1, 96 }
...
// lwork = 256, 1, 1
// gwork = 1792, 56, 1
__kernel void kernel_c124_sdk_14(__global float* restrict  X_T114, __global float* restrict  X_T117, __global const float* restrict  X_T85, __global const float* restrict  X_T113, __global const float* restrict  X_I_40, __global const float* restrict  X_I_39)
{
  ...
  for (int i4_lid = 0; i4_lid < 3; i4_lid += 1)
  {
    ...
    float LX_T113 = X_T113[gout_idx];
    float LX_I_40 = X_I_40[i4];
    float LX_I_39 = X_I_39[i4];
    float LX_T114 = (LX_T85 + LX_T113);
    float LX_T116 = (LX_T114 - LX_I_40);
    float LX_T117 = (LX_T116 * LX_I_39);
