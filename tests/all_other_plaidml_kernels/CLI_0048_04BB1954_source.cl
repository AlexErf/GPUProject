...
// Ranges: { 677376 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(1, 1, 2016, 336):(677376, 677376, 336, 1):2646 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 512 }
// Contraction output var shape: fp32(1, 1, 2016, 336):(677376, 677376, 336, 1):2646 KiB
