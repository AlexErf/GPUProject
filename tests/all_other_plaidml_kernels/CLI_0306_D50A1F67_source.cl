...
// lid: 256 1 1
// Original:
// X_T673[n0, n1, n2, a : _T908, _T909, _T910, _T911] = =(X_T672[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T673[n0, n1, n2, a : _T908, _T909, _T910, _T911] = =(X_T672[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 14, 1
__kernel void kernel_c108_sdk_216(__global float* restrict  X_T673, __global const float* restrict  in1)
{
  ...
  {
    int a = ((128 * a_lid) + a_tid);
    float LX_T673 = agg[a_lid];
    int gout_idx = ((a + (5824 * (n1_gid + n1_tid))) + (416 * n2_gid));
    X_T673[gout_idx] = LX_T673;
  }
}
