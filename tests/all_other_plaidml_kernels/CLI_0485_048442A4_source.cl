...
// lid: 256 1 1
// Original:
// X_T1441[n0, n1, n2, 672 + a : _T2044, _T2045, _T2046, _T2047] = =(X_T1440[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1441[n0, n1, n2, 672 + a : _T2044, _T2045, _T2046, _T2047] = =(X_T1440[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_490(__global float* restrict  X_T1441, __global const float* restrict  in1)
{
  X_T1441 = (X_T1441 + 672);
