...
// lid: 256 1 1
// Original:
// X_T226[n, x0, x1, co : _T230, _T231, _T232, _T233] = +(X_T225[n, k0 + x0, k1 + x1, ci] * X_I_77[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T226[n, x0, x1, co : _T230, _T231, _T232, _T233] = +(X_T225[n, k0 + x0, k1 + x1, ci] * X_I_77[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T227 = sub(X_T226, X_I_76)
// Elementwise op: [[pid(Mul)]] X_T228 = mul(X_T227, X_I_75)
// Tile size: { 32, 64, 8, 8 }
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 2
__kernel void kernel_c124_sdk_54(__global float* restrict  X_T228, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_76, __global const float* restrict  X_I_75)
{
