...
// lid: 256 1 1
// Original:
// X_T48[n, x0, x1, c : _T26, _T27, _T28, _T29] = >(X_T47[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T48[n, x0, x1, c : _T26, _T27, _T28, _T29] = >(X_T47[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 28, 1
__kernel void kernel_c29_sdk_5(__global float* restrict  X_T48, __global const float* restrict  in1)
{
  ...
  for (int c_lid = 0; c_lid < 2; c_lid += 1)
  {
    ...
    {
      int x0 = ((4 * x0_lid) + x0_tid);
      float LX_T48 = agg[(c_lid + (x0_lid * 2))];
      LX_T48 = select((float)LX_T48, (float)0, (int)(LX_T48 == (float)-FLT_MAX));
