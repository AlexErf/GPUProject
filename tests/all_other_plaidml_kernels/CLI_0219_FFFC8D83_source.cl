...
// lid: 256 1 1
// Original:
// X_T301[n0, n1, n2, 160 + a : _T354, _T355, _T356, _T357] = =(X_T300[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T301[n0, n1, n2, 160 + a : _T354, _T355, _T356, _T357] = =(X_T300[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c108_sdk_82(__global float* restrict  X_T301, __global const float* restrict  in1)
{
  X_T301 = (X_T301 + 160);
  ...
  for (int n1_lid = 0; n1_lid < 4; n1_lid += 1)
  {
    ...
    {
      int n1 = ((8 * n1_lid) + n1_tid);
      float LX_T301 = agg[n1_lid];
      int gout_idx = ((a_tid + (5376 * n1)) + (192 * n2_gid));
      X_T301[gout_idx] = LX_T301;
    }
  }
}
