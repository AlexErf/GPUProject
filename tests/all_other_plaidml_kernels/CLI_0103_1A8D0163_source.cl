...
// lid: 256 1 1
// Original:
// X_T670[i, 0 : _T849, _T850] = +(X_T668[i, j])
// With Index Variables Made Integral:
// X_T670[i, 0 : _T849, _T850] = +(X_T668[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c28_sdk_196(__global float* restrict  X_T670, __global const float* restrict  in1)
{
