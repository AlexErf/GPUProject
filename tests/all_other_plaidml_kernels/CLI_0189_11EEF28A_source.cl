...
// lid: 256 1 1
// Original:
// X_T2528[i, 0 : _T3526, _T3527] = >(X_T2507[i, j])
// With Index Variables Made Integral:
// X_T2528[i, 0 : _T3526, _T3527] = >(X_T2507[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c51_sdk_820(__global float* restrict  X_T2528, __global const float* restrict  in1)
{
  ...
  if ((tid < 1))
  {
    float LX_T2528 = agg[0];
    LX_T2528 = select((float)LX_T2528, (float)0, (int)(LX_T2528 == (float)-FLT_MAX));
    X_T2528[0] = LX_T2528;
  }
}
