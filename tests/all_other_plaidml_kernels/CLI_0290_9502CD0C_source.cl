...
// lid: 256 1 1
// Original:
// X_T511[n0, n1, n2, a : _T655, _T656, _T657, _T658] = =(X_T510[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T511[n0, n1, n2, a : _T655, _T656, _T657, _T658] = =(X_T510[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 14, 1
__kernel void kernel_c124_sdk_156(__global float* restrict  X_T511, __global const float* restrict  in1)
{
