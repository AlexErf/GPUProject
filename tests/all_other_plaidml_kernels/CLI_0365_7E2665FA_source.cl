...
// lid: 256 1 1
// Original:
// X_T946[n0, n1, n2, 704 + a : _T1310, _T1311, _T1312, _T1313] = =(X_T945[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T946[n0, n1, n2, 704 + a : _T1310, _T1311, _T1312, _T1313] = =(X_T945[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c108_sdk_313(__global float* restrict  X_T946, __global const float* restrict  in1)
{
  X_T946 = (X_T946 + 704);
