...
// lid: 256 1 1
// Original:
// X_T729[n0, n1, n2, 416 + a : _T977, _T978, _T979, _T980] = =(X_T728[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T729[n0, n1, n2, 416 + a : _T977, _T978, _T979, _T980] = =(X_T728[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c124_sdk_232(__global float* restrict  X_T729, __global const float* restrict  in1)
{
  X_T729 = (X_T729 + 416);
