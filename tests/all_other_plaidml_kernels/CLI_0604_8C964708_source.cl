...
// lid: 256 1 1
// Original:
// X_T2016[n0, n1, n2, 1408 + a : _T2895, _T2896, _T2897, _T2898] = =(X_T2015[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2016[n0, n1, n2, 1408 + a : _T2895, _T2896, _T2897, _T2898] = =(X_T2015[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1408 + a < 1440, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2016[n0, n1, n2, 1408 + a : _T2895, _T2896, _T2897, _T2898] = =(X_T2015[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2016   X_T2015  
//        a        32         1         1  
//       n1         7     10080       224  
//       n2         7      1440        32  
//      off                1408         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_697(__global float* restrict  X_T2016, __global const float* restrict  in1)
{
  X_T2016 = (X_T2016 + 1408);
  ...
  if (n2_cond)
  {
    float LX_T2016 = agg[0];
    int gout_idx = ((a_tid + (10080 * n1_gid)) + (1440 * n2_tid));
    X_T2016[gout_idx] = LX_T2016;
  }
}
