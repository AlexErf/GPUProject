...
// lid: 256 1 1
// Original:
// X_T848[n0, n1, n2, a : _T1167, _T1168, _T1169, _T1170] = =(X_T847[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T848[n0, n1, n2, a : _T1167, _T1168, _T1169, _T1170] = =(X_T847[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 19, 1
__kernel void kernel_c108_sdk_279(__global float* restrict  X_T848, __global const float* restrict  in1)
{
