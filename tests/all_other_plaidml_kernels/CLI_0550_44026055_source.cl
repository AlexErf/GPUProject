...
// lid: 256 1 1
// Original:
// X_T1766[n0, n1, n2, 1088 + a : _T2525, _T2526, _T2527, _T2528] = =(X_T1765[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1766[n0, n1, n2, 1088 + a : _T2525, _T2526, _T2527, _T2528] = =(X_T1765[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_607(__global float* restrict  X_T1766, __global const float* restrict  in1)
{
  X_T1766 = (X_T1766 + 1088);
