...
// Ranges: { 7056 }
// Out stride: { 1 }
// Elementwise input X_T6 shape: fp32(1, 1, 84, 84):(7056, 7056, 84, 1):27.5625 KiB
// Elementwise op: [[pid(RevMul)]] X_T7 = mul(X_T5, X_T6)
// Elementwise op: [[pid(Add)]] X_T8 = add(X_T4, X_T7)
// Tile size: { 256 }
// Contraction output var shape: fp32(1, 1, 84, 84):(7056, 7056, 84, 1):27.5625 KiB
...
__kernel void kernel_c15_sdk_1(__global float* restrict  X_T8, __global const float* restrict  X_T6)
{
  ...
  int i3_i4_cond = ((i3_i4_gid != 6912) || (i3_i4_tid < 144));
  if (i3_i4_cond)
  {
    int gout_idx = (i3_i4_gid + i3_i4_tid);
    float LX_T6 = X_T6[gout_idx];
    float LX_T7 = (0.37796446681022644f * LX_T6);
