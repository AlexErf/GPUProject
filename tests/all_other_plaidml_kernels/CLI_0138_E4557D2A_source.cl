...
// lid: 256 1 1
// Original:
// X_T187[n0, n1, n2, a : _T216, _T217, _T218, _T219] = =(X_T186[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T187[n0, n1, n2, a : _T216, _T217, _T218, _T219] = =(X_T186[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 14, 1
__kernel void kernel_c68_sdk_51(__global float* restrict  X_T187, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 7; a_lid += 1)
  {
    ...
    {
      int n1 = ((2 * n1_lid) + n1_tid);
      float LX_T187 = agg[(a_lid + (n1_lid * 7))];
