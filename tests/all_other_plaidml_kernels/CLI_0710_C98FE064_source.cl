...
// lid: 256 1 1
// Original:
// X_T2374[n0, n1, n2, 1600 + a : _T3413, _T3414, _T3415, _T3416] = =(X_T2373[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2374[n0, n1, n2, 1600 + a : _T3413, _T3414, _T3415, _T3416] = =(X_T2373[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1600 + a < 1632, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2374[n0, n1, n2, 1600 + a : _T3413, _T3414, _T3415, _T3416] = =(X_T2373[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2374   X_T2373  
//        a        32         1         1  
//       n1         7     11424       224  
//       n2         7      1632        32  
//      off                1600         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_823(__global float* restrict  X_T2374, __global const float* restrict  in1)
{
  X_T2374 = (X_T2374 + 1600);
  ...
  if (n2_cond)
  {
    float LX_T2374 = agg[0];
    int gout_idx = ((a_tid + (11424 * n1_gid)) + (1632 * n2_tid));
    X_T2374[gout_idx] = LX_T2374;
  }
}
