...
// lid: 256 1 1
// Original:
// X_T201[n, x0, x1, c : _T252, _T253, _T254, _T255] = +(X_T200[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T201[n, x0, x1, c : _T252, _T253, _T254, _T255] = +(X_T200[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 2816, 11, 1
__kernel void kernel_c42_sdk_57(__global float* restrict  X_T201, __global const float* restrict  in1)
{
  in1 = (in1 + -3528);
        ...
        if (x0_cond)
        {
          ...
          for (int c_lid = 0; c_lid < 2; c_lid += 1)
          {
            ...
            if (c_cond)
            {
              ...
              float LX_T201 = agg[((c_lid + (x1_lid * 2)) + (x0_lid * 4))];
