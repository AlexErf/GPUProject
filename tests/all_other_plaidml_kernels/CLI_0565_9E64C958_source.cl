...
// lid: 256 1 1
// Original:
// X_T1841[n0, n1, n2, 1184 + a : _T2636, _T2637, _T2638, _T2639] = =(X_T1840[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1841[n0, n1, n2, 1184 + a : _T2636, _T2637, _T2638, _T2639] = =(X_T1840[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_634(__global float* restrict  X_T1841, __global const float* restrict  in1)
{
  X_T1841 = (X_T1841 + 1184);
  ...
  if (n2_cond)
  {
    float LX_T1841 = agg[0];
    int gout_idx = ((a_tid + (8512 * n1_gid)) + (1216 * n2_tid));
    X_T1841[gout_idx] = LX_T1841;
  }
}
