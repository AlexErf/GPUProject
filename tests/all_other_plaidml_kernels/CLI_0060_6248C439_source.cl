...
// Ranges: { 2709504 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(1, 1, 4032, 672):(2709504, 2709504, 672, 1):10584 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 2048 }
// Contraction output var shape: fp32(1, 1, 4032, 672):(2709504, 2709504, 672, 1):10584 KiB
