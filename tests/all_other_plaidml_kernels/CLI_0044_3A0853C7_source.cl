...
// lid: 256 1 1
// Original:
// X_T110[x0, y1 : _T155, _T156] = +(X_T109[x0, z] * X_I_1[z, y1])
// With Index Variables Made Integral:
// X_T110[x0, y1 : _T155, _T156] = +(X_T109[x0, z] * X_I_1[z, y1]), 500000000 + x0 < 1000000000, 500000000 + y1 < 1000000000, 500000000 + z < 1000000000
...
// Elementwise op: [[pid(Add)]] X_T111 = add(X_T110, X_I_0)
// Tile size: { 64, 64 }
...
// lwork = 256, 1, 1
// gwork = 4096, 1, 1
__kernel void kernel_c18_sdk_23(__global float* restrict  X_T111, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_0)
{
