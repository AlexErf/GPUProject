...
// Ranges: { 65536 }
// Out stride: { 1 }
// Elementwise input X_T6 shape: fp32(128, 512):(512, 1):256 KiB
// Elementwise op: [[pid(RevMul)]] X_T7 = mul(X_T5, X_T6)
// Elementwise op: [[pid(Add)]] X_T8 = add(X_T4, X_T7)
// Tile size: { 4096 }
// Contraction output var shape: fp32(128, 512):(512, 1):256 KiB
...
// lwork = 256, 1, 1
// gwork = 4096, 1, 1
__kernel void kernel_c2_sdk_1(__global float* restrict  X_T8, __global const float* restrict  X_T6)
{
  ...
  for (int i1_i2_lid = 0; i1_i2_lid < 16; i1_i2_lid += 1)
  {
    ...
    float LX_T7 = (0.19364917278289795f * LX_T6);
