...
// lid: 256 1 1
// Original:
// X_T163[n0, n1, n2, 128 + a : _T137, _T138, _T139, _T140] = =(X_T162[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T163[n0, n1, n2, 128 + a : _T137, _T138, _T139, _T140] = =(X_T162[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c124_sdk_31(__global float* restrict  X_T163, __global const float* restrict  in1)
{
  X_T163 = (X_T163 + 128);
