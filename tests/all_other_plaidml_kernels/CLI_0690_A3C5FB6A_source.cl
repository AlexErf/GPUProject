...
// lid: 256 1 1
// Original:
// X_T2274[n0, n1, n2, 1472 + a : _T3265, _T3266, _T3267, _T3268] = =(X_T2273[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2274[n0, n1, n2, 1472 + a : _T3265, _T3266, _T3267, _T3268] = =(X_T2273[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1472 + a < 1504, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2274[n0, n1, n2, 1472 + a : _T3265, _T3266, _T3267, _T3268] = =(X_T2273[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2274   X_T2273  
//        a        32         1         1  
//       n1         7     10528       224  
//       n2         7      1504        32  
//      off                1472         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_787(__global float* restrict  X_T2274, __global const float* restrict  in1)
{
  X_T2274 = (X_T2274 + 1472);
  ...
  if (n2_cond)
  {
    float LX_T2274 = agg[0];
    int gout_idx = ((a_tid + (10528 * n1_gid)) + (1504 * n2_tid));
    X_T2274[gout_idx] = LX_T2274;
  }
}
