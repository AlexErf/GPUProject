...
// lid: 256 1 1
// Original:
// X_T201[n, x0, x1, co : _T193, _T194, _T195, _T196] = +(X_T200[n, k0 + x0, k1 + x1, ci] * X_I_67[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T201[n, x0, x1, co : _T193, _T194, _T195, _T196] = +(X_T200[n, k0 + x0, k1 + x1, ci] * X_I_67[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T202 = sub(X_T201, X_I_66)
// Elementwise op: [[pid(Mul)]] X_T203 = mul(X_T202, X_I_65)
// Tile size: { 32, 64, 8, 8 }
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 2
__kernel void kernel_c124_sdk_45(__global float* restrict  X_T203, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_66, __global const float* restrict  X_I_65)
{
