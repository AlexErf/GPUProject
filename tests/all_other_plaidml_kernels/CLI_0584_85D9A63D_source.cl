...
// Elementwise input X_T1920 shape: fp32(1, 7, 7, 1312):(64288, 9184, 1312, 1):251.125 KiB
// Elementwise input X_T1924 shape: fp32(1312):(1):5.125 KiB
// Elementwise input X_I_741 shape: fp32(1312):(1):5.125 KiB
// Elementwise op: [[pid(TrueDiv)]] X_T1925 = div(X_T1920, X_T1924)
// Elementwise op: [[pid(Add, Switch)]] X_T1926 = add(X_T1925, X_I_741)
...
// lwork = 256, 1, 1
// gwork = 1792, 11, 1
__kernel void kernel_c108_sdk_665(__global float* restrict  X_T1928, __global const float* restrict  X_T1920, __global const float* restrict  X_T1924, __global const float* restrict  X_I_741)
{
  ...
  for (int i4_lid = 0; i4_lid < 4; i4_lid += 1)
  {
    ...
    if (i4_cond)
    {
      ...
      if (i3_cond)
      {
        ...
        float LX_T1926 = (LX_T1925 + LX_I_741);
