...
// Ranges: { 2359296 }
// Out stride: { 1 }
// Elementwise input X_T6 shape: fp32(3, 3, 512, 512):(786432, 262144, 512, 1):9216 KiB
...
// lwork = 256, 1, 1
// gwork = 147456, 1, 1
__kernel void kernel_c12_sdk_1(__global float* restrict  X_T8, __global const float* restrict  X_T6)
{
  ...
  for (int i1_i2_i3_i4_lid = 0; i1_i2_i3_i4_lid < 16; i1_i2_i3_i4_lid += 1)
  {
    ...
    float LX_T7 = (0.05103103816509247f * LX_T6);
    float LX_T8 = (-0.025515519082546234f + LX_T7);
    X_T8[gout_idx] = LX_T8;
  }
}
