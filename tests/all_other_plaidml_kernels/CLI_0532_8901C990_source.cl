...
// lid: 256 1 1
// Original:
// X_T1668[n0, n1, n2, a : _T2382, _T2383, _T2384, _T2385] = =(X_T1667[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1668[n0, n1, n2, a : _T2382, _T2383, _T2384, _T2385] = =(X_T1667[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c108_sdk_573(__global float* restrict  X_T1668, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 4; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T1668 = agg[a_lid];
      int gout_idx = ((a + (7168 * n1_gid)) + (1024 * n2_gid));
      X_T1668[gout_idx] = LX_T1668;
    }
  }
}
