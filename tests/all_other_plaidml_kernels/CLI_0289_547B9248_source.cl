...
// lid: 256 1 1
// Original:
// X_T853[n0, n1, n2, a : _T1204, _T1205, _T1206, _T1207] = =(X_T852[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T853[n0, n1, n2, a : _T1204, _T1205, _T1206, _T1207] = =(X_T852[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 14, 1
__kernel void kernel_c68_sdk_288(__global float* restrict  X_T853, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 3; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T853 = agg[a_lid];
      int gout_idx = ((a + (9408 * n1_gid)) + (672 * n2_gid));
      X_T853[gout_idx] = LX_T853;
    }
  }
}
