...
// lid: 256 1 1
// Original:
// X_T2499[n0, n1, n2, 1760 + a : _T3598, _T3599, _T3600, _T3601] = =(X_T2498[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2499[n0, n1, n2, 1760 + a : _T3598, _T3599, _T3600, _T3601] = =(X_T2498[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1760 + a < 1792, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2499[n0, n1, n2, 1760 + a : _T3598, _T3599, _T3600, _T3601] = =(X_T2498[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2499   X_T2498  
//        a        32         1         1  
//       n1         7     12544       224  
//       n2         7      1792        32  
//      off                1760         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_868(__global float* restrict  X_T2499, __global const float* restrict  in1)
{
  X_T2499 = (X_T2499 + 1760);
  ...
  if (n2_cond)
  {
    float LX_T2499 = agg[0];
    int gout_idx = ((a_tid + (12544 * n1_gid)) + (1792 * n2_tid));
    X_T2499[gout_idx] = LX_T2499;
  }
}
