...
// Ranges: { 126976 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 992, 128):(126976, 126976, 128, 1):496 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 4096 }
// Contraction output var shape: fp32(1, 1, 992, 128):(126976, 126976, 128, 1):496 KiB
// Computed true ops: 253952
...
// lwork = 256, 1, 1
// gwork = 7936, 1, 1
__kernel void kernel_c63_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
