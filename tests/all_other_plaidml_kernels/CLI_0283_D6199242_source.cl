...
// lid: 256 1 1
// Original:
// X_T4164[i, 0 : _T6541, _T6542] = >(X_T4095[i, j])
// With Index Variables Made Integral:
// X_T4164[i, 0 : _T6541, _T6542] = >(X_T4095[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c42_sdk_1596(__global float* restrict  X_T4164, __global const float* restrict  in1)
{
  ...
  if ((tid < 1))
  {
    float LX_T4164 = agg[0];
    LX_T4164 = select((float)LX_T4164, (float)0, (int)(LX_T4164 == (float)-FLT_MAX));
    X_T4164[0] = LX_T4164;
  }
}
