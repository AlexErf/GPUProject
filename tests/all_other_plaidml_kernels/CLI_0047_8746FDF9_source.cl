...
// Ranges: { 30976 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(1, 1, 352, 88):(30976, 30976, 88, 1):121 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 256 }
// Contraction output var shape: fp32(1, 1, 352, 88):(30976, 30976, 88, 1):121 KiB
// Computed true ops: 30976
