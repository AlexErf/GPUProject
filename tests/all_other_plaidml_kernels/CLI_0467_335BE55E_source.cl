...
// lid: 256 1 1
// Original:
// X_T1279[n0, n1, n2, 1120 + a : _T1791, _T1792, _T1793, _T1794] = =(X_T1278[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1279[n0, n1, n2, 1120 + a : _T1791, _T1792, _T1793, _T1794] = =(X_T1278[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c124_sdk_430(__global float* restrict  X_T1279, __global const float* restrict  in1)
{
  X_T1279 = (X_T1279 + 1120);
