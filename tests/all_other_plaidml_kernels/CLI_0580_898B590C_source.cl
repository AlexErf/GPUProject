...
// lid: 256 1 1
// Original:
// X_T1916[n0, n1, n2, 1280 + a : _T2747, _T2748, _T2749, _T2750] = =(X_T1915[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1916[n0, n1, n2, 1280 + a : _T2747, _T2748, _T2749, _T2750] = =(X_T1915[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1280 + a < 1312, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1916[n0, n1, n2, 1280 + a : _T2747, _T2748, _T2749, _T2750] = =(X_T1915[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1916   X_T1915  
//        a        32         1         1  
//       n1         7      9184       224  
//       n2         7      1312        32  
//      off                1280         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_661(__global float* restrict  X_T1916, __global const float* restrict  in1)
{
  X_T1916 = (X_T1916 + 1280);
  ...
  if (n2_cond)
  {
    float LX_T1916 = agg[0];
    int gout_idx = ((a_tid + (9184 * n1_gid)) + (1312 * n2_tid));
    X_T1916[gout_idx] = LX_T1916;
  }
}
