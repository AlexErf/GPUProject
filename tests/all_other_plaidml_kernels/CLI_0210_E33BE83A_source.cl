...
// lid: 256 1 1
// Original:
// X_T165[n0, n1, n2, a : _T142, _T143, _T144, _T145] = =(X_T164[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T165[n0, n1, n2, a : _T142, _T143, _T144, _T145] = =(X_T164[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 14, 1
__kernel void kernel_c124_sdk_33(__global float* restrict  X_T165, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 5; a_lid += 1)
  {
    ...
    {
      int n1 = ((2 * n1_lid) + n1_tid);
      float LX_T165 = agg[(a_lid + (n1_lid * 5))];
