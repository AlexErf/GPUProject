...
// lid: 256 1 1
// Original:
// X_T646[n0, n1, n2, 320 + a : _T866, _T867, _T868, _T869] = =(X_T645[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T646[n0, n1, n2, 320 + a : _T866, _T867, _T868, _T869] = =(X_T645[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c108_sdk_205(__global float* restrict  X_T646, __global const float* restrict  in1)
{
  X_T646 = (X_T646 + 320);
