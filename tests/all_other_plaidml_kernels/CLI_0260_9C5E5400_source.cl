...
// lid: 256 1 1
// Original:
// X_T3026[n0, n1, n2, a : _T4812, _T4813, _T4814, _T4815] = =(X_T3025[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T3026[n0, n1, n2, a : _T4812, _T4813, _T4814, _T4815] = =(X_T3025[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 11, 0 <= n2 < 11, 0 <= n1 < 11, 0 <= n2 < 11, 0 <= a < 672, 0 <= a < 4032, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 11, 0 <= n2 < 11, 0 <= a < 672 }
// Defracted:
// X_T3026[n0, n1, n2, a : _T4812, _T4813, _T4814, _T4815] = =(X_T3025[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T3026   X_T3025  
//        a       672         1         1  
//       n1        11     44352      7392  
//       n2        11      4032       672  
//      off                   0         0  
...
// lwork = 256, 1, 1
// gwork = 768, 11, 11
__kernel void kernel_c42_sdk_1169(__global float* restrict  X_T3026, __global const float* restrict  in1)
{
