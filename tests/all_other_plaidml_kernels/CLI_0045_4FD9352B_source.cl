...
// Ranges: { 61440 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 480, 128):(61440, 61440, 128, 1):240 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 2048 }
// Contraction output var shape: fp32(1, 1, 480, 128):(61440, 61440, 128, 1):240 KiB
// Computed true ops: 122880
...
__kernel void kernel_c30_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i3_i4_lid = 0; i3_i4_lid < 8; i3_i4_lid += 1)
  {
    ...
    float LX_T8 = (0.1986798495054245f * LX_T7);
    float LX_T9 = (-0.09933992475271225f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
