...
// lid: 256 1 1
// Original:
// X_T2191[n0, n1, n2, 1632 + a : _T3154, _T3155, _T3156, _T3157] = =(X_T2190[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2191[n0, n1, n2, 1632 + a : _T3154, _T3155, _T3156, _T3157] = =(X_T2190[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_760(__global float* restrict  X_T2191, __global const float* restrict  in1)
{
  X_T2191 = (X_T2191 + 1632);
  ...
  if (n2_cond)
  {
    float LX_T2191 = agg[0];
    int gout_idx = ((a_tid + (11648 * n1_gid)) + (1664 * n2_tid));
    X_T2191[gout_idx] = LX_T2191;
  }
}
