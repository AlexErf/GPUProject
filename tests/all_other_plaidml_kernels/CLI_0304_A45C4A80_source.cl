...
// lid: 256 1 1
// Original:
// X_T571[n, x0, x1, co : _T739, _T740, _T741, _T742] = +(X_T570[n, k0 + x0, k1 + x1, ci] * X_I_9[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T571[n, x0, x1, co : _T739, _T740, _T741, _T742] = +(X_T570[n, k0 + x0, k1 + x1, ci] * X_I_9[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 2, 4
__kernel void kernel_c124_sdk_176(__global float* restrict  X_T571, __global const float* restrict  in1, __global const float* restrict  in2)
{
  ...
  for (int x1_lid = 0; x1_lid < 4; x1_lid += 1)
  {
    ...
    if (x1_cond)
    {
      ...
      for (int co_lid = 0; co_lid < 2; co_lid += 1)
      {
        ...
        {
          int x0 = ((2 * x0_lid) + x0_tid);
          float LX_T571 = agg[((co_lid + (x1_lid * 2)) + (x0_lid * 8))];
