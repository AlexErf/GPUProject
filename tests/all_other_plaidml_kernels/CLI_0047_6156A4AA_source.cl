...
// lid: 256 1 1
// Original:
// X_T116[i, 0 : _T141, _T142] = +(X_T114[i, j])
// With Index Variables Made Integral:
// X_T116[i, 0 : _T141, _T142] = +(X_T114[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c18_sdk_23(__global float* restrict  X_T116, __global const float* restrict  in1)
{
