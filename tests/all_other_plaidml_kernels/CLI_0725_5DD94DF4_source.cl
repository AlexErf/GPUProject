...
// lid: 256 1 1
// Original:
// X_T2449[n0, n1, n2, 1696 + a : _T3524, _T3525, _T3526, _T3527] = =(X_T2448[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2449[n0, n1, n2, 1696 + a : _T3524, _T3525, _T3526, _T3527] = =(X_T2448[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1696 + a < 1728, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2449[n0, n1, n2, 1696 + a : _T3524, _T3525, _T3526, _T3527] = =(X_T2448[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2449   X_T2448  
//        a        32         1         1  
//       n1         7     12096       224  
//       n2         7      1728        32  
//      off                1696         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_850(__global float* restrict  X_T2449, __global const float* restrict  in1)
{
  X_T2449 = (X_T2449 + 1696);
  ...
  if (n2_cond)
  {
    float LX_T2449 = agg[0];
    int gout_idx = ((a_tid + (12096 * n1_gid)) + (1728 * n2_tid));
    X_T2449[gout_idx] = LX_T2449;
  }
}
