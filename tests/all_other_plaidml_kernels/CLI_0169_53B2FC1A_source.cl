...
// lid: 256 1 1
// Original:
// X_T686[n0, n1, n2, 840 + a : _T1060, _T1061, _T1062, _T1063] = =(X_T685[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T686[n0, n1, n2, 840 + a : _T1060, _T1061, _T1062, _T1063] = =(X_T685[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= a < 168, 0 <= 840 + a < 1008, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 5376, 42, 1
__kernel void kernel_c42_sdk_249(__global float* restrict  X_T686, __global const float* restrict  in1)
{
  X_T686 = (X_T686 + 840);
