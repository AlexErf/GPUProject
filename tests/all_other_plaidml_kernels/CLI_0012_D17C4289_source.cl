...
// lid: 256 1 1
// Original:
// X_T22[i0, i1 : _T21, _T22] = =(X_I_10[i0, 384 + i1])
// With Index Variables Made Integral:
// X_T22[i0, i1 : _T21, _T22] = =(X_I_10[i0, 384 + i1]), 500000000 + i0 < 1000000000, 500000000 + i1 < 1000000000
// Constraints:{ 0 <= i0 < 128, 0 <= i1 < 128, 0 <= i0 < 128, 0 <= 384 + i1 < 512, 0 <= 500000000 + i0 < 1000000000, 0 <= 500000000 + i1 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 8192, 1, 1
__kernel void kernel_c6_sdk_8(__global float* restrict  X_T22, __global const float* restrict  in1)
{
  in1 = (in1 + 384);
  ...
  {
    {
      ...
      for (int i0_lid = 0; i0_lid < 2; i0_lid += 1)
      {
        ...
        in1_shared[lidx] = in1[clamp((int)gidx, (int)-384, (int)65151)];
      }
    }
  ...
  {
    int i1 = ((64 * i1_lid) + i1_tid);
    float LX_T22 = agg[i1_lid];
    int gout_idx = ((128 * (i0_gid + i0_tid)) + i1);
    X_T22[gout_idx] = LX_T22;
  }
}
