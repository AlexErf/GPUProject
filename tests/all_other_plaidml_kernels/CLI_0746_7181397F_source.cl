...
// lid: 256 1 1
// Original:
// X_T2549[n0, n1, n2, 1824 + a : _T3672, _T3673, _T3674, _T3675] = =(X_T2548[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2549[n0, n1, n2, 1824 + a : _T3672, _T3673, _T3674, _T3675] = =(X_T2548[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1824 + a < 1856, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2549[n0, n1, n2, 1824 + a : _T3672, _T3673, _T3674, _T3675] = =(X_T2548[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2549   X_T2548  
//        a        32         1         1  
//       n1         7     12992       224  
//       n2         7      1856        32  
//      off                1824         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_886(__global float* restrict  X_T2549, __global const float* restrict  in1)
{
  X_T2549 = (X_T2549 + 1824);
  ...
  if (n2_cond)
  {
    float LX_T2549 = agg[0];
    int gout_idx = ((a_tid + (12992 * n1_gid)) + (1856 * n2_tid));
    X_T2549[gout_idx] = LX_T2549;
  }
}
