...
// lid: 256 1 1
// Original:
// X_T123[n, x0, x1, co : _T119, _T120, _T121, _T122] = +(X_T122[n, k0 + x0, k1 + x1, ci] * X_I_47[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T123[n, x0, x1, co : _T119, _T120, _T121, _T122] = +(X_T122[n, k0 + x0, k1 + x1, ci] * X_I_47[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T124 = sub(X_T123, X_I_46)
// Elementwise op: [[pid(Mul)]] X_T125 = mul(X_T124, X_I_45)
// Tile size: { 32, 64, 8, 8 }
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 2
__kernel void kernel_c68_sdk_27(__global float* restrict  X_T125, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_46, __global const float* restrict  X_I_45)
{
