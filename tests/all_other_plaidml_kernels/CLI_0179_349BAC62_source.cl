...
// lid: 256 1 1
// Original:
// X_T1212[n, x0, x1, c : _T1899, _T1900, _T1901, _T1902] = >(X_T1211[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T1212[n, x0, x1, c : _T1899, _T1900, _T1901, _T1902] = >(X_T1211[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 768, 7, 1
__kernel void kernel_c42_sdk_456(__global float* restrict  X_T1212, __global const float* restrict  in1)
{
  ...
  if (c_cond)
  {
    for (int x1_lid = 0; x1_lid < 4; x1_lid += 1)
    {
      ...
      if (x1_cond)
      {
        ...
        float LX_T1212 = agg[x1_lid];
        LX_T1212 = select((float)LX_T1212, (float)0, (int)(LX_T1212 == (float)-FLT_MAX));
