...
// lid: 256 1 1
// Original:
// X_T115[n0, n1, n2, a : _T68, _T69, _T70, _T71] = =(X_T114[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T115[n0, n1, n2, a : _T68, _T69, _T70, _T71] = =(X_T114[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 56, 1
__kernel void kernel_c124_sdk_15(__global float* restrict  X_T115, __global const float* restrict  in1)
{
