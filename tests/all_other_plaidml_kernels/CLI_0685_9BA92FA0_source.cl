...
// lid: 256 1 1
// Original:
// X_T2249[n0, n1, n2, 1440 + a : _T3228, _T3229, _T3230, _T3231] = =(X_T2248[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2249[n0, n1, n2, 1440 + a : _T3228, _T3229, _T3230, _T3231] = =(X_T2248[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1440 + a < 1472, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2249[n0, n1, n2, 1440 + a : _T3228, _T3229, _T3230, _T3231] = =(X_T2248[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2249   X_T2248  
//        a        32         1         1  
//       n1         7     10304       224  
//       n2         7      1472        32  
//      off                1440         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_778(__global float* restrict  X_T2249, __global const float* restrict  in1)
{
  X_T2249 = (X_T2249 + 1440);
  ...
  if (n2_cond)
  {
    float LX_T2249 = agg[0];
    int gout_idx = ((a_tid + (10304 * n1_gid)) + (1472 * n2_tid));
    X_T2249[gout_idx] = LX_T2249;
  }
}
