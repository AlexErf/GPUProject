...
// lid: 256 1 1
// Original:
// X_T112[n0, n1, n2, a : _T105, _T106, _T107, _T108] = =(X_T111[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T112[n0, n1, n2, a : _T105, _T106, _T107, _T108] = =(X_T111[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 14336, 2, 1
__kernel void kernel_c68_sdk_24(__global float* restrict  X_T112, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 2; a_lid += 1)
  {
    ...
    {
      int n1 = ((8 * n1_lid) + n1_tid);
      float LX_T112 = agg[(a_lid + (n1_lid * 2))];
