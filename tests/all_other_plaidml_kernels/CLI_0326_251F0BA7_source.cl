...
// lid: 256 1 1
// Original:
// X_T773[n0, n1, n2, a : _T1056, _T1057, _T1058, _T1059] = =(X_T772[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T773[n0, n1, n2, a : _T1056, _T1057, _T1058, _T1059] = =(X_T772[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 2, 1
__kernel void kernel_c108_sdk_252(__global float* restrict  X_T773, __global const float* restrict  in1)
{
  ...
  for (int n1_lid = 0; n1_lid < 2; n1_lid += 1)
  {
    ...
    if (n1_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T773 = agg[(a_lid + (n1_lid * 8))];
        int gout_idx = (((a_gid + a) + (7616 * n1)) + (544 * n2_gid));
        X_T773[gout_idx] = LX_T773;
      }
    }
  }
}
