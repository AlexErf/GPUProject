...
// lid: 256 1 1
// Original:
// X_T2049[n0, n1, n2, 1184 + a : _T2932, _T2933, _T2934, _T2935] = =(X_T2048[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2049[n0, n1, n2, 1184 + a : _T2932, _T2933, _T2934, _T2935] = =(X_T2048[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1184 + a < 1216, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2049[n0, n1, n2, 1184 + a : _T2932, _T2933, _T2934, _T2935] = =(X_T2048[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2049   X_T2048  
//        a        32         1         1  
//       n1         7      8512       224  
//       n2         7      1216        32  
//      off                1184         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_706(__global float* restrict  X_T2049, __global const float* restrict  in1)
{
  X_T2049 = (X_T2049 + 1184);
  ...
  if (n2_cond)
  {
    float LX_T2049 = agg[0];
    int gout_idx = ((a_tid + (8512 * n1_gid)) + (1216 * n2_tid));
    X_T2049[gout_idx] = LX_T2049;
  }
}
