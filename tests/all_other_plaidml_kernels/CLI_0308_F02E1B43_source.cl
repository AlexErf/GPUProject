...
// lid: 256 1 1
// Original:
// X_T577[n0, n1, n2, a : _T760, _T761, _T762, _T763] = =(X_T576[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T577[n0, n1, n2, a : _T760, _T761, _T762, _T763] = =(X_T576[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 2, 1
__kernel void kernel_c124_sdk_180(__global float* restrict  X_T577, __global const float* restrict  in1)
{
  ...
  for (int n1_lid = 0; n1_lid < 2; n1_lid += 1)
  {
    ...
    if (n1_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T577 = agg[(a_lid + (n1_lid * 4))];
