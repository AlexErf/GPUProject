...
// Ranges: { 1179648 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(3, 3, 256, 512):(393216, 131072, 512, 1):4608 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 4096 }
// Contraction output var shape: fp32(3, 3, 256, 512):(393216, 131072, 512, 1):4608 KiB
// Computed true ops: 2359296
// Computed work groups: 288
...
__kernel void kernel_c10_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i1_i2_i3_i4_lid = 0; i1_i2_i3_i4_lid < 16; i1_i2_i3_i4_lid += 1)
  {
    ...
    float LX_T9 = (-0.02946278266608715f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
