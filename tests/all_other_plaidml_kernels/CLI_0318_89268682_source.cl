...
// lid: 256 1 1
// Original:
// X_T629[n0, n1, n2, 288 + a : _T829, _T830, _T831, _T832] = =(X_T628[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T629[n0, n1, n2, 288 + a : _T829, _T830, _T831, _T832] = =(X_T628[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c124_sdk_196(__global float* restrict  X_T629, __global const float* restrict  in1)
{
  X_T629 = (X_T629 + 288);
