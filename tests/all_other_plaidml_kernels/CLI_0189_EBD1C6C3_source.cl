...
// lid: 256 1 1
// Original:
// X_T168[n, x0, x1, co : _T156, _T157, _T158, _T159] = +(X_T167[n, k0 + x0, k1 + x1, ci] * X_I_57[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T168[n, x0, x1, co : _T156, _T157, _T158, _T159] = +(X_T167[n, k0 + x0, k1 + x1, ci] * X_I_57[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T169 = sub(X_T168, X_I_56)
// Elementwise op: [[pid(Mul)]] X_T170 = mul(X_T169, X_I_55)
// Tile size: { 32, 64, 8, 8 }
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 2
__kernel void kernel_c108_sdk_36(__global float* restrict  X_T170, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_56, __global const float* restrict  X_I_55)
{
