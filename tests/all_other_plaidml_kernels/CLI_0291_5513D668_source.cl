...
// lid: 256 1 1
// Original:
// X_T598[n0, n1, n2, a : _T797, _T798, _T799, _T800] = =(X_T597[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T598[n0, n1, n2, a : _T797, _T798, _T799, _T800] = =(X_T597[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 9, 1
__kernel void kernel_c108_sdk_189(__global float* restrict  X_T598, __global const float* restrict  in1)
{
