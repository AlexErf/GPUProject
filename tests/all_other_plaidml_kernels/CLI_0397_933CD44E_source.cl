...
// lid: 256 1 1
// Original:
// X_T1073[n0, n1, n2, a : _T1500, _T1501, _T1502, _T1503] = =(X_T1072[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1073[n0, n1, n2, a : _T1500, _T1501, _T1502, _T1503] = =(X_T1072[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 14, 1
__kernel void kernel_c108_sdk_360(__global float* restrict  X_T1073, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 4; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T1073 = agg[a_lid];
      int gout_idx = ((a + (12992 * n1_gid)) + (928 * n2_gid));
      X_T1073[gout_idx] = LX_T1073;
    }
  }
}
