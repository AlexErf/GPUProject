...
// lid: 256 1 1
// Original:
// X_T1593[n0, n1, n2, a : _T2271, _T2272, _T2273, _T2274] = =(X_T1592[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1593[n0, n1, n2, a : _T2271, _T2272, _T2273, _T2274] = =(X_T1592[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c108_sdk_546(__global float* restrict  X_T1593, __global const float* restrict  in1)
{
  ...
  if (n2_cond)
  {
    ...
    {
      int a = ((32 * a_lid) + a_tid);
      float LX_T1593 = agg[a_lid];
      int gout_idx = (((a_gid + a) + (6496 * n1_gid)) + (928 * n2_tid));
      X_T1593[gout_idx] = LX_T1593;
    }
  }
}
