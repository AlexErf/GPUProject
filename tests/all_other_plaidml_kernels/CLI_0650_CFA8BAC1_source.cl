...
// lid: 256 1 1
// Original:
// X_T2074[n0, n1, n2, 1216 + a : _T2969, _T2970, _T2971, _T2972] = =(X_T2073[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2074[n0, n1, n2, 1216 + a : _T2969, _T2970, _T2971, _T2972] = =(X_T2073[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_715(__global float* restrict  X_T2074, __global const float* restrict  in1)
{
  X_T2074 = (X_T2074 + 1216);
