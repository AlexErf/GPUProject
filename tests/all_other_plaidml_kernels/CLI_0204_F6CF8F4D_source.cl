...
// lid: 256 1 1
// Original:
// X_T481[n0, n1, n2, 416 + a : _T650, _T651, _T652, _T653] = =(X_T480[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T481[n0, n1, n2, 416 + a : _T650, _T651, _T652, _T653] = =(X_T480[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_154(__global float* restrict  X_T481, __global const float* restrict  in1)
{
  X_T481 = (X_T481 + 416);
