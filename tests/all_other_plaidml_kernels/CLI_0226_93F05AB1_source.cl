...
// lid: 256 1 1
// Original:
// X_T2091[n, x0, x1, c : _T3314, _T3315, _T3316, _T3317] = +(X_T1753[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T2091[n, x0, x1, c : _T3314, _T3315, _T3316, _T3317] = +(X_T1753[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(normal_A_block_8)]] X_T2092 = div(X_T2091, X_T1707)
// Elementwise op: [[pid(Add)]] X_T2093 = add(X_T2092, X_T2092)
...
// lwork = 256, 1, 1
// gwork = 1536, 11, 1
__kernel void kernel_c42_sdk_801(__global float* restrict  X_T2093, __global const float* restrict  in1, __global const float* restrict  X_T1707)
{
  in1 = (in1 + -7392);
