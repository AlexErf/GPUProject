...
// lid: 256 1 1
// Original:
// X_T650[n0, n1, n2, 504 + a : _T991, _T992, _T993, _T994] = =(X_T649[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T650[n0, n1, n2, 504 + a : _T991, _T992, _T993, _T994] = =(X_T649[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= a < 168, 0 <= 504 + a < 1008, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 5376, 42, 1
__kernel void kernel_c42_sdk_232(__global float* restrict  X_T650, __global const float* restrict  in1)
{
  X_T650 = (X_T650 + 504);
