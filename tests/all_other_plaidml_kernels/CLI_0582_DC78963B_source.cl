...
// lid: 256 1 1
// Original:
// X_T1918[n0, n1, n2, a : _T2752, _T2753, _T2754, _T2755] = =(X_T1917[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1918[n0, n1, n2, a : _T2752, _T2753, _T2754, _T2755] = =(X_T1917[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 11, 1
__kernel void kernel_c108_sdk_663(__global float* restrict  X_T1918, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 4; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      if (n2_cond)
      {
        float LX_T1918 = agg[a_lid];
        int gout_idx = (((a_gid + a) + (9408 * n1_gid)) + (1344 * n2_tid));
        X_T1918[gout_idx] = LX_T1918;
      }
    }
  }
}
