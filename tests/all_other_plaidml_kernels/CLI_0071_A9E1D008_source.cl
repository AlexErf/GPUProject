...
// lid: 256 1 1
// Original:
// X_T57[n, x0, x1, c : _T40, _T41, _T42, _T43] = >(X_T56[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T57[n, x0, x1, c : _T40, _T41, _T42, _T43] = >(X_T56[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c42_sdk_7(__global float* restrict  X_T57, __global const float* restrict  in1)
{
  ...
  if (c_cond)
  {
    for (int x1_lid = 0; x1_lid < 2; x1_lid += 1)
    {
      ...
      {
        int x0 = ((4 * x0_lid) + x0_tid);
        float LX_T57 = agg[(x1_lid + (x0_lid * 2))];
        LX_T57 = select((float)LX_T57, (float)0, (int)(LX_T57 == (float)-FLT_MAX));
