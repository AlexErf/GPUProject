...
// Elementwise input X_I_41 shape: fp32(80):(1):320 bytes
// Elementwise op: [[pid(TrueDiv)]] X_T69 = div(X_T64, X_T68)
// Elementwise op: [[pid(Add, Switch)]] X_T70 = add(X_T69, X_I_41)
...
// lwork = 256, 1, 1
// gwork = 9472, 37, 1
__kernel void kernel_c56_sdk_12(__global float* restrict  X_T72, __global const float* restrict  X_T64, __global const float* restrict  X_T68, __global const float* restrict  X_I_41)
{
    ...
    if (i2_cond)
    {
      for (int i4_lid = 0; i4_lid < 2; i4_lid += 1)
      {
        ...
        if (i4_cond)
        {
          ...
          float LX_I_41 = X_I_41[i4];
          float LX_T69 = (LX_T64 / LX_T68);
          float LX_T70 = (LX_T69 + LX_I_41);
