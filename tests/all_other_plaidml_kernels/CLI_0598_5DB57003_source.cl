...
// lid: 256 1 1
// Original:
// X_T1991[n0, n1, n2, 1376 + a : _T2858, _T2859, _T2860, _T2861] = =(X_T1990[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1991[n0, n1, n2, 1376 + a : _T2858, _T2859, _T2860, _T2861] = =(X_T1990[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1376 + a < 1408, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1991[n0, n1, n2, 1376 + a : _T2858, _T2859, _T2860, _T2861] = =(X_T1990[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1991   X_T1990  
//        a        32         1         1  
//       n1         7      9856       224  
//       n2         7      1408        32  
//      off                1376         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_688(__global float* restrict  X_T1991, __global const float* restrict  in1)
{
  X_T1991 = (X_T1991 + 1376);
  ...
  if (n2_cond)
  {
    float LX_T1991 = agg[0];
    int gout_idx = ((a_tid + (9856 * n1_gid)) + (1408 * n2_tid));
