...
// lid: 256 1 1
// Original:
// X_T1741[n0, n1, n2, 1056 + a : _T2488, _T2489, _T2490, _T2491] = =(X_T1740[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1741[n0, n1, n2, 1056 + a : _T2488, _T2489, _T2490, _T2491] = =(X_T1740[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_598(__global float* restrict  X_T1741, __global const float* restrict  in1)
{
  X_T1741 = (X_T1741 + 1056);
