...
// lid: 256 1 1
// Original:
// X_T210[n0, n1, n2, 224 + a : _T248, _T249, _T250, _T251] = =(X_T209[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T210[n0, n1, n2, 224 + a : _T248, _T249, _T250, _T251] = =(X_T209[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_58(__global float* restrict  X_T210, __global const float* restrict  in1)
{
  X_T210 = (X_T210 + 224);
