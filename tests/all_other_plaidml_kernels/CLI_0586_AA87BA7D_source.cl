...
// lid: 256 1 1
// Original:
// X_T1941[n0, n1, n2, 1312 + a : _T2784, _T2785, _T2786, _T2787] = =(X_T1940[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1941[n0, n1, n2, 1312 + a : _T2784, _T2785, _T2786, _T2787] = =(X_T1940[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1312 + a < 1344, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1941[n0, n1, n2, 1312 + a : _T2784, _T2785, _T2786, _T2787] = =(X_T1940[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1941   X_T1940  
//        a        32         1         1  
//       n1         7      9408       224  
//       n2         7      1344        32  
//      off                1312         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_670(__global float* restrict  X_T1941, __global const float* restrict  in1)
{
  X_T1941 = (X_T1941 + 1312);
  ...
  if (n2_cond)
  {
    float LX_T1941 = agg[0];
    int gout_idx = ((a_tid + (9408 * n1_gid)) + (1344 * n2_tid));
    X_T1941[gout_idx] = LX_T1941;
  }
}
