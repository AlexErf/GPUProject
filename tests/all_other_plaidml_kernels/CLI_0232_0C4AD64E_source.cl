...
// lid: 256 1 1
// Original:
// X_T254[n, o0, o1, c : _T274, _T275, _T276, _T277] = =(X_T253[])
// With Index Variables Made Integral:
// X_T254[n, o0, o1, c : _T274, _T275, _T276, _T277] = =(X_T253[]), 500000000 + c < 1000000000, 500000000 + n < 1000000000, 500000000 + o0 < 1000000000, 500000000 + o1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 2
__kernel void kernel_c124_sdk_64(__global float* restrict  X_T254)
{
  ...
  for (int c_lid = 0; c_lid < 2; c_lid += 1)
  {
    ...
    for (int o1_lid = 0; o1_lid < 2; o1_lid += 1)
    {
      ...
      {
        int o0 = ((2 * o0_lid) + o0_tid);
        float LX_T254 = agg[((c_lid + (o1_lid * 2)) + (o0_lid * 4))];
