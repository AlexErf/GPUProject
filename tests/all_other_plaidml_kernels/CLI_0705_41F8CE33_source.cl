...
// lid: 256 1 1
// Original:
// X_T2349[n0, n1, n2, 1568 + a : _T3376, _T3377, _T3378, _T3379] = =(X_T2348[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2349[n0, n1, n2, 1568 + a : _T3376, _T3377, _T3378, _T3379] = =(X_T2348[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_814(__global float* restrict  X_T2349, __global const float* restrict  in1)
{
  X_T2349 = (X_T2349 + 1568);
  ...
  if (n2_cond)
  {
    float LX_T2349 = agg[0];
    int gout_idx = ((a_tid + (11200 * n1_gid)) + (1600 * n2_tid));
    X_T2349[gout_idx] = LX_T2349;
  }
}
