...
// lid: 256 1 1
// Original:
// X_T1861[n0, n1, n2, 336 + a : _T2940, _T2941, _T2942, _T2943] = =(X_T1860[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1861[n0, n1, n2, 336 + a : _T2940, _T2941, _T2942, _T2943] = =(X_T1860[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= a < 336, 0 <= 336 + a < 2016, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= a < 336 }
// Defracted:
// X_T1861[n0, n1, n2, 336 + a : _T2940, _T2941, _T2942, _T2943] = =(X_T1860[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1861   X_T1860  
//        a       336         1         1  
//       n1        21     42336      7056  
//       n2        21      2016       336  
//      off                 336         0  
...
// lwork = 256, 1, 1
// gwork = 768, 11, 11
__kernel void kernel_c42_sdk_709(__global float* restrict  X_T1861, __global const float* restrict  in1)
{
  X_T1861 = (X_T1861 + 336);
