...
// Ranges: { 864 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(3, 3, 96, 1):(288, 96, 1, 1):3.375 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 256 }
// Contraction output var shape: fp32(3, 3, 96, 1):(288, 96, 1, 1):3.375 KiB
...
__kernel void kernel_c8_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  if (i1_i2_i3_i4_cond)
  {
    ...
    float LX_T8 = (0.16580533981323242f * LX_T7);
    float LX_T9 = (-0.08290266990661621f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
