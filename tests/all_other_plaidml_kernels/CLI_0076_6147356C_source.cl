...
// lid: 256 1 1
// Original:
// X_T684[x0, y1 : _T824, _T825] = +(X_T683[x0, z] * X_I_1[z, y1])
// With Index Variables Made Integral:
// X_T684[x0, y1 : _T824, _T825] = +(X_T683[x0, z] * X_I_1[z, y1]), 500000000 + x0 < 1000000000, 500000000 + y1 < 1000000000, 500000000 + z < 1000000000
...
// Elementwise op: [[pid(Add)]] X_T685 = add(X_T684, X_I_0)
// Tile size: { 64, 64 }
...
// lwork = 256, 1, 1
// gwork = 4096, 1, 1
__kernel void kernel_c29_sdk_163(__global float* restrict  X_T685, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_0)
{
