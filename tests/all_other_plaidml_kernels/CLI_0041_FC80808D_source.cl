...
// lid: 256 1 1
// Original:
// X_T98[n, x0, x1, c : _T137, _T138, _T139, _T140] = >(X_T96[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 2, k1 < 2
// With Index Variables Made Integral:
// X_T98[n, x0, x1, c : _T137, _T138, _T139, _T140] = >(X_T96[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 2, k1 < 2, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c18_sdk_20(__global float* restrict  X_T98, __global const float* restrict  in1)
{
  ...
  if (x1_cond)
  {
    ...
    {
      int c = ((32 * c_lid) + c_tid);
      float LX_T98 = agg[c_lid];
      LX_T98 = select((float)LX_T98, (float)0, (int)(LX_T98 == (float)-FLT_MAX));
