...
// lid: 256 1 1
// Original:
// X_T990[n0, n1, n2, 1088 + a : _T1397, _T1398, _T1399, _T1400] = =(X_T989[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T990[n0, n1, n2, 1088 + a : _T1397, _T1398, _T1399, _T1400] = =(X_T989[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 8, 0 <= n2 < 8, 0 <= n1 < 8, 0 <= n2 < 8, 0 <= a < 768, 0 <= 1088 + a < 2048, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1536, 8, 1
__kernel void kernel_c56_sdk_339(__global float* restrict  X_T990, __global const float* restrict  in1)
{
  X_T990 = (X_T990 + 1088);
  ...
  {
    int a = ((32 * a_lid) + a_tid);
    float LX_T990 = agg[a_lid];
    int gout_idx = (((a_gid + a) + (16384 * n1_gid)) + (2048 * n2_tid));
    X_T990[gout_idx] = LX_T990;
  }
}
