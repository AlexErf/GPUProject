...
// lid: 256 1 1
// Original:
// X_T1666[n0, n1, n2, 960 + a : _T2377, _T2378, _T2379, _T2380] = =(X_T1665[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1666[n0, n1, n2, 960 + a : _T2377, _T2378, _T2379, _T2380] = =(X_T1665[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_571(__global float* restrict  X_T1666, __global const float* restrict  in1)
{
  X_T1666 = (X_T1666 + 960);
