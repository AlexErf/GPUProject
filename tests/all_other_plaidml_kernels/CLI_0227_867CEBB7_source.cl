...
// lid: 256 1 1
// Original:
// X_T1144[i, 0 : _T1619, _T1620] = +(X_T1142[i, j])
// With Index Variables Made Integral:
// X_T1144[i, 0 : _T1619, _T1620] = +(X_T1142[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c56_sdk_396(__global float* restrict  X_T1144, __global const float* restrict  in1)
{
