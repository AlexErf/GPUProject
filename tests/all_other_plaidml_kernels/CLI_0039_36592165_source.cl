...
// Ranges: { 1024000 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 1024, 1000):(1024000, 1024000, 1000, 1):4000 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 4096 }
// Contraction output var shape: fp32(1, 1, 1024, 1000):(1024000, 1024000, 1000, 1):4000 KiB
...
__kernel void kernel_c23_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i3_i4_lid = 0; i3_i4_lid < 16; i3_i4_lid += 1)
  {
    ...
    float LX_T8 = (0.10889310389757156f * LX_T7);
    float LX_T9 = (-0.05444655194878578f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
