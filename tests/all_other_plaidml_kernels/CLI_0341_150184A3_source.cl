...
// lid: 256 1 1
// Original:
// X_T846[n0, n1, n2, 576 + a : _T1162, _T1163, _T1164, _T1165] = =(X_T845[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T846[n0, n1, n2, 576 + a : _T1162, _T1163, _T1164, _T1165] = =(X_T845[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c108_sdk_277(__global float* restrict  X_T846, __global const float* restrict  in1)
{
  X_T846 = (X_T846 + 576);
