...
// Ranges: { 24576 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 192, 128):(24576, 24576, 128, 1):96 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 1024 }
// Contraction output var shape: fp32(1, 1, 192, 128):(24576, 24576, 128, 1):96 KiB
...
__kernel void kernel_c12_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i3_i4_lid = 0; i3_i4_lid < 4; i3_i4_lid += 1)
  {
    ...
    float LX_T8 = (0.273861289024353f * LX_T7);
    float LX_T9 = (-0.1369306445121765f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
