...
// lid: 256 1 1
// Original:
// X_T266[n0, n1, n2, a : _T372, _T373, _T374, _T375] = =(X_T263[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T266[n0, n1, n2, a : _T372, _T373, _T374, _T375] = =(X_T263[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= a < 42, 0 <= n1 < 83, 0 <= n2 < 83, 0 <= n1 < 83, 0 <= n2 < 83, 0 <= a < 84, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 5376, 83, 1
__kernel void kernel_c42_sdk_85(__global float* restrict  X_T266, __global const float* restrict  in1)
{
