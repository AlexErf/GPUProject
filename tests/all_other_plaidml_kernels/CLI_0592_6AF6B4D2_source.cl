...
// lid: 256 1 1
// Original:
// X_T1966[n0, n1, n2, 1344 + a : _T2821, _T2822, _T2823, _T2824] = =(X_T1965[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1966[n0, n1, n2, 1344 + a : _T2821, _T2822, _T2823, _T2824] = =(X_T1965[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_679(__global float* restrict  X_T1966, __global const float* restrict  in1)
{
  X_T1966 = (X_T1966 + 1344);
  ...
  if (n2_cond)
  {
    float LX_T1966 = agg[0];
    int gout_idx = ((a_tid + (9632 * n1_gid)) + (1376 * n2_tid));
    X_T1966[gout_idx] = LX_T1966;
  }
}
