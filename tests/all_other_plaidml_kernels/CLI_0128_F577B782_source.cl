...
// lid: 256 1 1
// Original:
// X_T353[n0, n1, n2, 22 + a : _T529, _T530, _T531, _T532] = =(X_T352[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T353[n0, n1, n2, 22 + a : _T529, _T530, _T531, _T532] = =(X_T352[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= a < 22, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= 22 + a < 88, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1792, 14, 1
__kernel void kernel_c42_sdk_120(__global float* restrict  X_T353, __global const float* restrict  in1)
{
  X_T353 = (X_T353 + 22);
