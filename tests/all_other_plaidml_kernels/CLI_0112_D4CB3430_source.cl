...
// Elementwise input X_I_38 shape: fp32(192):(1):768 bytes
// Elementwise op: [[pid(TrueDiv)]] X_T80 = div(X_T75, X_T79)
// Elementwise op: [[pid(Add, Switch)]] X_T81 = add(X_T80, X_I_38)
...
// lwork = 256, 1, 1
// gwork = 9216, 71, 1
__kernel void kernel_c56_sdk_15(__global float* restrict  X_T83, __global const float* restrict  X_T75, __global const float* restrict  X_T79, __global const float* restrict  X_I_38)
{
