...
// lid: 256 1 1
// Original:
// X_T456[n0, n1, n2, 384 + a : _T613, _T614, _T615, _T616] = =(X_T455[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T456[n0, n1, n2, 384 + a : _T613, _T614, _T615, _T616] = =(X_T455[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_145(__global float* restrict  X_T456, __global const float* restrict  in1)
{
  X_T456 = (X_T456 + 384);
