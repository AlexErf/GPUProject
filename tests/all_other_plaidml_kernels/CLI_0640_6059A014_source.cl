...
// lid: 256 1 1
// Original:
// X_T2166[n0, n1, n2, 1600 + a : _T3117, _T3118, _T3119, _T3120] = =(X_T2165[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2166[n0, n1, n2, 1600 + a : _T3117, _T3118, _T3119, _T3120] = =(X_T2165[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_751(__global float* restrict  X_T2166, __global const float* restrict  in1)
{
  X_T2166 = (X_T2166 + 1600);
  ...
  if (n2_cond)
  {
    float LX_T2166 = agg[0];
    int gout_idx = ((a_tid + (11424 * n1_gid)) + (1632 * n2_tid));
    X_T2166[gout_idx] = LX_T2166;
  }
}
