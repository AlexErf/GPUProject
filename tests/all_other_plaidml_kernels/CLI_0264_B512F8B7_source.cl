...
// lid: 256 1 1
// Original:
// X_T409[n0, n1, n2, 288 + a : _T502, _T503, _T504, _T505] = =(X_T408[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T409[n0, n1, n2, 288 + a : _T502, _T503, _T504, _T505] = =(X_T408[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c124_sdk_118(__global float* restrict  X_T409, __global const float* restrict  in1)
{
  X_T409 = (X_T409 + 288);
