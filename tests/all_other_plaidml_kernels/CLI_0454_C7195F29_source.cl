...
// lid: 256 1 1
// Original:
// X_T1602[i, 0 : _T2292, _T2293] = +(X_T1600[i, j])
// With Index Variables Made Integral:
// X_T1602[i, 0 : _T2292, _T2293] = +(X_T1600[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c68_sdk_552(__global float* restrict  X_T1602, __global const float* restrict  in1)
{
