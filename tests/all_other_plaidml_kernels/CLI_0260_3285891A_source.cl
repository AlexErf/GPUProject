...
// lid: 256 1 1
// Original:
// X_T478[n0, n1, n2, a : _T618, _T619, _T620, _T621] = =(X_T477[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T478[n0, n1, n2, a : _T618, _T619, _T620, _T621] = =(X_T477[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 28, 1
__kernel void kernel_c108_sdk_147(__global float* restrict  X_T478, __global const float* restrict  in1)
{
