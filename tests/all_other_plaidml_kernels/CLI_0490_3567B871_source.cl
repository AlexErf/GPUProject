...
// lid: 256 1 1
// Original:
// X_T1466[n0, n1, n2, 704 + a : _T2081, _T2082, _T2083, _T2084] = =(X_T1465[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1466[n0, n1, n2, 704 + a : _T2081, _T2082, _T2083, _T2084] = =(X_T1465[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_499(__global float* restrict  X_T1466, __global const float* restrict  in1)
{
  X_T1466 = (X_T1466 + 704);
