...
// lid: 256 1 1
// Original:
// X_T188[n0, n1, n2, 160 + a : _T174, _T175, _T176, _T177] = =(X_T187[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T188[n0, n1, n2, 160 + a : _T174, _T175, _T176, _T177] = =(X_T187[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c124_sdk_40(__global float* restrict  X_T188, __global const float* restrict  in1)
{
  X_T188 = (X_T188 + 160);
