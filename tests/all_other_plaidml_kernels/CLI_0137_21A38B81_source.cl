...
// lid: 256 1 1
// Original:
// X_T207[n0, n1, n2, 64 + a : _T251, _T252, _T253, _T254] = =(X_T206[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T207[n0, n1, n2, 64 + a : _T251, _T252, _T253, _T254] = =(X_T206[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= a < 64, 0 <= 64 + a < 288, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 8960, 1, 1
__kernel void kernel_c56_sdk_58(__global float* restrict  X_T207, __global const float* restrict  in1)
{
  X_T207 = (X_T207 + 64);
  ...
  for (int n2_lid = 0; n2_lid < 5; n2_lid += 1)
  {
    ...
    if (n2_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T207 = agg[(a_lid + (n2_lid * 2))];
