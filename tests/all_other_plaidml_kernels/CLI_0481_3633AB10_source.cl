...
// lid: 256 1 1
// Original:
// X_T1331[n0, n1, n2, a : _T1870, _T1871, _T1872, _T1873] = =(X_T1330[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1331[n0, n1, n2, a : _T1870, _T1871, _T1872, _T1873] = =(X_T1330[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 19, 1
__kernel void kernel_c124_sdk_450(__global float* restrict  X_T1331, __global const float* restrict  in1)
{
  ...
  for (int n2_lid = 0; n2_lid < 4; n2_lid += 1)
  {
    ...
    if (n2_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T1331 = agg[(a_lid + (n2_lid * 2))];
        int gout_idx = (((a_gid + a) + (17472 * (n1_gid + n1_tid))) + (1248 * n2));
        X_T1331[gout_idx] = LX_T1331;
      }
    }
  }
}
