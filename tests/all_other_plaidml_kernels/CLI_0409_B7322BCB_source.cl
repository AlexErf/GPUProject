...
// lid: 256 1 1
// Original:
// X_T1031[n0, n1, n2, a : _T1426, _T1427, _T1428, _T1429] = =(X_T1030[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1031[n0, n1, n2, a : _T1426, _T1427, _T1428, _T1429] = =(X_T1030[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 14, 1
__kernel void kernel_c124_sdk_342(__global float* restrict  X_T1031, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 7; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T1031 = agg[a_lid];
      int gout_idx = ((a + (12096 * (n1_gid + n1_tid))) + (864 * n2_gid));
      X_T1031[gout_idx] = LX_T1031;
    }
  }
}
