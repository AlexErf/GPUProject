...
// lid: 256 1 1
// Original:
// X_T426[n0, n1, n2, 168 + a : _T639, _T640, _T641, _T642] = =(X_T425[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T426[n0, n1, n2, 168 + a : _T639, _T640, _T641, _T642] = =(X_T425[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= a < 84, 0 <= 168 + a < 336, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 5376, 21, 1
__kernel void kernel_c42_sdk_146(__global float* restrict  X_T426, __global const float* restrict  in1)
{
  X_T426 = (X_T426 + 168);
  ...
  for (int a_lid = 0; a_lid < 2; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T426 = agg[a_lid];
      int gout_idx = ((a + (14112 * (n1_gid + n1_tid))) + (336 * (n2_gid + n2_tid)));
      X_T426[gout_idx] = LX_T426;
    }
  }
}
