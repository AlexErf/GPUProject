...
// lid: 256 1 1
// Original:
// X_T263[n, x0, x1, co : _T367, _T368, _T369, _T370] = +(X_T262[n, k0 + x0, k1 + x1, ci] * X_I_135[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T263[n, x0, x1, co : _T367, _T368, _T369, _T370] = +(X_T262[n, k0 + x0, k1 + x1, ci] * X_I_135[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 2816, 11, 1
__kernel void kernel_c42_sdk_84(__global float* restrict  X_T263, __global const float* restrict  in1, __global const float* restrict  in2)
{
        ...
        if (x0_cond)
        {
          ...
          for (int co_lid = 0; co_lid < 2; co_lid += 1)
          {
            ...
            if (co_cond)
            {
              ...
              float LX_T263 = agg[((co_lid + (x1_lid * 2)) + (x0_lid * 4))];
