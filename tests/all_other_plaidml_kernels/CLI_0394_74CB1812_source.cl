...
// lid: 256 1 1
// Original:
// X_T1298[n0, n1, n2, a : _T1864, _T1865, _T1866, _T1867] = =(X_T1297[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1298[n0, n1, n2, a : _T1864, _T1865, _T1866, _T1867] = =(X_T1297[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1536, 7, 1
__kernel void kernel_c68_sdk_447(__global float* restrict  X_T1298, __global const float* restrict  in1)
{
