...
// lid: 256 1 1
// Original:
// X_T2141[n0, n1, n2, 1568 + a : _T3080, _T3081, _T3082, _T3083] = =(X_T2140[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2141[n0, n1, n2, 1568 + a : _T3080, _T3081, _T3082, _T3083] = =(X_T2140[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1568 + a < 1600, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2141[n0, n1, n2, 1568 + a : _T3080, _T3081, _T3082, _T3083] = =(X_T2140[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2141   X_T2140  
//        a        32         1         1  
//       n1         7     11200       224  
//       n2         7      1600        32  
//      off                1568         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_742(__global float* restrict  X_T2141, __global const float* restrict  in1)
{
  X_T2141 = (X_T2141 + 1568);
  ...
  if (n2_cond)
  {
    float LX_T2141 = agg[0];
    int gout_idx = ((a_tid + (11200 * n1_gid)) + (1600 * n2_tid));
    X_T2141[gout_idx] = LX_T2141;
  }
}
