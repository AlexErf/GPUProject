...
// lid: 256 1 1
// Original:
// X_T112[i, 0 : _T137, _T138] = >(X_T99[i, j])
// With Index Variables Made Integral:
// X_T112[i, 0 : _T137, _T138] = >(X_T99[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c18_sdk_21(__global float* restrict  X_T112, __global const float* restrict  in1)
{
  ...
  {
    float LX_T112 = agg[0];
    LX_T112 = select((float)LX_T112, (float)0, (int)(LX_T112 == (float)-FLT_MAX));
    X_T112[0] = LX_T112;
  }
}
