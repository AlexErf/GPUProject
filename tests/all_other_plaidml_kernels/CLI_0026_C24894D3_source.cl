...
// Ranges: { 4096000 }
// Out stride: { 1 }
// Elementwise input X_T6 shape: fp32(4096, 1000):(1000, 1):16000 KiB
// Elementwise op: [[pid(RevMul)]] X_T7 = mul(X_T5, X_T6)
// Elementwise op: [[pid(Add)]] X_T8 = add(X_T4, X_T7)
// Tile size: { 4096 }
// Contraction output var shape: fp32(4096, 1000):(1000, 1):16000 KiB
// Computed true ops: 8192000
// Computed work groups: 1000
...
__kernel void kernel_c16_sdk_1(__global float* restrict  X_T8, __global const float* restrict  X_T6)
{
  ...
  for (int i1_i2_lid = 0; i1_i2_lid < 16; i1_i2_lid += 1)
  {
    ...
    float LX_T7 = (0.06862635165452957f * LX_T6);
    float LX_T8 = (-0.034313175827264786f + LX_T7);
    X_T8[gout_idx] = LX_T8;
  }
}
