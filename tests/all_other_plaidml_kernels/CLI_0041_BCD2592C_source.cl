...
// lid: 256 1 1
// Original:
// X_T86[n, x0, x1, c : _T116, _T117, _T118, _T119] = >(X_T84[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 2, k1 < 2
// With Index Variables Made Integral:
// X_T86[n, x0, x1, c : _T116, _T117, _T118, _T119] = >(X_T84[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 2, k1 < 2, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c18_sdk_17(__global float* restrict  X_T86, __global const float* restrict  in1)
{
  ...
  if (x1_cond)
  {
    ...
    {
      int c = ((32 * c_lid) + c_tid);
      float LX_T86 = agg[c_lid];
      LX_T86 = select((float)LX_T86, (float)0, (int)(LX_T86 == (float)-FLT_MAX));
