...
// lid: 256 1 1
// Original:
// X_T1421[n0, n1, n2, 800 + a : _T2044, _T2045, _T2046, _T2047] = =(X_T1420[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1421[n0, n1, n2, 800 + a : _T2044, _T2045, _T2046, _T2047] = =(X_T1420[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 800 + a < 832, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1421[n0, n1, n2, 800 + a : _T2044, _T2045, _T2046, _T2047] = =(X_T1420[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1421   X_T1420  
//        a        32         1         1  
//       n1         7      5824       224  
//       n2         7       832        32  
//      off                 800         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_490(__global float* restrict  X_T1421, __global const float* restrict  in1)
{
  X_T1421 = (X_T1421 + 800);
  ...
  if (n2_cond)
  {
    float LX_T1421 = agg[0];
    int gout_idx = ((a_tid + (5824 * n1_gid)) + (832 * n2_tid));
    X_T1421[gout_idx] = LX_T1421;
  }
}
