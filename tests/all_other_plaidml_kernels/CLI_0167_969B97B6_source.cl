...
// lid: 256 1 1
// Original:
// X_T657[n0, n1, n2, 672 + a : _T1014, _T1015, _T1016, _T1017] = =(X_T656[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T657[n0, n1, n2, 672 + a : _T1014, _T1015, _T1016, _T1017] = =(X_T656[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= a < 168, 0 <= 672 + a < 1008, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 5376, 42, 1
__kernel void kernel_c42_sdk_237(__global float* restrict  X_T657, __global const float* restrict  in1)
{
  X_T657 = (X_T657 + 672);
