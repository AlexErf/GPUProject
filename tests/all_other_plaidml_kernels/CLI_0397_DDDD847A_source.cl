...
// lid: 256 1 1
// Original:
// X_T981[n0, n1, n2, a : _T1352, _T1353, _T1354, _T1355] = =(X_T980[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T981[n0, n1, n2, a : _T1352, _T1353, _T1354, _T1355] = =(X_T980[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1536, 14, 1
__kernel void kernel_c124_sdk_324(__global float* restrict  X_T981, __global const float* restrict  in1)
{
  ...
  for (int n1_lid = 0; n1_lid < 2; n1_lid += 1)
  {
    ...
    if (n1_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T981 = agg[(a_lid + (n1_lid * 4))];
