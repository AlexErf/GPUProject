...
// Elementwise input X_T1225 shape: fp32(1, 14, 14, 1088):(213248, 15232, 1088, 1):833 KiB
// Elementwise input X_T1229 shape: fp32(1088):(1):4.25 KiB
// Elementwise input X_I_470 shape: fp32(1088):(1):4.25 KiB
// Elementwise op: [[pid(TrueDiv)]] X_T1230 = div(X_T1225, X_T1229)
// Elementwise op: [[pid(Add, Switch)]] X_T1231 = add(X_T1230, X_I_470)
...
// lwork = 256, 1, 1
// gwork = 1792, 34, 1
__kernel void kernel_c108_sdk_416(__global float* restrict  X_T1233, __global const float* restrict  X_T1225, __global const float* restrict  X_T1229, __global const float* restrict  X_I_470)
{
  ...
  for (int i3_lid = 0; i3_lid < 4; i3_lid += 1)
  {
    ...
    if (i3_cond)
    {
      ...
      float LX_T1229 = X_T1229[(i4_gid + i4_tid)];
      float LX_I_470 = X_I_470[(i4_gid + i4_tid)];
      float LX_T1230 = (LX_T1225 / LX_T1229);
      float LX_T1231 = (LX_T1230 + LX_I_470);
