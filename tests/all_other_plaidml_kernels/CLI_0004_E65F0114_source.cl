...
// Ranges: { 8192 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 64, 128):(8192, 8192, 128, 1):32 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 512 }
// Contraction output var shape: fp32(1, 1, 64, 128):(8192, 8192, 128, 1):32 KiB
...
__kernel void kernel_c3_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i3_i4_lid = 0; i3_i4_lid < 2; i3_i4_lid += 1)
  {
    ...
    float LX_T8 = (0.3535533845424652f * LX_T7);
    float LX_T9 = (-0.1767766922712326f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
