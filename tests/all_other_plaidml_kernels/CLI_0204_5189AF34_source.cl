...
// lid: 256 1 1
// Original:
// X_T138[n0, n1, n2, 96 + a : _T100, _T101, _T102, _T103] = =(X_T137[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T138[n0, n1, n2, 96 + a : _T100, _T101, _T102, _T103] = =(X_T137[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c124_sdk_22(__global float* restrict  X_T138, __global const float* restrict  in1)
{
  X_T138 = (X_T138 + 96);
