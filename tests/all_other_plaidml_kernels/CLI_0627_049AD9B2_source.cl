...
// lid: 256 1 1
// Original:
// X_T1951[n0, n1, n2, a : _T2789, _T2790, _T2791, _T2792] = =(X_T1950[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1951[n0, n1, n2, a : _T2789, _T2790, _T2791, _T2792] = =(X_T1950[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 9, 1
__kernel void kernel_c124_sdk_672(__global float* restrict  X_T1951, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 4; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      if (n2_cond)
      {
        float LX_T1951 = agg[a_lid];
        int gout_idx = (((a_gid + a) + (7840 * n1_gid)) + (1120 * n2_tid));
        X_T1951[gout_idx] = LX_T1951;
      }
    }
  }
}
