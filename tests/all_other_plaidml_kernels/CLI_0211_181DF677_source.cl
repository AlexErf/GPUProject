...
// lid: 256 1 1
// Original:
// X_T992[n, x0, x1, c : _T1402, _T1403, _T1404, _T1405] = +(X_T896[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T992[n, x0, x1, c : _T1402, _T1403, _T1404, _T1405] = +(X_T896[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 2560, 2, 1
__kernel void kernel_c56_sdk_341(__global float* restrict  X_T992, __global const float* restrict  in1)
{
  in1 = (in1 + -11520);
