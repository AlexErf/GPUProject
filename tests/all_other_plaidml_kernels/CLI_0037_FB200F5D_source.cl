...
// Ranges: { 995328 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(3, 3, 288, 384):(331776, 110592, 384, 1):3888 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 4096 }
// Contraction output var shape: fp32(3, 3, 288, 384):(331776, 110592, 384, 1):3888 KiB
// Computed true ops: 1990656
...
__kernel void kernel_c22_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i1_i2_i3_i4_lid = 0; i1_i2_i3_i4_lid < 16; i1_i2_i3_i4_lid += 1)
  {
    ...
    float LX_T8 = (0.0629940778017044f * LX_T7);
    float LX_T9 = (-0.0314970389008522f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
