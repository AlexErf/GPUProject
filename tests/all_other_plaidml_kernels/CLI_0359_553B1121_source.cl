...
// lid: 256 1 1
// Original:
// X_T829[n0, n1, n2, 544 + a : _T1125, _T1126, _T1127, _T1128] = =(X_T828[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T829[n0, n1, n2, 544 + a : _T1125, _T1126, _T1127, _T1128] = =(X_T828[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c124_sdk_268(__global float* restrict  X_T829, __global const float* restrict  in1)
{
  X_T829 = (X_T829 + 544);
