...
// lid: 256 1 1
// Original:
// X_T351[n0, n1, n2, 224 + a : _T428, _T429, _T430, _T431] = =(X_T350[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T351[n0, n1, n2, 224 + a : _T428, _T429, _T430, _T431] = =(X_T350[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c108_sdk_100(__global float* restrict  X_T351, __global const float* restrict  in1)
{
  X_T351 = (X_T351 + 224);
  ...
  for (int n1_lid = 0; n1_lid < 4; n1_lid += 1)
  {
    ...
    {
      int n1 = ((8 * n1_lid) + n1_tid);
      float LX_T351 = agg[n1_lid];
      int gout_idx = ((a_tid + (7168 * n1)) + (256 * n2_gid));
      X_T351[gout_idx] = LX_T351;
    }
  }
}
