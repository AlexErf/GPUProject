...
// lid: 256 1 1
// Original:
// X_T2878[n0, n1, n2, a : _T4569, _T4570, _T4571, _T4572] = =(X_T2877[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2878[n0, n1, n2, a : _T4569, _T4570, _T4571, _T4572] = =(X_T2877[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 11, 0 <= n2 < 11, 0 <= n1 < 11, 0 <= n2 < 11, 0 <= a < 672, 0 <= a < 2688, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 11, 0 <= n2 < 11, 0 <= a < 672 }
// Defracted:
// X_T2878[n0, n1, n2, a : _T4569, _T4570, _T4571, _T4572] = =(X_T2877[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2878   X_T2877  
//        a       672         1         1  
//       n1        11     29568      7392  
//       n2        11      2688       672  
//      off                   0         0  
...
// lwork = 256, 1, 1
// gwork = 768, 11, 11
__kernel void kernel_c42_sdk_1111(__global float* restrict  X_T2878, __global const float* restrict  in1)
{
