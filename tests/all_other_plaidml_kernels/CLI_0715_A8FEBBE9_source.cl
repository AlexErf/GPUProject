...
// lid: 256 1 1
// Original:
// X_T2399[n0, n1, n2, 1632 + a : _T3450, _T3451, _T3452, _T3453] = =(X_T2398[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2399[n0, n1, n2, 1632 + a : _T3450, _T3451, _T3452, _T3453] = =(X_T2398[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1632 + a < 1664, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T2399[n0, n1, n2, 1632 + a : _T3450, _T3451, _T3452, _T3453] = =(X_T2398[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2399   X_T2398  
//        a        32         1         1  
//       n1         7     11648       224  
//       n2         7      1664        32  
//      off                1632         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_832(__global float* restrict  X_T2399, __global const float* restrict  in1)
{
  X_T2399 = (X_T2399 + 1632);
  ...
  if (n2_cond)
  {
    float LX_T2399 = agg[0];
    int gout_idx = ((a_tid + (11648 * n1_gid)) + (1664 * n2_tid));
    X_T2399[gout_idx] = LX_T2399;
  }
}
