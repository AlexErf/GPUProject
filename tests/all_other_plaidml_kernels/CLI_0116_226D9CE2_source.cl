...
// lid: 256 1 1
// Original:
// X_T95[n0, n1, n2, a : _T93, _T94, _T95, _T96] = =(X_T94[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T95[n0, n1, n2, a : _T93, _T94, _T95, _T96] = =(X_T94[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= a < 64, 0 <= a < 256, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 8960, 1, 1
__kernel void kernel_c56_sdk_20(__global float* restrict  X_T95, __global const float* restrict  in1)
{
  ...
  for (int n2_lid = 0; n2_lid < 5; n2_lid += 1)
  {
    ...
    if (n2_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T95 = agg[(a_lid + (n2_lid * 2))];
