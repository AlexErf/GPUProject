...
// lid: 256 1 1
// Original:
// X_T422[n, x0, x1, co : _T521, _T522, _T523, _T524] = +(X_T421[n, k0 + x0, k1 + x1, ci] * X_I_148[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T422[n, x0, x1, co : _T521, _T522, _T523, _T524] = +(X_T421[n, k0 + x0, k1 + x1, ci] * X_I_148[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T423 = sub(X_T422, X_I_147)
// Elementwise op: [[pid(Mul)]] X_T424 = mul(X_T423, X_I_146)
...
// lwork = 256, 1, 1
// gwork = 1792, 2, 2
__kernel void kernel_c124_sdk_123(__global float* restrict  X_T424, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_147, __global const float* restrict  X_I_146)
{
