...
// lid: 256 1 1
// Original:
// X_T1221[n0, n1, n2, 544 + a : _T1748, _T1749, _T1750, _T1751] = =(X_T1220[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1221[n0, n1, n2, 544 + a : _T1748, _T1749, _T1750, _T1751] = =(X_T1220[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 544 + a < 576, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_418(__global float* restrict  X_T1221, __global const float* restrict  in1)
{
  X_T1221 = (X_T1221 + 544);
  ...
  if (n2_cond)
  {
    ...
    int gout_idx = ((a_tid + (4032 * n1_gid)) + (576 * n2_tid));
