...
// Ranges: { 45056 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 352, 128):(45056, 45056, 128, 1):176 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 2048 }
// Contraction output var shape: fp32(1, 1, 352, 128):(45056, 45056, 128, 1):176 KiB
// Computed true ops: 90112
