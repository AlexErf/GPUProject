...
// Ranges: { 16384 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(1, 1, 256, 64):(16384, 16384, 64, 1):64 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 1024 }
// Contraction output var shape: fp32(1, 1, 256, 64):(16384, 16384, 64, 1):64 KiB
// Computed true ops: 16384
...
// lwork = 256, 1, 1
// gwork = 4096, 1, 1
__kernel void kernel_c7_sdk_0(__global float* restrict  X_T0, __global const float* restrict  X_I_0)
{
