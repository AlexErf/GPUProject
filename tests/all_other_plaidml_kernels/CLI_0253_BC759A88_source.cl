...
// lid: 256 1 1
// Original:
// X_T2291[n0, n1, n2, 352 + a : _T3633, _T3634, _T3635, _T3636] = =(X_T2290[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2291[n0, n1, n2, 352 + a : _T3633, _T3634, _T3635, _T3636] = =(X_T2290[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 176, 0 <= 352 + a < 704, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 176 }
// Defracted:
// X_T2291[n0, n1, n2, 352 + a : _T3633, _T3634, _T3635, _T3636] = =(X_T2290[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2291   X_T2290  
//        a       176         1         1  
//       n1         7      4928      1232  
//       n2         7       704       176  
//      off                 352         0  
...
// lwork = 256, 1, 1
// gwork = 768, 7, 1
__kernel void kernel_c42_sdk_876(__global float* restrict  X_T2291, __global const float* restrict  in1)
{
  X_T2291 = (X_T2291 + 352);
  ...
  for (int a_lid = 0; a_lid < 2; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      if (n1_cond)
      {
        float LX_T2291 = agg[a_lid];
        int gout_idx = (((a_gid + a) + (4928 * n1_tid)) + (704 * n2_gid));
        X_T2291[gout_idx] = LX_T2291;
      }
    }
  }
}
