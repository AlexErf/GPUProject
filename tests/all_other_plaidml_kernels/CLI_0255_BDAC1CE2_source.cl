...
// lid: 256 1 1
// Original:
// X_T361[n0, n1, n2, a : _T433, _T434, _T435, _T436] = =(X_T360[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T361[n0, n1, n2, a : _T433, _T434, _T435, _T436] = =(X_T360[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 2, 1
__kernel void kernel_c124_sdk_102(__global float* restrict  X_T361, __global const float* restrict  in1)
{
  ...
  for (int n1_lid = 0; n1_lid < 4; n1_lid += 1)
  {
    ...
    if (n1_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T361 = agg[(a_lid + (n1_lid * 4))];
