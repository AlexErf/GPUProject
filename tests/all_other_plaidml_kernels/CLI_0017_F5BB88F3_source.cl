...
// Ranges: { 378 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(3, 3, 42, 1):(126, 42, 1, 1):1.47656 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 128 }
// Contraction output var shape: fp32(3, 3, 42, 1):(126, 42, 1, 1):1.47656 KiB
// Computed true ops: 756
...
__kernel void kernel_c11_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  int i1_i2_i3_i4_cond = ((i1_i2_i3_i4_gid != 256) || (i1_i2_i3_i4_tid < 122));
  if (i1_i2_i3_i4_cond)
  {
    if ((tid < 128))
    {
      ...
      float LX_T8 = (0.24902912974357605f * LX_T7);
      float LX_T9 = (-0.12451456487178802f + LX_T8);
      X_T9[gout_idx] = LX_T9;
    }
  }
}
