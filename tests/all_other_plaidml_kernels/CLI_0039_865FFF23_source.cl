...
// lid: 256 1 1
// Original:
// X_T72[n, x0, x1, c : _T89, _T90, _T91, _T92] = >(X_T71[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 2, k1 < 2
// With Index Variables Made Integral:
// X_T72[n, x0, x1, c : _T89, _T90, _T91, _T92] = >(X_T71[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 2, k1 < 2, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 2, 1
__kernel void kernel_c18_sdk_13(__global float* restrict  X_T72, __global const float* restrict  in1)
{
  ...
  for (int x0_lid = 0; x0_lid < 2; x0_lid += 1)
  {
    ...
    if (x0_cond)
    {
      ...
      {
        int c = ((32 * c_lid) + c_tid);
        float LX_T72 = agg[(c_lid + (x0_lid * 8))];
        LX_T72 = select((float)LX_T72, (float)0, (int)(LX_T72 == (float)-FLT_MAX));
