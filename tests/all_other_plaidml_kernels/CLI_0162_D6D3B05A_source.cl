...
// lid: 256 1 1
// Original:
// X_T646[n, x0, x1, c : _T973, _T974, _T975, _T976] = +(X_T521[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T646[n, x0, x1, c : _T973, _T974, _T975, _T976] = +(X_T521[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 2, 1
__kernel void kernel_c42_sdk_229(__global float* restrict  X_T646, __global const float* restrict  in1)
{
  in1 = (in1 + -1276);
    ...
    if (x0_cond)
    {
      ...
      for (int c_lid = 0; c_lid < 2; c_lid += 1)
      {
        ...
        if (c_cond)
        {
          ...
          float LX_T646 = agg[(c_lid + (x0_lid * 2))];
