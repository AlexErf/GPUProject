...
// Ranges: { 2560000 }
// Out stride: { 1 }
// Elementwise input X_T6 shape: fp32(20000, 128):(128, 1):10000 KiB
// Elementwise op: [[pid(RevMul)]] X_T7 = mul(X_T5, X_T6)
// Elementwise op: [[pid(Add)]] X_T8 = add(X_T4, X_T7)
// Tile size: { 4096 }
// Contraction output var shape: fp32(20000, 128):(128, 1):10000 KiB
// Computed true ops: 5120000
...
__kernel void kernel_c1_sdk_1(__global float* restrict  X_T8, __global const float* restrict  X_T6)
{
  ...
  for (int i1_i2_lid = 0; i1_i2_lid < 16; i1_i2_lid += 1)
  {
    ...
    float LX_T7 = (0.10000000149011612f * LX_T6);
    float LX_T8 = (-0.05000000074505806f + LX_T7);
    X_T8[gout_idx] = LX_T8;
  }
}
