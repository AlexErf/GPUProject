...
// lid: 256 1 1
// Original:
// X_T1273[n0, n1, n2, a : _T1796, _T1797, _T1798, _T1799] = =(X_T1272[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1273[n0, n1, n2, a : _T1796, _T1797, _T1798, _T1799] = =(X_T1272[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 2304, 14, 1
__kernel void kernel_c108_sdk_432(__global float* restrict  X_T1273, __global const float* restrict  in1)
{
  ...
  for (int n2_lid = 0; n2_lid < 2; n2_lid += 1)
  {
    ...
    if (n2_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T1273 = agg[(a_lid + (n2_lid * 4))];
        int gout_idx = (((a_gid + a) + (16576 * n1_gid)) + (1184 * n2));
        X_T1273[gout_idx] = LX_T1273;
      }
    }
  }
}
