...
// lid: 256 1 1
// Original:
// X_T2099[n0, n1, n2, 1248 + a : _T3006, _T3007, _T3008, _T3009] = =(X_T2098[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2099[n0, n1, n2, 1248 + a : _T3006, _T3007, _T3008, _T3009] = =(X_T2098[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_724(__global float* restrict  X_T2099, __global const float* restrict  in1)
{
  X_T2099 = (X_T2099 + 1248);
