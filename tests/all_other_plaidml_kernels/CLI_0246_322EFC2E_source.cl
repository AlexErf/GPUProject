...
// lid: 256 1 1
// Original:
// X_T426[n0, n1, n2, 320 + a : _T539, _T540, _T541, _T542] = =(X_T425[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T426[n0, n1, n2, 320 + a : _T539, _T540, _T541, _T542] = =(X_T425[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c108_sdk_127(__global float* restrict  X_T426, __global const float* restrict  in1)
{
  X_T426 = (X_T426 + 320);
