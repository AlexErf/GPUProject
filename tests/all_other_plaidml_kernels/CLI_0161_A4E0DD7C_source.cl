...
// lid: 256 1 1
// Original:
// X_T394[n0, n1, n2, a : _T547, _T548, _T549, _T550] = =(X_T393[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T394[n0, n1, n2, a : _T547, _T548, _T549, _T550] = =(X_T393[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 17, 0 <= n2 < 17, 0 <= n1 < 17, 0 <= n2 < 17, 0 <= a < 192, 0 <= a < 768, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 2304, 17, 1
__kernel void kernel_c56_sdk_131(__global float* restrict  X_T394, __global const float* restrict  in1)
{
  ...
  if (n1_cond)
  {
    for (int a_lid = 0; a_lid < 2; a_lid += 1)
    {
      ...
      if (a_cond)
      {
        ...
        float LX_T394 = agg[a_lid];
        int gout_idx = ((a + (13056 * (n1_gid + n1_tid))) + (768 * n2_gid));
        X_T394[gout_idx] = LX_T394;
      }
    }
  }
}
