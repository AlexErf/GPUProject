...
// lid: 256 1 1
// Original:
// X_T457[n0, n1, n2, 252 + a : _T687, _T688, _T689, _T690] = =(X_T456[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T457[n0, n1, n2, 252 + a : _T687, _T688, _T689, _T690] = =(X_T456[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= a < 84, 0 <= 252 + a < 336, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 5376, 21, 1
__kernel void kernel_c42_sdk_158(__global float* restrict  X_T457, __global const float* restrict  in1)
{
  X_T457 = (X_T457 + 252);
