...
// lid: 256 1 1
// Original:
// X_T469[n0, n1, n2, a : _T706, _T707, _T708, _T709] = =(X_T468[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T469[n0, n1, n2, a : _T706, _T707, _T708, _T709] = =(X_T468[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= a < 44, 0 <= a < 264, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 3584, 14, 1
__kernel void kernel_c42_sdk_163(__global float* restrict  X_T469, __global const float* restrict  in1)
{
