...
// Ranges: { 172032 }
// Out stride: { 1 }
// Elementwise input X_T8 shape: fp32(3, 1, 224, 256):(57344, 57344, 256, 1):672 KiB
// Elementwise op: [[pid(RevMul)]] X_T9 = mul(X_T7, X_T8)
// Elementwise op: [[pid(Add)]] X_T10 = add(X_T6, X_T9)
// Tile size: { 4096 }
// Contraction output var shape: fp32(3, 1, 224, 256):(57344, 57344, 256, 1):672 KiB
...
// lwork = 256, 1, 1
// gwork = 10752, 1, 1
__kernel void kernel_c44_sdk_1(__global float* restrict  X_T10, __global const float* restrict  X_T8)
{
  ...
  for (int i1_i2_i3_i4_lid = 0; i1_i2_i3_i4_lid < 16; i1_i2_i3_i4_lid += 1)
  {
    ...
    float LX_T9 = (0.12909944355487823f * LX_T8);
    float LX_T10 = (-0.06454972177743912f + LX_T9);
