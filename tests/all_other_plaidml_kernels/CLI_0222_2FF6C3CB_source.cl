...
// lid: 256 1 1
// Original:
// X_T546[n, o0, o1, c : _T749, _T750, _T751, _T752] = =(X_T225[])
// With Index Variables Made Integral:
// X_T546[n, o0, o1, c : _T749, _T750, _T751, _T752] = =(X_T225[]), 500000000 + c < 1000000000, 500000000 + n < 1000000000, 500000000 + o0 < 1000000000, 500000000 + o1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c68_sdk_178(__global float* restrict  X_T546)
{
  ...
  for (int c_lid = 0; c_lid < 8; c_lid += 1)
  {
    ...
    {
      int o0 = ((2 * o0_lid) + o0_tid);
      float LX_T546 = agg[(c_lid + (o0_lid * 8))];
