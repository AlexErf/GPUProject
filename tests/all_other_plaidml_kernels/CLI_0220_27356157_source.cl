...
// lid: 256 1 1
// Original:
// X_T213[n0, n1, n2, 192 + a : _T211, _T212, _T213, _T214] = =(X_T212[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T213[n0, n1, n2, 192 + a : _T211, _T212, _T213, _T214] = =(X_T212[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= a < 32, 0 <= n1 < 56, 0 <= n2 < 56, 0 <= n1 < 56, 0 <= n2 < 56, 0 <= 192 + a < 224, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c124_sdk_49(__global float* restrict  X_T213, __global const float* restrict  in1)
{
  X_T213 = (X_T213 + 192);
  ...
  {
    int n1 = ((4 * n1_lid) + n1_tid);
    float LX_T213 = agg[n1_lid];
    int gout_idx = ((a_tid + (12544 * n1)) + (224 * (n2_gid + n2_tid)));
