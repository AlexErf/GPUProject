...
// lid: 256 1 1
// Original:
// X_T187[n0, n1, n2, a : _T222, _T223, _T224, _T225] = =(X_T186[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T187[n0, n1, n2, a : _T222, _T223, _T224, _T225] = =(X_T186[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= a < 32, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= a < 128, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 8960, 1, 1
__kernel void kernel_c51_sdk_51(__global float* restrict  X_T187, __global const float* restrict  in1)
{
