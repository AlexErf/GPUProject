...
// lid: 256 1 1
// Original:
// X_T1296[n0, n1, n2, 640 + a : _T1859, _T1860, _T1861, _T1862] = =(X_T1295[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1296[n0, n1, n2, 640 + a : _T1859, _T1860, _T1861, _T1862] = =(X_T1295[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 640 + a < 672, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_445(__global float* restrict  X_T1296, __global const float* restrict  in1)
{
  X_T1296 = (X_T1296 + 640);
  ...
  if (n2_cond)
  {
    ...
    int gout_idx = ((a_tid + (4704 * n1_gid)) + (672 * n2_tid));
