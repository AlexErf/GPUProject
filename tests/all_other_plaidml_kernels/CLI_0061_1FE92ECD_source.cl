...
// Ranges: { 278528 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 1088, 256):(278528, 278528, 256, 1):1088 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 4096 }
// Contraction output var shape: fp32(1, 1, 1088, 256):(278528, 278528, 256, 1):1088 KiB
// Computed true ops: 557056
