...
// lid: 256 1 1
// Original:
// X_T364[n, x0, x1, co : _T447, _T448, _T449, _T450] = +(X_T363[n, k0 + x0, k1 + x1, ci] * X_I_128[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T364[n, x0, x1, co : _T447, _T448, _T449, _T450] = +(X_T363[n, k0 + x0, k1 + x1, ci] * X_I_128[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T365 = sub(X_T364, X_I_127)
// Elementwise op: [[pid(Mul)]] X_T366 = mul(X_T365, X_I_126)
...
// lwork = 256, 1, 1
// gwork = 1792, 2, 2
__kernel void kernel_c108_sdk_105(__global float* restrict  X_T366, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_127, __global const float* restrict  X_I_126)
{
