...
// Ranges: { 1048576 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(1, 1, 512, 2048):(1048576, 1048576, 2048, 1):4096 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 4096 }
// Contraction output var shape: fp32(1, 1, 512, 2048):(1048576, 1048576, 2048, 1):4096 KiB
