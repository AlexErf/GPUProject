...
// lid: 256 1 1
// Original:
// X_T1348[n0, n1, n2, a : _T1907, _T1908, _T1909, _T1910] = =(X_T1347[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1348[n0, n1, n2, a : _T1907, _T1908, _T1909, _T1910] = =(X_T1347[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 39, 1
__kernel void kernel_c108_sdk_459(__global float* restrict  X_T1348, __global const float* restrict  in1)
{
