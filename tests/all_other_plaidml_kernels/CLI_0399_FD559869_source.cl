...
// lid: 256 1 1
// Original:
// X_T1323[n0, n1, n2, a : _T1901, _T1902, _T1903, _T1904] = =(X_T1322[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1323[n0, n1, n2, a : _T1901, _T1902, _T1903, _T1904] = =(X_T1322[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1536, 7, 1
__kernel void kernel_c68_sdk_456(__global float* restrict  X_T1323, __global const float* restrict  in1)
{
