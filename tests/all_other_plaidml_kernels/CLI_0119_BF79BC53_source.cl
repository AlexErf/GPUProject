...
// Elementwise input X_I_63 shape: fp32(48):(1):192 bytes
// Elementwise op: [[pid(TrueDiv)]] X_T107 = div(X_T102, X_T106)
// Elementwise op: [[pid(Add, Switch)]] X_T108 = add(X_T107, X_I_63)
...
// lwork = 256, 1, 1
// gwork = 8960, 1, 1
__kernel void kernel_c56_sdk_23(__global float* restrict  X_T110, __global const float* restrict  X_T102, __global const float* restrict  X_T106, __global const float* restrict  X_I_63)
{
    ...
    if (i4_cond)
    {
      ...
      for (int i3_lid = 0; i3_lid < 5; i3_lid += 1)
      {
        ...
        if (i3_cond)
        {
          ...
          float LX_I_63 = X_I_63[i4];
          float LX_T107 = (LX_T102 / LX_T106);
          float LX_T108 = (LX_T107 + LX_I_63);
