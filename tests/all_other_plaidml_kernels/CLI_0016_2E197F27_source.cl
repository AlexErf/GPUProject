...
// Ranges: { 262144 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(1, 1, 256, 1024):(262144, 262144, 1024, 1):1024 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 4096 }
// Contraction output var shape: fp32(1, 1, 256, 1024):(262144, 262144, 1024, 1):1024 KiB
