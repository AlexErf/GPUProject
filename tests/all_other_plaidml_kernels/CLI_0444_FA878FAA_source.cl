...
// Elementwise input X_T1248 shape: fp32(1, 14, 14, 1152):(225792, 16128, 1152, 1):882 KiB
// Elementwise input X_T1271 shape: fp32(1, 14, 14, 1152):(225792, 16128, 1152, 1):882 KiB
...
// Elementwise op: [[pid(Sub)]] X_T1274 = sub(X_T1272, X_I_492)
// Elementwise op: [[pid(Mul)]] X_T1275 = mul(X_T1274, X_I_491)
// Tile size: { 1, 2, 14, 32 }
...
// lwork = 256, 1, 1
// gwork = 1792, 36, 1
__kernel void kernel_c108_sdk_431(__global float* restrict  X_T1272, __global float* restrict  X_T1275, __global const float* restrict  X_T1248, __global const float* restrict  X_T1271, __global const float* restrict  X_I_492, __global const float* restrict  X_I_491)
{
  ...
  for (int i3_lid = 0; i3_lid < 4; i3_lid += 1)
  {
    ...
    if (i3_cond)
    {
      ...
      float LX_T1274 = (LX_T1272 - LX_I_492);
      float LX_T1275 = (LX_T1274 * LX_I_491);
