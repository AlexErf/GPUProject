...
// lid: 256 1 1
// Original:
// X_T84[n, x0, x1, co : _T59, _T60, _T61, _T62] = +(X_T83[n, -1 + k0 + x0, -1 + k1 + x1, ci] * X_I_23[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T84[n, x0, x1, co : _T59, _T60, _T61, _T62] = +(X_T83[n, -1 + k0 + x0, -1 + k1 + x1, ci] * X_I_23[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_12(__global float* restrict  X_T84, __global const float* restrict  in1, __global const float* restrict  in2)
{
  in1 = (in1 + -7296);
