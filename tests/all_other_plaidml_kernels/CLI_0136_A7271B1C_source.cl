...
// lid: 256 1 1
// Original:
// X_T185[n0, n1, n2, 192 + a : _T211, _T212, _T213, _T214] = =(X_T184[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T185[n0, n1, n2, 192 + a : _T211, _T212, _T213, _T214] = =(X_T184[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_49(__global float* restrict  X_T185, __global const float* restrict  in1)
{
  X_T185 = (X_T185 + 192);
