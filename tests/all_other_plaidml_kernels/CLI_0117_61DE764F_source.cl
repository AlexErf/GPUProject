...
// lid: 256 1 1
// Original:
// X_T174[n0, n1, n2, 256 + a : _T203, _T204, _T205, _T206] = =(X_T173[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T174[n0, n1, n2, 256 + a : _T203, _T204, _T205, _T206] = =(X_T173[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= a < 64, 0 <= 256 + a < 320, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 8960, 1, 1
__kernel void kernel_c51_sdk_46(__global float* restrict  X_T174, __global const float* restrict  in1)
{
  X_T174 = (X_T174 + 256);
  ...
  for (int n2_lid = 0; n2_lid < 5; n2_lid += 1)
  {
    ...
    if (n2_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T174 = agg[(a_lid + (n2_lid * 2))];
        int gout_idx = ((a + (11200 * n1_gid)) + (320 * n2));
