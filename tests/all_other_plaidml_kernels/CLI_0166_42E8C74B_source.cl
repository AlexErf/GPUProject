...
// lid: 256 1 1
// Original:
// X_T73[n, d0, d1, c : _T21, _T22, _T23, _T24] = =(X_T71[n, -1 + d0, -1 + d1, c])
// With Index Variables Made Integral:
// X_T73[n, d0, d1, c : _T21, _T22, _T23, _T24] = =(X_T71[n, -1 + d0, -1 + d1, c]), 500000000 + c < 1000000000, 500000000 + d0 < 1000000000, 500000000 + d1 < 1000000000, 500000000 + n < 1000000000
...
// lwork = 256, 1, 1
// gwork = 57344, 1, 1
__kernel void kernel_c108_sdk_4(__global float* restrict  X_T73, __global const float* restrict  in1)
{
  X_T73 = (X_T73 + 7360);
