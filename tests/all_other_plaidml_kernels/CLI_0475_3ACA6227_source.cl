...
// lid: 256 1 1
// Original:
// X_T1306[n0, n1, n2, a : _T1833, _T1834, _T1835, _T1836] = =(X_T1305[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1306[n0, n1, n2, a : _T1833, _T1834, _T1835, _T1836] = =(X_T1305[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 37, 1
__kernel void kernel_c124_sdk_441(__global float* restrict  X_T1306, __global const float* restrict  in1)
{
