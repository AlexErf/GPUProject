...
// lid: 256 1 1
// Original:
// X_T430[n0, n1, n2, 192 + a : _T590, _T591, _T592, _T593] = =(X_T429[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T430[n0, n1, n2, 192 + a : _T590, _T591, _T592, _T593] = =(X_T429[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 17, 0 <= n2 < 17, 0 <= n1 < 17, 0 <= n2 < 17, 0 <= a < 192, 0 <= 192 + a < 768, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 2304, 17, 1
__kernel void kernel_c56_sdk_141(__global float* restrict  X_T430, __global const float* restrict  in1)
{
  X_T430 = (X_T430 + 192);
