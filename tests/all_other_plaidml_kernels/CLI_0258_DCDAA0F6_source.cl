...
// lid: 256 1 1
// Original:
// X_T476[n0, n1, n2, 384 + a : _T613, _T614, _T615, _T616] = =(X_T475[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T476[n0, n1, n2, 384 + a : _T613, _T614, _T615, _T616] = =(X_T475[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= a < 32, 0 <= 384 + a < 416, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c108_sdk_145(__global float* restrict  X_T476, __global const float* restrict  in1)
{
  X_T476 = (X_T476 + 384);
  ...
  for (int n1_lid = 0; n1_lid < 4; n1_lid += 1)
  {
    ...
    {
      int n1 = ((8 * n1_lid) + n1_tid);
      float LX_T476 = agg[n1_lid];
      int gout_idx = ((a_tid + (11648 * n1)) + (416 * n2_gid));
      X_T476[gout_idx] = LX_T476;
    }
  }
}
