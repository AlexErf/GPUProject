...
// lid: 256 1 1
// Original:
// X_T276[n0, n1, n2, 128 + a : _T317, _T318, _T319, _T320] = =(X_T275[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T276[n0, n1, n2, 128 + a : _T317, _T318, _T319, _T320] = =(X_T275[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c108_sdk_73(__global float* restrict  X_T276, __global const float* restrict  in1)
{
  X_T276 = (X_T276 + 128);
