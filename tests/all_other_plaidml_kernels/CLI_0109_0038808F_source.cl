...
// lid: 256 1 1
// Original:
// X_T393[i0, i1 : _T571, _T572] = =(X_I_10[i0, 256 + i1])
// With Index Variables Made Integral:
// X_T393[i0, i1 : _T571, _T572] = =(X_I_10[i0, 256 + i1]), 500000000 + i0 < 1000000000, 500000000 + i1 < 1000000000
// Constraints:{ 0 <= i0 < 128, 0 <= i1 < 128, 0 <= i0 < 128, 0 <= 256 + i1 < 512, 0 <= 500000000 + i0 < 1000000000, 0 <= 500000000 + i1 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 8192, 1, 1
__kernel void kernel_c6_sdk_190(__global float* restrict  X_T393, __global const float* restrict  in1)
{
  in1 = (in1 + 256);
  ...
  {
    {
      ...
      for (int i0_lid = 0; i0_lid < 2; i0_lid += 1)
      {
        ...
        in1_shared[lidx] = in1[clamp((int)gidx, (int)-256, (int)65279)];
      }
    }
