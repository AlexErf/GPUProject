...
// lid: 256 1 1
// Original:
// X_T1541[n0, n1, n2, 800 + a : _T2192, _T2193, _T2194, _T2195] = =(X_T1540[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1541[n0, n1, n2, 800 + a : _T2192, _T2193, _T2194, _T2195] = =(X_T1540[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_526(__global float* restrict  X_T1541, __global const float* restrict  in1)
{
  X_T1541 = (X_T1541 + 800);
