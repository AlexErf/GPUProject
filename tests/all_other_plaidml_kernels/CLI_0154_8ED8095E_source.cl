...
// lid: 256 1 1
// Original:
// X_T745[i, 0 : _T868, _T869] = >(X_T722[i, j])
// With Index Variables Made Integral:
// X_T745[i, 0 : _T868, _T869] = >(X_T722[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c43_sdk_197(__global float* restrict  X_T745, __global const float* restrict  in1)
{
  ...
  {
    float LX_T745 = agg[0];
    LX_T745 = select((float)LX_T745, (float)0, (int)(LX_T745 == (float)-FLT_MAX));
    X_T745[0] = LX_T745;
  }
}
