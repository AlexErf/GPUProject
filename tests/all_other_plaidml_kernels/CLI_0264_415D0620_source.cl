...
// lid: 256 1 1
// Original:
// X_T501[n0, n1, n2, 416 + a : _T650, _T651, _T652, _T653] = =(X_T500[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T501[n0, n1, n2, 416 + a : _T650, _T651, _T652, _T653] = =(X_T500[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c108_sdk_154(__global float* restrict  X_T501, __global const float* restrict  in1)
{
  X_T501 = (X_T501 + 416);
  ...
  for (int n1_lid = 0; n1_lid < 4; n1_lid += 1)
  {
    ...
    {
      int n1 = ((8 * n1_lid) + n1_tid);
      float LX_T501 = agg[n1_lid];
      int gout_idx = ((a_tid + (12544 * n1)) + (448 * n2_gid));
      X_T501[gout_idx] = LX_T501;
    }
  }
}
