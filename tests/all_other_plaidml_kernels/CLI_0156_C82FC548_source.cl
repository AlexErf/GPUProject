...
// lid: 256 1 1
// Original:
// X_T258[n0, n1, n2, a : _T322, _T323, _T324, _T325] = =(X_T257[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T258[n0, n1, n2, a : _T322, _T323, _T324, _T325] = =(X_T257[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 28, 1
__kernel void kernel_c68_sdk_75(__global float* restrict  X_T258, __global const float* restrict  in1)
{
