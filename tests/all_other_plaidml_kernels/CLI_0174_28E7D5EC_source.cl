...
// lid: 256 1 1
// Original:
// X_T502[n0, n1, n2, 576 + a : _T695, _T696, _T697, _T698] = =(X_T501[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T502[n0, n1, n2, 576 + a : _T695, _T696, _T697, _T698] = =(X_T501[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 17, 0 <= n2 < 17, 0 <= n1 < 17, 0 <= n2 < 17, 0 <= a < 192, 0 <= 576 + a < 768, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 2304, 17, 1
__kernel void kernel_c56_sdk_166(__global float* restrict  X_T502, __global const float* restrict  in1)
{
  X_T502 = (X_T502 + 576);
