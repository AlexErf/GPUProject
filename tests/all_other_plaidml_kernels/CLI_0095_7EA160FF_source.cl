...
// lid: 256 1 1
// Original:
// X_T203[n0, n1, n2, 22 + a : _T270, _T271, _T272, _T273] = =(X_T202[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T203[n0, n1, n2, 22 + a : _T270, _T271, _T272, _T273] = =(X_T202[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= a < 11, 0 <= 22 + a < 44, 0 <= n1 < 56, 0 <= n2 < 56, 0 <= n1 < 56, 0 <= n2 < 56, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1792, 28, 1
__kernel void kernel_c42_sdk_60(__global float* restrict  X_T203, __global const float* restrict  in1)
{
  X_T203 = (X_T203 + 22);
