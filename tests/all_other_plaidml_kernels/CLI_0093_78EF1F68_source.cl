...
// lid: 256 1 1
// Original:
// X_T477[i, 0 : _T521, _T522] = >(X_T452[i, j])
// With Index Variables Made Integral:
// X_T477[i, 0 : _T521, _T522] = >(X_T452[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c25_sdk_115(__global float* restrict  X_T477, __global const float* restrict  in1)
{
  ...
  {
    float LX_T477 = agg[0];
    LX_T477 = select((float)LX_T477, (float)0, (int)(LX_T477 == (float)-FLT_MAX));
    X_T477[0] = LX_T477;
  }
}
