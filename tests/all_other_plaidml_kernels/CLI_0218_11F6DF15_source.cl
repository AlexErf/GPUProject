...
// lid: 256 1 1
// Original:
// X_T1574[n0, n1, n2, 176 + a : _T2470, _T2471, _T2472, _T2473] = =(X_T1573[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1574[n0, n1, n2, 176 + a : _T2470, _T2471, _T2472, _T2473] = =(X_T1573[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88, 0 <= 176 + a < 528, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88 }
// Defracted:
// X_T1574[n0, n1, n2, 176 + a : _T2470, _T2471, _T2472, _T2473] = =(X_T1573[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1574   X_T1573  
//        a        88         1         1  
//       n1        14      7392      1232  
//       n2        14       528        88  
//      off                 176         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c42_sdk_593(__global float* restrict  X_T1574, __global const float* restrict  in1)
{
  X_T1574 = (X_T1574 + 176);
