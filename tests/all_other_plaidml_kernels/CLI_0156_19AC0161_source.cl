...
// lid: 256 1 1
// Original:
// X_T749[i, 0 : _T872, _T873] = +(X_T747[i, j])
// With Index Variables Made Integral:
// X_T749[i, 0 : _T872, _T873] = +(X_T747[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c43_sdk_199(__global float* restrict  X_T749, __global const float* restrict  in1)
{
