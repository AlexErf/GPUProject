...
// lid: 256 1 1
// Original:
// X_T444[n, x0, x1, co : _T595, _T596, _T597, _T598] = +(X_T443[n, k0 + x0, k1 + x1, ci] * X_I_168[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T444[n, x0, x1, co : _T595, _T596, _T597, _T598] = +(X_T443[n, k0 + x0, k1 + x1, ci] * X_I_168[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T445 = sub(X_T444, X_I_167)
// Elementwise op: [[pid(Mul)]] X_T446 = mul(X_T445, X_I_166)
...
// lwork = 256, 1, 1
// gwork = 1792, 2, 2
__kernel void kernel_c68_sdk_141(__global float* restrict  X_T446, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_167, __global const float* restrict  X_I_166)
{
