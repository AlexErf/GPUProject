...
// lid: 256 1 1
// Original:
// X_T459[n0, n1, n2, 352 + a : _T576, _T577, _T578, _T579] = =(X_T458[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T459[n0, n1, n2, 352 + a : _T576, _T577, _T578, _T579] = =(X_T458[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c124_sdk_136(__global float* restrict  X_T459, __global const float* restrict  in1)
{
  X_T459 = (X_T459 + 352);
