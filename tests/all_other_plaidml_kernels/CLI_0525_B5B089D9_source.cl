...
// lid: 256 1 1
// Original:
// X_T1641[n0, n1, n2, 928 + a : _T2340, _T2341, _T2342, _T2343] = =(X_T1640[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1641[n0, n1, n2, 928 + a : _T2340, _T2341, _T2342, _T2343] = =(X_T1640[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_562(__global float* restrict  X_T1641, __global const float* restrict  in1)
{
  X_T1641 = (X_T1641 + 928);
