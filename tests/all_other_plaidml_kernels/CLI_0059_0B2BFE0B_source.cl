...
// Ranges: { 1806336 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(1, 1, 2688, 672):(1806336, 1806336, 672, 1):7056 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 4096 }
// Contraction output var shape: fp32(1, 1, 2688, 672):(1806336, 1806336, 672, 1):7056 KiB
