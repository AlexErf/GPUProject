...
// lid: 256 1 1
// Original:
// X_T2977[n, x0, x1, c : _T4727, _T4728, _T4729, _T4730] = +(X_T2976[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T2977[n, x0, x1, c : _T4727, _T4728, _T4729, _T4730] = +(X_T2976[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 768, 11, 1
__kernel void kernel_c42_sdk_1149(__global float* restrict  X_T2977, __global const float* restrict  in1)
{
  in1 = (in1 + -8064);
