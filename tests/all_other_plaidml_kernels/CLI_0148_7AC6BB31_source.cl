...
// lid: 256 1 1
// Original:
// X_T488[n0, n1, n2, a : _T735, _T736, _T737, _T738] = =(X_T485[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T488[n0, n1, n2, a : _T735, _T736, _T737, _T738] = =(X_T485[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= a < 22, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= a < 44, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1792, 14, 1
__kernel void kernel_c42_sdk_170(__global float* restrict  X_T488, __global const float* restrict  in1)
{
