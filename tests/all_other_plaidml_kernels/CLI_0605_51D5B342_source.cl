...
// lid: 256 1 1
// Original:
// X_T1849[n0, n1, n2, 928 + a : _T2636, _T2637, _T2638, _T2639] = =(X_T1848[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1849[n0, n1, n2, 928 + a : _T2636, _T2637, _T2638, _T2639] = =(X_T1848[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 928 + a < 960, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1849[n0, n1, n2, 928 + a : _T2636, _T2637, _T2638, _T2639] = =(X_T1848[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1849   X_T1848  
//        a        32         1         1  
//       n1         7      6720       224  
//       n2         7       960        32  
//      off                 928         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_634(__global float* restrict  X_T1849, __global const float* restrict  in1)
{
  X_T1849 = (X_T1849 + 928);
  ...
  if (n2_cond)
  {
    float LX_T1849 = agg[0];
    int gout_idx = ((a_tid + (6720 * n1_gid)) + (960 * n2_tid));
    X_T1849[gout_idx] = LX_T1849;
  }
}
