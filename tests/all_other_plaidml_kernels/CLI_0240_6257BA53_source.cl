...
// lid: 256 1 1
// Original:
// X_T286[n0, n1, n2, a : _T322, _T323, _T324, _T325] = =(X_T285[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T286[n0, n1, n2, a : _T322, _T323, _T324, _T325] = =(X_T285[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 28, 1
__kernel void kernel_c124_sdk_75(__global float* restrict  X_T286, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 3; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T286 = agg[a_lid];
      int gout_idx = ((a + (5376 * (n1_gid + n1_tid))) + (192 * n2_gid));
      X_T286[gout_idx] = LX_T286;
    }
  }
}
