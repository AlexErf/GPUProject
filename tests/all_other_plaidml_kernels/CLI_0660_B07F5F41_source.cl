...
// lid: 256 1 1
// Original:
// X_T2124[n0, n1, n2, 1280 + a : _T3043, _T3044, _T3045, _T3046] = =(X_T2123[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2124[n0, n1, n2, 1280 + a : _T3043, _T3044, _T3045, _T3046] = =(X_T2123[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_733(__global float* restrict  X_T2124, __global const float* restrict  in1)
{
  X_T2124 = (X_T2124 + 1280);
