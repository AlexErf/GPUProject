...
// lid: 256 1 1
// Original:
// X_T121[n0, n1, n2, 64 + a : _T123, _T124, _T125, _T126] = =(X_T120[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T121[n0, n1, n2, 64 + a : _T123, _T124, _T125, _T126] = =(X_T120[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= a < 64, 0 <= 64 + a < 256, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 8960, 1, 1
__kernel void kernel_c56_sdk_27(__global float* restrict  X_T121, __global const float* restrict  in1)
{
  X_T121 = (X_T121 + 64);
  ...
  for (int n2_lid = 0; n2_lid < 5; n2_lid += 1)
  {
    ...
    if (n2_cond)
    {
      ...
      for (int a_lid = 0; a_lid < 2; a_lid += 1)
      {
        ...
        int gout_idx = ((a + (8960 * n1_gid)) + (256 * n2));
