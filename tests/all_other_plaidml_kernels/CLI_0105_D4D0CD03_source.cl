...
// Elementwise input X_I_44 shape: fp32(64):(1):256 bytes
// Elementwise op: [[pid(TrueDiv)]] X_T58 = div(X_T53, X_T57)
// Elementwise op: [[pid(Add, Switch)]] X_T59 = add(X_T58, X_I_44)
...
// lwork = 256, 1, 1
// gwork = 9472, 147, 1
__kernel void kernel_c56_sdk_8(__global float* restrict  X_T61, __global const float* restrict  X_T53, __global const float* restrict  X_T57, __global const float* restrict  X_I_44)
{
  ...
  if (i3_cond)
  {
    ...
    float LX_I_44 = X_I_44[i4_tid];
    float LX_T58 = (LX_T53 / LX_T57);
    float LX_T59 = (LX_T58 + LX_I_44);
