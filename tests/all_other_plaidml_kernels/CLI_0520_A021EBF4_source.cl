...
// lid: 256 1 1
// Original:
// X_T1616[n0, n1, n2, 896 + a : _T2303, _T2304, _T2305, _T2306] = =(X_T1615[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1616[n0, n1, n2, 896 + a : _T2303, _T2304, _T2305, _T2306] = =(X_T1615[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_553(__global float* restrict  X_T1616, __global const float* restrict  in1)
{
  X_T1616 = (X_T1616 + 896);
