...
// lid: 256 1 1
// Original:
// X_T384[n0, n1, n2, 256 + a : _T465, _T466, _T467, _T468] = =(X_T383[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T384[n0, n1, n2, 256 + a : _T465, _T466, _T467, _T468] = =(X_T383[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c124_sdk_109(__global float* restrict  X_T384, __global const float* restrict  in1)
{
  X_T384 = (X_T384 + 256);
