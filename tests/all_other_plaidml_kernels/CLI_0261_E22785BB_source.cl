...
// lid: 256 1 1
// Original:
// X_T728[n0, n1, n2, a : _T1019, _T1020, _T1021, _T1022] = =(X_T727[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T728[n0, n1, n2, a : _T1019, _T1020, _T1021, _T1022] = =(X_T727[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 15, 1
__kernel void kernel_c68_sdk_243(__global float* restrict  X_T728, __global const float* restrict  in1)
{
