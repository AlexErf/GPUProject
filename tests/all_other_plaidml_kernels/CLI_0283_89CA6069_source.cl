...
// lid: 256 1 1
// Original:
// X_T3131[i, 0 : _T4873, _T4874] = >(X_T3060[i, j])
// With Index Variables Made Integral:
// X_T3131[i, 0 : _T4873, _T4874] = >(X_T3060[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c42_sdk_1182(__global float* restrict  X_T3131, __global const float* restrict  in1)
{
  ...
  if ((tid < 1))
  {
    float LX_T3131 = agg[0];
    LX_T3131 = select((float)LX_T3131, (float)0, (int)(LX_T3131 == (float)-FLT_MAX));
    X_T3131[0] = LX_T3131;
  }
}
