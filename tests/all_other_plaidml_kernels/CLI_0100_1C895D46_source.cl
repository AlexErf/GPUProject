...
// Elementwise input X_I_50 shape: fp32(32):(1):128 bytes
// Elementwise op: [[pid(TrueDiv)]] X_T38 = div(X_T32, X_T37)
// Elementwise op: [[pid(Add, Switch)]] X_T39 = add(X_T38, X_I_50)
...
// lwork = 256, 1, 1
// gwork = 4864, 75, 1
__kernel void kernel_c56_sdk_2(__global float* restrict  X_T41, __global const float* restrict  X_T32, __global const float* restrict  X_T37, __global const float* restrict  X_I_50)
{
