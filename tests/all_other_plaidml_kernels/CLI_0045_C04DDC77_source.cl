...
// lid: 256 1 1
// Original:
// X_T124[i, 0 : _T158, _T159] = >(X_T111[i, j])
// With Index Variables Made Integral:
// X_T124[i, 0 : _T158, _T159] = >(X_T111[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c18_sdk_24(__global float* restrict  X_T124, __global const float* restrict  in1)
{
  ...
  {
    float LX_T124 = agg[0];
    LX_T124 = select((float)LX_T124, (float)0, (int)(LX_T124 == (float)-FLT_MAX));
    X_T124[0] = LX_T124;
  }
}
