...
// lid: 256 1 1
// Original:
// X_T461[n0, n1, n2, a : _T581, _T582, _T583, _T584] = =(X_T460[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T461[n0, n1, n2, a : _T581, _T582, _T583, _T584] = =(X_T460[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 14, 1
__kernel void kernel_c124_sdk_138(__global float* restrict  X_T461, __global const float* restrict  in1)
{
