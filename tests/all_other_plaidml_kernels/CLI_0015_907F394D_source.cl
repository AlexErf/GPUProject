...
// Ranges: { 20480 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 160, 128):(20480, 20480, 128, 1):80 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 1024 }
// Contraction output var shape: fp32(1, 1, 160, 128):(20480, 20480, 128, 1):80 KiB
...
__kernel void kernel_c10_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i3_i4_lid = 0; i3_i4_lid < 4; i3_i4_lid += 1)
  {
    ...
    float LX_T8 = (0.28867512941360474f * LX_T7);
    float LX_T9 = (-0.14433756470680237f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
