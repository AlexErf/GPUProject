...
// lid: 256 1 1
// Original:
// X_T269[n, x0, x1, co : _T336, _T337, _T338, _T339] = +(X_T268[n, k0 + x0, k1 + x1, ci] * X_I_98[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T269[n, x0, x1, co : _T336, _T337, _T338, _T339] = +(X_T268[n, k0 + x0, k1 + x1, ci] * X_I_98[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T270 = sub(X_T269, X_I_97)
// Elementwise op: [[pid(Mul)]] X_T271 = mul(X_T270, X_I_96)
...
// lwork = 256, 1, 1
// gwork = 1792, 2, 2
__kernel void kernel_c68_sdk_78(__global float* restrict  X_T271, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_97, __global const float* restrict  X_I_96)
{
