...
// lid: 256 1 1
// Original:
// X_T1394[n0, n1, n2, 264 + a : _T2189, _T2190, _T2191, _T2192] = =(X_T1393[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1394[n0, n1, n2, 264 + a : _T2189, _T2190, _T2191, _T2192] = =(X_T1393[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88, 0 <= 264 + a < 352, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88 }
// Defracted:
// X_T1394[n0, n1, n2, 264 + a : _T2189, _T2190, _T2191, _T2192] = =(X_T1393[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1394   X_T1393  
//        a        88         1         1  
//       n1        14      4928      1232  
//       n2        14       352        88  
//      off                 264         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c42_sdk_524(__global float* restrict  X_T1394, __global const float* restrict  in1)
{
  X_T1394 = (X_T1394 + 264);
