...
// lid: 256 1 1
// Original:
// X_T2630[i, 0 : _T3772, _T3773] = +(X_T2628[i, j])
// With Index Variables Made Integral:
// X_T2630[i, 0 : _T3772, _T3773] = +(X_T2628[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c124_sdk_912(__global float* restrict  X_T2630, __global const float* restrict  in1)
{
