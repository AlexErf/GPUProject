...
// lid: 256 1 1
// Original:
// X_T2218[i, 0 : _T3176, _T3177] = >(X_T2207[i, j])
// With Index Variables Made Integral:
// X_T2218[i, 0 : _T3176, _T3177] = >(X_T2207[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c108_sdk_766(__global float* restrict  X_T2218, __global const float* restrict  in1)
{
  ...
  if ((tid < 1))
  {
    float LX_T2218 = agg[0];
    LX_T2218 = select((float)LX_T2218, (float)0, (int)(LX_T2218 == (float)-FLT_MAX));
    X_T2218[0] = LX_T2218;
  }
}
