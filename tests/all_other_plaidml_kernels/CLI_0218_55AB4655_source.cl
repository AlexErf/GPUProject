...
// lid: 256 1 1
// Original:
// X_T289[n, x0, x1, co : _T336, _T337, _T338, _T339] = +(X_T288[n, k0 + x0, k1 + x1, ci] * X_I_98[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T289[n, x0, x1, co : _T336, _T337, _T338, _T339] = +(X_T288[n, k0 + x0, k1 + x1, ci] * X_I_98[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T290 = sub(X_T289, X_I_97)
// Elementwise op: [[pid(Mul)]] X_T291 = mul(X_T290, X_I_96)
...
// lwork = 256, 1, 1
// gwork = 1792, 2, 2
__kernel void kernel_c108_sdk_78(__global float* restrict  X_T291, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_97, __global const float* restrict  X_I_96)
{
