...
// lid: 256 1 1
// Original:
// X_T1899[n0, n1, n2, 992 + a : _T2710, _T2711, _T2712, _T2713] = =(X_T1898[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1899[n0, n1, n2, 992 + a : _T2710, _T2711, _T2712, _T2713] = =(X_T1898[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 992 + a < 1024, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1899[n0, n1, n2, 992 + a : _T2710, _T2711, _T2712, _T2713] = =(X_T1898[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1899   X_T1898  
//        a        32         1         1  
//       n1         7      7168       224  
//       n2         7      1024        32  
//      off                 992         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_652(__global float* restrict  X_T1899, __global const float* restrict  in1)
{
  X_T1899 = (X_T1899 + 992);
  ...
  if (n2_cond)
  {
    float LX_T1899 = agg[0];
    int gout_idx = ((a_tid + (7168 * n1_gid)) + (1024 * n2_tid));
    X_T1899[gout_idx] = LX_T1899;
  }
}
