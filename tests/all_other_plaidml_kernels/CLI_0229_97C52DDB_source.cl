...
// lid: 256 1 1
// Original:
// X_T576[n0, n1, n2, 256 + a : _T792, _T793, _T794, _T795] = =(X_T575[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T576[n0, n1, n2, 256 + a : _T792, _T793, _T794, _T795] = =(X_T575[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c68_sdk_187(__global float* restrict  X_T576, __global const float* restrict  in1)
{
  X_T576 = (X_T576 + 256);
