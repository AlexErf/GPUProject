...
// lid: 256 1 1
// Original:
// X_T1261[n, x0, x1, c : _T1979, _T1980, _T1981, _T1982] = +(X_T1260[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T1261[n, x0, x1, c : _T1979, _T1980, _T1981, _T1982] = +(X_T1260[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise input X_T1259 shape: fp32(1, 14, 14, 88):(17248, 1232, 88, 1):67.375 KiB
// Elementwise op: [[pid(reduction_A_block_reduce_4)]] X_T1262 = div(X_T1259, X_T1261)
...
// lwork = 256, 1, 1
// gwork = 768, 7, 1
__kernel void kernel_c42_sdk_474(__global float* restrict  X_T1262, __global const float* restrict  in1, __global const float* restrict  X_T1259)
{
  ...
  if (c_cond)
  {
    for (int x1_lid = 0; x1_lid < 4; x1_lid += 1)
    {
      ...
      if (x1_cond)
      {
        ...
        float LX_T1261 = agg[x1_lid];
        int gout_idx = (((c_gid + c_tid) + (1232 * (x0_gid + x0_tid))) + (88 * x1));
        float LX_T1259 = X_T1259[gout_idx];
        float LX_T1262 = (LX_T1259 / LX_T1261);
        X_T1262[gout_idx] = LX_T1262;
      }
    }
  }
}
