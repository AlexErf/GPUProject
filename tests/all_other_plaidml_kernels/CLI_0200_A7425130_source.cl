...
// lid: 256 1 1
// Original:
// X_T1363[n0, n1, n2, 176 + a : _T2141, _T2142, _T2143, _T2144] = =(X_T1362[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1363[n0, n1, n2, 176 + a : _T2141, _T2142, _T2143, _T2144] = =(X_T1362[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88, 0 <= 176 + a < 352, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88 }
// Defracted:
// X_T1363[n0, n1, n2, 176 + a : _T2141, _T2142, _T2143, _T2144] = =(X_T1362[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1363   X_T1362  
//        a        88         1         1  
//       n1        14      4928      1232  
//       n2        14       352        88  
//      off                 176         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c42_sdk_512(__global float* restrict  X_T1363, __global const float* restrict  in1)
{
  X_T1363 = (X_T1363 + 176);
  ...
  for (int a_lid = 0; a_lid < 2; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T1363 = agg[a_lid];
      int gout_idx = ((a + (4928 * (n1_gid + n1_tid))) + (352 * (n2_gid + n2_tid)));
      X_T1363[gout_idx] = LX_T1363;
    }
  }
}
