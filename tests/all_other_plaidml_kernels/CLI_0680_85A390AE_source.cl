...
// lid: 256 1 1
// Original:
// X_T2224[n0, n1, n2, 1408 + a : _T3191, _T3192, _T3193, _T3194] = =(X_T2223[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2224[n0, n1, n2, 1408 + a : _T3191, _T3192, _T3193, _T3194] = =(X_T2223[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_769(__global float* restrict  X_T2224, __global const float* restrict  in1)
{
  X_T2224 = (X_T2224 + 1408);
  ...
  if (n2_cond)
  {
    float LX_T2224 = agg[0];
    int gout_idx = ((a_tid + (10080 * n1_gid)) + (1440 * n2_tid));
    X_T2224[gout_idx] = LX_T2224;
  }
}
