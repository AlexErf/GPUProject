...
// lid: 256 1 1
// Original:
// X_T2066[n0, n1, n2, 1472 + a : _T2969, _T2970, _T2971, _T2972] = =(X_T2065[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2066[n0, n1, n2, 1472 + a : _T2969, _T2970, _T2971, _T2972] = =(X_T2065[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_715(__global float* restrict  X_T2066, __global const float* restrict  in1)
{
  X_T2066 = (X_T2066 + 1472);
  ...
  if (n2_cond)
  {
    float LX_T2066 = agg[0];
    int gout_idx = ((a_tid + (10528 * n1_gid)) + (1504 * n2_tid));
    X_T2066[gout_idx] = LX_T2066;
  }
}
