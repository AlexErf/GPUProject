...
// lid: 256 1 1
// Original:
// X_T1156[n0, n1, n2, a : _T1611, _T1612, _T1613, _T1614] = =(X_T1155[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1156[n0, n1, n2, a : _T1611, _T1612, _T1613, _T1614] = =(X_T1155[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 31, 1
__kernel void kernel_c124_sdk_387(__global float* restrict  X_T1156, __global const float* restrict  in1)
{
