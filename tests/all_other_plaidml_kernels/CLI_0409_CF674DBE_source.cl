...
// lid: 256 1 1
// Original:
// X_T1373[n0, n1, n2, a : _T1975, _T1976, _T1977, _T1978] = =(X_T1372[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1373[n0, n1, n2, a : _T1975, _T1976, _T1977, _T1978] = =(X_T1372[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1536, 7, 1
__kernel void kernel_c68_sdk_474(__global float* restrict  X_T1373, __global const float* restrict  in1)
{
  ...
  if (n2_cond)
  {
    ...
    {
      int a = ((32 * a_lid) + a_tid);
      float LX_T1373 = agg[a_lid];
      int gout_idx = (((a_gid + a) + (5600 * n1_gid)) + (800 * n2_tid));
      X_T1373[gout_idx] = LX_T1373;
    }
  }
}
