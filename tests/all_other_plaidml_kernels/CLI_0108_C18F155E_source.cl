...
// lid: 256 1 1
// Original:
// X_T261[n, x0, x1, co : _T367, _T368, _T369, _T370] = +(X_T260[n, k0 + x0, k1 + x1, ci] * X_I_123[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T261[n, x0, x1, co : _T367, _T368, _T369, _T370] = +(X_T260[n, k0 + x0, k1 + x1, ci] * X_I_123[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Computed true ops: 2207744
// Computed work groups: 28
// Computed inner loops: 1
// Computed shared mem: 15968
// Computed out regs: 7168
// Computed mem read: 15744
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c42_sdk_84(__global float* restrict  X_T261, __global const float* restrict  in1, __global const float* restrict  in2)
{
  ...
  if (co_cond)
  {
    ...
    {
      int x0 = ((8 * x0_lid) + x0_tid);
      float LX_T261 = agg[x0_lid];
      int gout_idx = ((co_tid + (616 * x0)) + (11 * (x1_gid + x1_tid)));
      X_T261[gout_idx] = LX_T261;
    }
  }
}
