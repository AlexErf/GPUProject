...
// lid: 256 1 1
// Original:
// X_T85[n0, n1, n2, 64 + a : _T63, _T64, _T65, _T66] = =(X_T84[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T85[n0, n1, n2, 64 + a : _T63, _T64, _T65, _T66] = =(X_T84[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_13(__global float* restrict  X_T85, __global const float* restrict  in1)
{
  X_T85 = (X_T85 + 64);
