...
// lid: 256 1 1
// Original:
// X_T106[x0, y1 : _T150, _T151] = +(X_T105[x0, z] * X_I_3[z, y1])
// With Index Variables Made Integral:
// X_T106[x0, y1 : _T150, _T151] = +(X_T105[x0, z] * X_I_3[z, y1]), 500000000 + x0 < 1000000000, 500000000 + y1 < 1000000000, 500000000 + z < 1000000000
...
// Elementwise op: [[pid(Add)]] X_T107 = add(X_T106, X_I_2)
// Elementwise op: X_T108 = cmp_lt(X_T107, X_T2)
// Elementwise op: [[pid(Relu)]] X_T109 = cond(X_T108, X_T2, X_T107)
// Tile size: { 128, 32 }
...
// lwork = 256, 1, 1
// gwork = 8192, 1, 1
__kernel void kernel_c18_sdk_22(__global float* restrict  X_T109, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_2)
{
  ...
  if ((tid < 128))
  {
    ...
    float LX_T107 = (LX_T106 + LX_I_2);
    int LX_T108 = (LX_T107 < 0.0f);
    float LX_T109 = select((float)LX_T107, (float)0.0f, (int)LX_T108);
