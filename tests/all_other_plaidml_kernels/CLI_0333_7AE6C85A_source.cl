...
// lid: 256 1 1
// Original:
// X_T704[n0, n1, n2, 384 + a : _T940, _T941, _T942, _T943] = =(X_T703[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T704[n0, n1, n2, 384 + a : _T940, _T941, _T942, _T943] = =(X_T703[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c124_sdk_223(__global float* restrict  X_T704, __global const float* restrict  in1)
{
  X_T704 = (X_T704 + 384);
