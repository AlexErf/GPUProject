...
// lid: 256 1 1
// Original:
// X_T534[n0, n1, n2, 448 + a : _T687, _T688, _T689, _T690] = =(X_T533[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T534[n0, n1, n2, 448 + a : _T687, _T688, _T689, _T690] = =(X_T533[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c124_sdk_163(__global float* restrict  X_T534, __global const float* restrict  in1)
{
  X_T534 = (X_T534 + 448);
