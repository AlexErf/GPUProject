...
// lid: 256 1 1
// Original:
// X_T1346[n0, n1, n2, 704 + a : _T1933, _T1934, _T1935, _T1936] = =(X_T1345[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1346[n0, n1, n2, 704 + a : _T1933, _T1934, _T1935, _T1936] = =(X_T1345[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 704 + a < 736, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1346[n0, n1, n2, 704 + a : _T1933, _T1934, _T1935, _T1936] = =(X_T1345[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1346   X_T1345  
//        a        32         1         1  
//       n1         7      5152       224  
//       n2         7       736        32  
//      off                 704         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_463(__global float* restrict  X_T1346, __global const float* restrict  in1)
{
  X_T1346 = (X_T1346 + 704);
  ...
  if (n2_cond)
  {
    float LX_T1346 = agg[0];
    int gout_idx = ((a_tid + (5152 * n1_gid)) + (736 * n2_tid));
    X_T1346[gout_idx] = LX_T1346;
  }
}
