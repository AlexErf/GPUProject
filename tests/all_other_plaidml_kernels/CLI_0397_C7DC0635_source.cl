...
// lid: 256 1 1
// Original:
// X_T1321[n0, n1, n2, 672 + a : _T1896, _T1897, _T1898, _T1899] = =(X_T1320[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1321[n0, n1, n2, 672 + a : _T1896, _T1897, _T1898, _T1899] = =(X_T1320[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 672 + a < 704, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1321[n0, n1, n2, 672 + a : _T1896, _T1897, _T1898, _T1899] = =(X_T1320[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1321   X_T1320  
//        a        32         1         1  
//       n1         7      4928       224  
//       n2         7       704        32  
//      off                 672         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_454(__global float* restrict  X_T1321, __global const float* restrict  in1)
{
  X_T1321 = (X_T1321 + 672);
  ...
  if (n2_cond)
  {
    float LX_T1321 = agg[0];
    int gout_idx = ((a_tid + (4928 * n1_gid)) + (704 * n2_tid));
    X_T1321[gout_idx] = LX_T1321;
  }
}
