...
// lid: 256 1 1
// Original:
// X_T1920[n0, n1, n2, 672 + a : _T3026, _T3027, _T3028, _T3029] = =(X_T1919[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1920[n0, n1, n2, 672 + a : _T3026, _T3027, _T3028, _T3029] = =(X_T1919[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= a < 336, 0 <= 672 + a < 2016, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= a < 336 }
// Defracted:
// X_T1920[n0, n1, n2, 672 + a : _T3026, _T3027, _T3028, _T3029] = =(X_T1919[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1920   X_T1919  
//        a       336         1         1  
//       n1        21     42336      7056  
//       n2        21      2016       336  
//      off                 672         0  
...
// lwork = 256, 1, 1
// gwork = 768, 11, 11
__kernel void kernel_c42_sdk_731(__global float* restrict  X_T1920, __global const float* restrict  in1)
{
  X_T1920 = (X_T1920 + 672);
