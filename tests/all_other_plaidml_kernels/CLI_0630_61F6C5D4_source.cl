...
// lid: 256 1 1
// Original:
// X_T1974[n0, n1, n2, 1088 + a : _T2821, _T2822, _T2823, _T2824] = =(X_T1973[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1974[n0, n1, n2, 1088 + a : _T2821, _T2822, _T2823, _T2824] = =(X_T1973[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1088 + a < 1120, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1974[n0, n1, n2, 1088 + a : _T2821, _T2822, _T2823, _T2824] = =(X_T1973[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1974   X_T1973  
//        a        32         1         1  
//       n1         7      7840       224  
//       n2         7      1120        32  
//      off                1088         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_679(__global float* restrict  X_T1974, __global const float* restrict  in1)
{
  X_T1974 = (X_T1974 + 1088);
  ...
  if (n2_cond)
  {
    float LX_T1974 = agg[0];
    int gout_idx = ((a_tid + (7840 * n1_gid)) + (1120 * n2_tid));
