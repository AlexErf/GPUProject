...
// lid: 256 1 1
// Original:
// X_T2322[n0, n1, n2, 528 + a : _T3681, _T3682, _T3683, _T3684] = =(X_T2321[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2322[n0, n1, n2, 528 + a : _T3681, _T3682, _T3683, _T3684] = =(X_T2321[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 176, 0 <= 528 + a < 704, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 176 }
// Defracted:
// X_T2322[n0, n1, n2, 528 + a : _T3681, _T3682, _T3683, _T3684] = =(X_T2321[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2322   X_T2321  
//        a       176         1         1  
//       n1         7      4928      1232  
//       n2         7       704       176  
//      off                 528         0  
...
// lwork = 256, 1, 1
// gwork = 768, 7, 1
__kernel void kernel_c42_sdk_888(__global float* restrict  X_T2322, __global const float* restrict  in1)
{
  X_T2322 = (X_T2322 + 528);
  ...
  for (int a_lid = 0; a_lid < 2; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      if (n1_cond)
      {
        float LX_T2322 = agg[a_lid];
        int gout_idx = (((a_gid + a) + (4928 * n1_tid)) + (704 * n2_gid));
        X_T2322[gout_idx] = LX_T2322;
      }
    }
  }
}
