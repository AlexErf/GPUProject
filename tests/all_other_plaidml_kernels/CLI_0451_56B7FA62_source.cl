...
// lid: 256 1 1
// Original:
// X_T1206[n0, n1, n2, a : _T1685, _T1686, _T1687, _T1688] = =(X_T1205[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1206[n0, n1, n2, a : _T1685, _T1686, _T1687, _T1688] = =(X_T1205[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 33, 1
__kernel void kernel_c124_sdk_405(__global float* restrict  X_T1206, __global const float* restrict  in1)
{
