...
// lid: 256 1 1
// Original:
// X_T1769[n0, n1, n2, a : _T2793, _T2794, _T2795, _T2796] = =(X_T1765[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1769[n0, n1, n2, a : _T2793, _T2794, _T2795, _T2796] = =(X_T1765[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= a < 168, 0 <= a < 336, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= a < 168 }
// Defracted:
// X_T1769[n0, n1, n2, a : _T2793, _T2794, _T2795, _T2796] = =(X_T1765[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1769   X_T1765  
//        a       168         1         1  
//       n1        21      7056      3528  
//       n2        21       336       168  
//      off                   0         0  
...
// lwork = 256, 1, 1
// gwork = 2816, 21, 1
__kernel void kernel_c42_sdk_674(__global float* restrict  X_T1769, __global const float* restrict  in1)
{
  ...
  if (n1_cond)
  {
    for (int a_lid = 0; a_lid < 2; a_lid += 1)
    {
      ...
      if (a_cond)
      {
        ...
        float LX_T1769 = agg[a_lid];
        int gout_idx = ((a + (7056 * (n1_gid + n1_tid))) + (336 * n2_gid));
        X_T1769[gout_idx] = LX_T1769;
      }
    }
  }
}
