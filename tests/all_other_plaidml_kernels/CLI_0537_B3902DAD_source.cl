...
// lid: 256 1 1
// Original:
// X_T1693[n0, n1, n2, a : _T2419, _T2420, _T2421, _T2422] = =(X_T1692[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1693[n0, n1, n2, a : _T2419, _T2420, _T2421, _T2422] = =(X_T1692[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 8, 1
__kernel void kernel_c108_sdk_582(__global float* restrict  X_T1693, __global const float* restrict  in1)
{
  ...
  if (n2_cond)
  {
    ...
    {
      int a = ((32 * a_lid) + a_tid);
      float LX_T1693 = agg[a_lid];
      int gout_idx = (((a_gid + a) + (7392 * n1_gid)) + (1056 * n2_tid));
      X_T1693[gout_idx] = LX_T1693;
    }
  }
}
