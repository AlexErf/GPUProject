...
// Ranges: { 64 }
// Out stride: { 1 }
// Elementwise input X_I_56 shape: fp32(64):(1):256 bytes
// Elementwise op: [[pid(Add)]] X_T54 = add(X_T33, X_I_56)
...
// lwork = 64, 1, 1
// gwork = 64, 1, 1
__kernel void kernel_c56_sdk_7(__global float* restrict  X_T57, __global const float* restrict  X_I_56)
{
  int tid = get_local_id(0);
  int i1_tid = (tid % 64);
  float LX_I_56 = X_I_56[i1_tid];
  float LX_T54 = (0.0010000000474974513f + LX_I_56);
