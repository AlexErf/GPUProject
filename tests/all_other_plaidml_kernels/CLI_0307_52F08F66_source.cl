...
// lid: 256 1 1
// Original:
// X_T928[n0, n1, n2, a : _T1315, _T1316, _T1317, _T1318] = =(X_T927[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T928[n0, n1, n2, a : _T1315, _T1316, _T1317, _T1318] = =(X_T927[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 23, 1
__kernel void kernel_c68_sdk_315(__global float* restrict  X_T928, __global const float* restrict  in1)
{
