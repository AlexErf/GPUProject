...
// lid: 256 1 1
// Original:
// X_T2187[n, x0, x1, c : _T3461, _T3462, _T3463, _T3464] = +(X_T2139[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T2187[n, x0, x1, c : _T3461, _T3462, _T3463, _T3464] = +(X_T2139[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 768, 7, 1
__kernel void kernel_c42_sdk_836(__global float* restrict  X_T2187, __global const float* restrict  in1)
{
  ...
  for (int c_lid = 0; c_lid < 2; c_lid += 1)
  {
    ...
    if (c_cond)
    {
      ...
      if (x0_cond)
      {
        float LX_T2187 = agg[c_lid];
        int gout_idx = (((c_gid + c) + (1232 * x0_tid)) + (176 * x1_gid));
        X_T2187[gout_idx] = LX_T2187;
      }
    }
  }
}
