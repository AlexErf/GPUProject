...
// lid: 256 1 1
// Original:
// X_T1521[n0, n1, n2, 928 + a : _T2192, _T2193, _T2194, _T2195] = =(X_T1520[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1521[n0, n1, n2, 928 + a : _T2192, _T2193, _T2194, _T2195] = =(X_T1520[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_526(__global float* restrict  X_T1521, __global const float* restrict  in1)
{
  X_T1521 = (X_T1521 + 928);
  ...
  if (n2_cond)
  {
    float LX_T1521 = agg[0];
    int gout_idx = ((a_tid + (6720 * n1_gid)) + (960 * n2_tid));
    X_T1521[gout_idx] = LX_T1521;
  }
}
