...
// lid: 256 1 1
// Original:
// X_T458[n0, n1, n2, a : _T618, _T619, _T620, _T621] = =(X_T457[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T458[n0, n1, n2, a : _T618, _T619, _T620, _T621] = =(X_T457[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 28, 1
__kernel void kernel_c68_sdk_147(__global float* restrict  X_T458, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 7; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T458 = agg[a_lid];
      int gout_idx = ((a + (12544 * (n1_gid + n1_tid))) + (448 * n2_gid));
      X_T458[gout_idx] = LX_T458;
    }
  }
}
