...
// Ranges: { 968 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(1, 1, 44, 22):(968, 968, 22, 1):3.78125 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 256 }
// Contraction output var shape: fp32(1, 1, 44, 22):(968, 968, 22, 1):3.78125 KiB
...
__kernel void kernel_c13_sdk_0(__global float* restrict  X_T0, __global const float* restrict  X_I_0)
{
  ...
  int i3_i4_cond = ((i3_i4_gid != 768) || (i3_i4_tid < 200));
  if (i3_i4_cond)
  {
