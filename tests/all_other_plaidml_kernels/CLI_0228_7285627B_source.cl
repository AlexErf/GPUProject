...
// lid: 256 1 1
// Original:
// X_T339[n, x0, x1, co : _T410, _T411, _T412, _T413] = +(X_T338[n, k0 + x0, k1 + x1, ci] * X_I_118[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T339[n, x0, x1, co : _T410, _T411, _T412, _T413] = +(X_T338[n, k0 + x0, k1 + x1, ci] * X_I_118[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T340 = sub(X_T339, X_I_117)
// Elementwise op: [[pid(Mul)]] X_T341 = mul(X_T340, X_I_116)
...
// lwork = 256, 1, 1
// gwork = 1792, 2, 2
__kernel void kernel_c108_sdk_96(__global float* restrict  X_T341, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_117, __global const float* restrict  X_I_116)
{
