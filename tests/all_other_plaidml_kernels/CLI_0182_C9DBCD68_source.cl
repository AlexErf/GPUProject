...
// lid: 256 1 1
// Original:
// X_T383[n0, n1, n2, a : _T507, _T508, _T509, _T510] = =(X_T382[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T383[n0, n1, n2, a : _T507, _T508, _T509, _T510] = =(X_T382[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 14, 1
__kernel void kernel_c68_sdk_120(__global float* restrict  X_T383, __global const float* restrict  in1)
{
