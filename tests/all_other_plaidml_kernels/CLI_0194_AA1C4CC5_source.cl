...
// lid: 256 1 1
// Original:
// X_T1296[n0, n1, n2, 88 + a : _T2031, _T2032, _T2033, _T2034] = =(X_T1295[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1296[n0, n1, n2, 88 + a : _T2031, _T2032, _T2033, _T2034] = =(X_T1295[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 88, 0 <= 88 + a < 352, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c42_sdk_486(__global float* restrict  X_T1296, __global const float* restrict  in1)
{
  X_T1296 = (X_T1296 + 88);
