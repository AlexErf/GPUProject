...
// lid: 256 1 1
// Original:
// X_T2376[n0, n1, n2, a : _T3418, _T3419, _T3420, _T3421] = =(X_T2375[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2376[n0, n1, n2, a : _T3418, _T3419, _T3420, _T3421] = =(X_T2375[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c124_sdk_825(__global float* restrict  X_T2376, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 7; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T2376 = agg[a_lid];
      int gout_idx = ((a + (11648 * n1_gid)) + (1664 * n2_gid));
      X_T2376[gout_idx] = LX_T2376;
    }
  }
}
