...
// lid: 256 1 1
// Original:
// X_T481[n, x0, x1, c : _T713, _T714, _T715, _T716] = +(X_T240[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 1, k1 < 1
// With Index Variables Made Integral:
// X_T481[n, x0, x1, c : _T713, _T714, _T715, _T716] = +(X_T240[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 1, k1 < 1, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 5376, 42, 1
__kernel void kernel_c42_sdk_166(__global float* restrict  X_T481, __global const float* restrict  in1)
{
  ...
  for (int c_lid = 0; c_lid < 2; c_lid += 1)
  {
    ...
    if (c_cond)
    {
      ...
      float LX_T481 = agg[c_lid];
      int gout_idx = ((c + (7056 * (x0_gid + x0_tid))) + (168 * x1_gid));
      X_T481[gout_idx] = LX_T481;
    }
  }
}
