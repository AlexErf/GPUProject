...
// lid: 256 1 1
// Original:
// X_T1223[n0, n1, n2, a : _T1722, _T1723, _T1724, _T1725] = =(X_T1222[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1223[n0, n1, n2, a : _T1722, _T1723, _T1724, _T1725] = =(X_T1222[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 17, 1
__kernel void kernel_c108_sdk_414(__global float* restrict  X_T1223, __global const float* restrict  in1)
{
  ...
  for (int n2_lid = 0; n2_lid < 4; n2_lid += 1)
  {
    ...
    if (n2_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T1223 = agg[(a_lid + (n2_lid * 2))];
