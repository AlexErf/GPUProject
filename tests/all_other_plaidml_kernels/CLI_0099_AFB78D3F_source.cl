...
// Elementwise op: [[pid(Add)]] X_T34 = add(X_T33, X_I_54)
...
// lwork = 32, 1, 1
// gwork = 32, 1, 1
__kernel void kernel_c56_sdk_1(__global float* restrict  X_T37, __global const float* restrict  X_I_54)
{
  int tid = get_local_id(0);
  int i1_tid = (tid % 32);
  float LX_I_54 = X_I_54[i1_tid];
  float LX_T34 = (0.0010000000474974513f + LX_I_54);
