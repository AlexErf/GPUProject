...
// lid: 256 1 1
// Original:
// X_T806[n0, n1, n2, a : _T1093, _T1094, _T1095, _T1096] = =(X_T805[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T806[n0, n1, n2, a : _T1093, _T1094, _T1095, _T1096] = =(X_T805[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 17, 1
__kernel void kernel_c124_sdk_261(__global float* restrict  X_T806, __global const float* restrict  in1)
{
