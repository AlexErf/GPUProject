...
// lid: 256 1 1
// Original:
// X_T401[n0, n1, n2, 288 + a : _T502, _T503, _T504, _T505] = =(X_T400[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T401[n0, n1, n2, 288 + a : _T502, _T503, _T504, _T505] = =(X_T400[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c108_sdk_118(__global float* restrict  X_T401, __global const float* restrict  in1)
{
  X_T401 = (X_T401 + 288);
  ...
  for (int n1_lid = 0; n1_lid < 4; n1_lid += 1)
  {
    ...
    {
      int n1 = ((8 * n1_lid) + n1_tid);
      float LX_T401 = agg[n1_lid];
      int gout_idx = ((a_tid + (8960 * n1)) + (320 * n2_gid));
      X_T401[gout_idx] = LX_T401;
    }
  }
}
