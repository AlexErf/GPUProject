...
// lid: 256 1 1
// Original:
// X_T687[n0, n1, n2, 220 + a : _T1060, _T1061, _T1062, _T1063] = =(X_T686[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T687[n0, n1, n2, 220 + a : _T1060, _T1061, _T1062, _T1063] = =(X_T686[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= n1 < 28, 0 <= n2 < 28, 0 <= a < 44, 0 <= 220 + a < 264, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 3584, 14, 1
__kernel void kernel_c42_sdk_249(__global float* restrict  X_T687, __global const float* restrict  in1)
{
  X_T687 = (X_T687 + 220);
