...
// lid: 256 1 1
// Original:
// X_T928[n0, n1, n2, 384 + a : _T1275, _T1276, _T1277, _T1278] = =(X_T927[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T928[n0, n1, n2, 384 + a : _T1275, _T1276, _T1277, _T1278] = =(X_T927[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 17, 0 <= n2 < 17, 0 <= n1 < 17, 0 <= n2 < 17, 0 <= a < 384, 0 <= 384 + a < 1088, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 4352, 17, 1
__kernel void kernel_c51_sdk_301(__global float* restrict  X_T928, __global const float* restrict  in1)
{
  X_T928 = (X_T928 + 384);
  ...
  for (int a_lid = 0; a_lid < 2; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T928 = agg[a_lid];
      int gout_idx = ((a + (18496 * n1_gid)) + (1088 * n2_gid));
      X_T928[gout_idx] = LX_T928;
    }
  }
}
