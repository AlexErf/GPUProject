...
// lid: 256 1 1
// Original:
// X_T2149[n0, n1, n2, 1312 + a : _T3080, _T3081, _T3082, _T3083] = =(X_T2148[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2149[n0, n1, n2, 1312 + a : _T3080, _T3081, _T3082, _T3083] = =(X_T2148[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_742(__global float* restrict  X_T2149, __global const float* restrict  in1)
{
  X_T2149 = (X_T2149 + 1312);
