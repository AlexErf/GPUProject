...
// lid: 256 1 1
// Original:
// X_T311[n0, n1, n2, a : _T359, _T360, _T361, _T362] = =(X_T310[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T311[n0, n1, n2, a : _T359, _T360, _T361, _T362] = =(X_T310[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 28, 1
__kernel void kernel_c124_sdk_84(__global float* restrict  X_T311, __global const float* restrict  in1)
{
  ...
  {
    int a = ((64 * a_lid) + a_tid);
    float LX_T311 = agg[a_lid];
    int gout_idx = ((a + (6272 * (n1_gid + n1_tid))) + (224 * n2_gid));
    X_T311[gout_idx] = LX_T311;
  }
}
