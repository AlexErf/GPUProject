...
// lid: 256 1 1
// Original:
// X_T1396[n0, n1, n2, 768 + a : _T2007, _T2008, _T2009, _T2010] = =(X_T1395[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1396[n0, n1, n2, 768 + a : _T2007, _T2008, _T2009, _T2010] = =(X_T1395[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 768 + a < 800, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1396[n0, n1, n2, 768 + a : _T2007, _T2008, _T2009, _T2010] = =(X_T1395[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1396   X_T1395  
//        a        32         1         1  
//       n1         7      5600       224  
//       n2         7       800        32  
//      off                 768         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_481(__global float* restrict  X_T1396, __global const float* restrict  in1)
{
  X_T1396 = (X_T1396 + 768);
  ...
  if (n2_cond)
  {
    float LX_T1396 = agg[0];
    int gout_idx = ((a_tid + (5600 * n1_gid)) + (800 * n2_tid));
    X_T1396[gout_idx] = LX_T1396;
  }
}
