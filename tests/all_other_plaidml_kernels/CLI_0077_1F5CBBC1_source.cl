...
// lid: 256 1 1
// Original:
// X_T696[i, 0 : _T827, _T828] = >(X_T685[i, j])
// With Index Variables Made Integral:
// X_T696[i, 0 : _T827, _T828] = >(X_T685[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c29_sdk_164(__global float* restrict  X_T696, __global const float* restrict  in1)
{
  ...
  {
    float LX_T696 = agg[0];
    LX_T696 = select((float)LX_T696, (float)0, (int)(LX_T696 == (float)-FLT_MAX));
    X_T696[0] = LX_T696;
  }
}
