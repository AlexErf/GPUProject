...
// lid: 256 1 1
// Original:
// X_T2532[i, 0 : _T3530, _T3531] = +(X_T2530[i, j])
// With Index Variables Made Integral:
// X_T2532[i, 0 : _T3530, _T3531] = +(X_T2530[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c51_sdk_822(__global float* restrict  X_T2532, __global const float* restrict  in1)
{
