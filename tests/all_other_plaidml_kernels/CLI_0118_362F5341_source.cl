...
// Ranges: { 48 }
// Out stride: { 1 }
// Elementwise input X_I_66 shape: fp32(48):(1):192 bytes
// Elementwise op: [[pid(Add)]] X_T103 = add(X_T33, X_I_66)
...
// lwork = 64, 1, 1
// gwork = 64, 1, 1
__kernel void kernel_c56_sdk_22(__global float* restrict  X_T106, __global const float* restrict  X_I_66)
{
  ...
  if (i1_cond)
  {
    float LX_I_66 = X_I_66[i1_tid];
    float LX_T103 = (0.0010000000474974513f + LX_I_66);
