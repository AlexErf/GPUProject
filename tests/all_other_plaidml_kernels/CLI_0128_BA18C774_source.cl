...
// lid: 256 1 1
// Original:
// X_T355[n0, n1, n2, 84 + a : _T529, _T530, _T531, _T532] = =(X_T354[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T355[n0, n1, n2, 84 + a : _T529, _T530, _T531, _T532] = =(X_T354[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= n1 < 42, 0 <= n2 < 42, 0 <= a < 84, 0 <= 84 + a < 336, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 5376, 21, 1
__kernel void kernel_c42_sdk_120(__global float* restrict  X_T355, __global const float* restrict  in1)
{
  X_T355 = (X_T355 + 84);
