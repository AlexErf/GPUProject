...
// lid: 256 1 1
// Original:
// X_T239[n0, n1, n2, 128 + a : _T295, _T296, _T297, _T298] = =(X_T238[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T239[n0, n1, n2, 128 + a : _T295, _T296, _T297, _T298] = =(X_T238[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= a < 96, 0 <= 128 + a < 288, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 2304, 35, 1
__kernel void kernel_c56_sdk_69(__global float* restrict  X_T239, __global const float* restrict  in1)
{
  X_T239 = (X_T239 + 128);
  ...
  if (n1_cond)
  {
    for (int a_lid = 0; a_lid < 2; a_lid += 1)
    {
      ...
      if (a_cond)
      {
        ...
        float LX_T239 = agg[a_lid];
        int gout_idx = ((a + (10080 * (n1_gid + n1_tid))) + (288 * n2_gid));
        X_T239[gout_idx] = LX_T239;
      }
    }
  }
}
