...
// lid: 256 1 1
// Original:
// X_T159[n, x0, x1, c : _T172, _T173, _T174, _T175] = +(X_T84[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T159[n, x0, x1, c : _T172, _T173, _T174, _T175] = +(X_T84[n, -1 + k0 + x0, -1 + k1 + x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 768, 5, 5
__kernel void kernel_c56_sdk_40(__global float* restrict  X_T159, __global const float* restrict  in1)
{
  in1 = (in1 + -6912);
    ...
    if (x1_cond)
    {
      ...
      for (int x0_lid = 0; x0_lid < 4; x0_lid += 1)
      {
        ...
        if (x0_cond)
        {
          ...
          {
            int c = ((32 * c_lid) + c_tid);
            float LX_T159 = agg[((c_lid + (x1_lid * 2)) + (x0_lid * 4))];
