...
// Ranges: { 4608 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(3, 3, 512, 1):(1536, 512, 1, 1):18 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 256 }
// Contraction output var shape: fp32(3, 3, 512, 1):(1536, 512, 1, 1):18 KiB
...
__kernel void kernel_c17_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  float LX_T8 = (0.07209841161966324f * LX_T7);
  float LX_T9 = (-0.03604920580983162f + LX_T8);
  X_T9[gout_idx] = LX_T9;
}
