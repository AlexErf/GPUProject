...
// lid: 256 1 1
// Original:
// X_T1816[n0, n1, n2, 1152 + a : _T2599, _T2600, _T2601, _T2602] = =(X_T1815[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1816[n0, n1, n2, 1152 + a : _T2599, _T2600, _T2601, _T2602] = =(X_T1815[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1152 + a < 1184, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1816[n0, n1, n2, 1152 + a : _T2599, _T2600, _T2601, _T2602] = =(X_T1815[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1816   X_T1815  
//        a        32         1         1  
//       n1         7      8288       224  
//       n2         7      1184        32  
//      off                1152         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_625(__global float* restrict  X_T1816, __global const float* restrict  in1)
{
  X_T1816 = (X_T1816 + 1152);
  ...
  if (n2_cond)
  {
    float LX_T1816 = agg[0];
    int gout_idx = ((a_tid + (8288 * n1_gid)) + (1184 * n2_tid));
    X_T1816[gout_idx] = LX_T1816;
  }
}
