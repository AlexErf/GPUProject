...
// lid: 256 1 1
// Original:
// X_T1496[n0, n1, n2, 896 + a : _T2155, _T2156, _T2157, _T2158] = =(X_T1495[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1496[n0, n1, n2, 896 + a : _T2155, _T2156, _T2157, _T2158] = =(X_T1495[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_517(__global float* restrict  X_T1496, __global const float* restrict  in1)
{
  X_T1496 = (X_T1496 + 896);
  ...
  if (n2_cond)
  {
    float LX_T1496 = agg[0];
    int gout_idx = ((a_tid + (6496 * n1_gid)) + (928 * n2_tid));
    X_T1496[gout_idx] = LX_T1496;
  }
}
