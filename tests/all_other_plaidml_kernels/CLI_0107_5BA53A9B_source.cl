...
// lid: 256 1 1
// Original:
// X_T63[n, x0, x1, co : _T48, _T49, _T50, _T51] = +(X_T62[n, k0 + x0, k1 + x1, ci] * X_I_43[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T63[n, x0, x1, co : _T48, _T49, _T50, _T51] = +(X_T62[n, k0 + x0, k1 + x1, ci] * X_I_43[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise input X_I_42 shape: fp32(80):(1):320 bytes
// Elementwise op: [[pid(Sub)]] X_T64 = sub(X_T63, X_I_42)
// Tile size: { 64, 80, 4, 8 }
...
// lwork = 256, 1, 1
// gwork = 2560, 19, 1
__kernel void kernel_c56_sdk_10(__global float* restrict  X_T64, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_42)
{
        ...
        if (x0_cond)
        {
          ...
          for (int co_lid = 0; co_lid < 3; co_lid += 1)
          {
            ...
            if (co_cond)
            {
              ...
              float LX_I_42 = X_I_42[co];
              float LX_T64 = (LX_T63 - LX_I_42);
