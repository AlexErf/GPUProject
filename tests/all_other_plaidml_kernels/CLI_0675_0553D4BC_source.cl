...
// lid: 256 1 1
// Original:
// X_T2199[n0, n1, n2, 1376 + a : _T3154, _T3155, _T3156, _T3157] = =(X_T2198[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2199[n0, n1, n2, 1376 + a : _T3154, _T3155, _T3156, _T3157] = =(X_T2198[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_760(__global float* restrict  X_T2199, __global const float* restrict  in1)
{
  X_T2199 = (X_T2199 + 1376);
