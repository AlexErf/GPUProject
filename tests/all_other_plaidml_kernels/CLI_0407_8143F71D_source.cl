...
// lid: 256 1 1
// Original:
// X_T1371[n0, n1, n2, 736 + a : _T1970, _T1971, _T1972, _T1973] = =(X_T1370[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1371[n0, n1, n2, 736 + a : _T1970, _T1971, _T1972, _T1973] = =(X_T1370[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_472(__global float* restrict  X_T1371, __global const float* restrict  in1)
{
  X_T1371 = (X_T1371 + 736);
