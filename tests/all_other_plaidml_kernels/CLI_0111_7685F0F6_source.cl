...
// Ranges: { 192 }
// Out stride: { 1 }
// Elementwise input X_I_58 shape: fp32(192):(1):768 bytes
// Elementwise op: [[pid(Add)]] X_T76 = add(X_T33, X_I_58)
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c56_sdk_14(__global float* restrict  X_T79, __global const float* restrict  X_I_58)
{
  ...
  if (i1_cond)
  {
    float LX_I_58 = X_I_58[i1_tid];
    float LX_T76 = (0.0010000000474974513f + LX_I_58);
