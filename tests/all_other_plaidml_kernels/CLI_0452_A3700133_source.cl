...
// lid: 256 1 1
// Original:
// X_T1598[i, 0 : _T2288, _T2289] = >(X_T1587[i, j])
// With Index Variables Made Integral:
// X_T1598[i, 0 : _T2288, _T2289] = >(X_T1587[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c68_sdk_550(__global float* restrict  X_T1598, __global const float* restrict  in1)
{
  ...
  if ((tid < 1))
  {
    float LX_T1598 = agg[0];
    LX_T1598 = select((float)LX_T1598, (float)0, (int)(LX_T1598 == (float)-FLT_MAX));
    X_T1598[0] = LX_T1598;
  }
}
