...
// lid: 256 1 1
// Original:
// X_T160[n0, n1, n2, 160 + a : _T174, _T175, _T176, _T177] = =(X_T159[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T160[n0, n1, n2, 160 + a : _T174, _T175, _T176, _T177] = =(X_T159[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_40(__global float* restrict  X_T160, __global const float* restrict  in1)
{
  X_T160 = (X_T160 + 160);
  ...
  {
    int n1 = ((4 * n1_lid) + n1_tid);
    float LX_T160 = agg[n1_lid];
    int gout_idx = ((a_tid + (10752 * n1)) + (192 * (n2_gid + n2_tid)));
    X_T160[gout_idx] = LX_T160;
  }
}
