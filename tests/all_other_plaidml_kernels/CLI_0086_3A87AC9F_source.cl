...
// lid: 256 1 1
// Original:
// X_T136[n0, n1, n2, 11 + a : _T160, _T161, _T162, _T163] = =(X_T135[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T136[n0, n1, n2, 11 + a : _T160, _T161, _T162, _T163] = =(X_T135[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= a < 11, 0 <= 11 + a < 44, 0 <= n1 < 56, 0 <= n2 < 56, 0 <= n1 < 56, 0 <= n2 < 56, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1792, 28, 1
__kernel void kernel_c42_sdk_34(__global float* restrict  X_T136, __global const float* restrict  in1)
{
  X_T136 = (X_T136 + 11);
