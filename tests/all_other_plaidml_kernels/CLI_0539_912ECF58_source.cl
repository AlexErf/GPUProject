...
// lid: 256 1 1
// Original:
// X_T1579[n0, n1, n2, 1504 + a : _T2235, _T2236, _T2237, _T2238] = =(X_T1578[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1579[n0, n1, n2, 1504 + a : _T2235, _T2236, _T2237, _T2238] = =(X_T1578[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 32, 0 <= 1504 + a < 1536, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 14, 0 <= n2 < 14, 0 <= a < 32 }
// Defracted:
// X_T1579[n0, n1, n2, 1504 + a : _T2235, _T2236, _T2237, _T2238] = =(X_T1578[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1579   X_T1578  
//        a        32         1         1  
//       n1        14     21504       448  
//       n2        14      1536        32  
//      off                1504         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c124_sdk_538(__global float* restrict  X_T1579, __global const float* restrict  in1)
{
  X_T1579 = (X_T1579 + 1504);
  ...
  if (n2_cond)
  {
    ...
    int gout_idx = ((a_tid + (21504 * (n1_gid + n1_tid))) + (1536 * (n2_gid + n2_tid)));
