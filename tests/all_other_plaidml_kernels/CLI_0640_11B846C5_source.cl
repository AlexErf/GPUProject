...
// lid: 256 1 1
// Original:
// X_T2024[n0, n1, n2, 1152 + a : _T2895, _T2896, _T2897, _T2898] = =(X_T2023[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2024[n0, n1, n2, 1152 + a : _T2895, _T2896, _T2897, _T2898] = =(X_T2023[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_697(__global float* restrict  X_T2024, __global const float* restrict  in1)
{
  X_T2024 = (X_T2024 + 1152);
