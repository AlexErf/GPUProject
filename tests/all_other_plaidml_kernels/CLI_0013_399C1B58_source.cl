...
// Ranges: { 65536 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(1, 1, 512, 128):(65536, 65536, 128, 1):256 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 4096 }
// Contraction output var shape: fp32(1, 1, 512, 128):(65536, 65536, 128, 1):256 KiB
...
// lwork = 256, 1, 1
// gwork = 4096, 1, 1
__kernel void kernel_c14_sdk_0(__global float* restrict  X_T0, __global const float* restrict  X_I_0)
{
