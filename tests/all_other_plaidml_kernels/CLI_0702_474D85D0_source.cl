...
// lid: 256 1 1
// Original:
// X_T2326[n0, n1, n2, a : _T3344, _T3345, _T3346, _T3347] = =(X_T2325[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2326[n0, n1, n2, a : _T3344, _T3345, _T3346, _T3347] = =(X_T2325[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c124_sdk_807(__global float* restrict  X_T2326, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 7; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      float LX_T2326 = agg[a_lid];
      int gout_idx = ((a + (11200 * n1_gid)) + (1600 * n2_gid));
      X_T2326[gout_idx] = LX_T2326;
    }
  }
}
