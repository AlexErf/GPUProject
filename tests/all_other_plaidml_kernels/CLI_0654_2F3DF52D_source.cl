...
// lid: 256 1 1
// Original:
// X_T2222[i, 0 : _T3180, _T3181] = +(X_T2220[i, j])
// With Index Variables Made Integral:
// X_T2222[i, 0 : _T3180, _T3181] = +(X_T2220[i, j]), 500000000 + i < 1000000000, 500000000 + j < 1000000000
...
// lwork = 256, 1, 1
// gwork = 256, 1, 1
__kernel void kernel_c108_sdk_768(__global float* restrict  X_T2222, __global const float* restrict  in1)
{
