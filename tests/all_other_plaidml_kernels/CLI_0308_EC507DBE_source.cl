...
// lid: 256 1 1
// Original:
// X_T684[n, x0, x1, co : _T922, _T923, _T924, _T925] = +(X_T683[n, k0 + x0, k1 + x1, ci] * X_I_249[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T684[n, x0, x1, co : _T922, _T923, _T924, _T925] = +(X_T683[n, k0 + x0, k1 + x1, ci] * X_I_249[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T685 = sub(X_T684, X_I_248)
// Elementwise op: [[pid(Mul)]] X_T686 = mul(X_T685, X_I_247)
...
// lwork = 256, 1, 1
// gwork = 1024, 4, 1
__kernel void kernel_c108_sdk_219(__global float* restrict  X_T686, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_248, __global const float* restrict  X_I_247)
{
  ...
  if (x1_cond)
  {
    for (int x0_lid = 0; x0_lid < 7; x0_lid += 1)
    {
      ...
      float LX_T685 = (LX_T684 - LX_I_248);
      float LX_T686 = (LX_T685 * LX_I_247);
