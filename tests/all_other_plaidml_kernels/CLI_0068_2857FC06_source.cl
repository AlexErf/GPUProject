...
// Ranges: { 90112 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 704, 128):(90112, 90112, 128, 1):352 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 4096 }
// Contraction output var shape: fp32(1, 1, 704, 128):(90112, 90112, 128, 1):352 KiB
// Computed true ops: 180224
// Computed work groups: 22
...
__kernel void kernel_c45_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i3_i4_lid = 0; i3_i4_lid < 16; i3_i4_lid += 1)
  {
    ...
    float LX_T8 = (0.16984155774116516f * LX_T7);
    float LX_T9 = (-0.08492077887058258f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
