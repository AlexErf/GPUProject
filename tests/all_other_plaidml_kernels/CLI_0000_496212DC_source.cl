...
// Ranges: { 2592 }
// Out stride: { 1 }
// Elementwise input X_I_0 shape: fp32(3, 3, 3, 96):(864, 288, 96, 1):10.125 KiB
// Elementwise op: X_T0 = ident(X_I_0)
// Tile size: { 256 }
// Contraction output var shape: fp32(3, 3, 3, 96):(864, 288, 96, 1):10.125 KiB
// Computed true ops: 2592
// Computed work groups: 11
...
__kernel void kernel_c1_sdk_0(__global float* restrict  X_T0, __global const float* restrict  X_I_0)
{
  ...
  int i1_i2_i3_i4_cond = ((i1_i2_i3_i4_gid != 2560) || (i1_i2_i3_i4_tid < 32));
  if (i1_i2_i3_i4_cond)
  {
