...
// lid: 256 1 1
// Original:
// X_T157[n0, n1, n2, 128 + a : _T167, _T168, _T169, _T170] = =(X_T156[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T157[n0, n1, n2, 128 + a : _T167, _T168, _T169, _T170] = =(X_T156[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= n1 < 35, 0 <= n2 < 35, 0 <= a < 96, 0 <= 128 + a < 256, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 2304, 35, 1
__kernel void kernel_c56_sdk_38(__global float* restrict  X_T157, __global const float* restrict  in1)
{
  X_T157 = (X_T157 + 128);
  ...
  if (n1_cond)
  {
    for (int a_lid = 0; a_lid < 2; a_lid += 1)
    {
      ...
      if (a_cond)
      {
        ...
        int gout_idx = ((a + (8960 * (n1_gid + n1_tid))) + (256 * n2_gid));
