...
// Ranges: { 399360 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 2080, 192):(399360, 399360, 192, 1):1560 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 2048 }
// Contraction output var shape: fp32(1, 1, 2080, 192):(399360, 399360, 192, 1):1560 KiB
// Computed true ops: 798720
// Computed work groups: 195
...
__kernel void kernel_c41_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i3_i4_lid = 0; i3_i4_lid < 8; i3_i4_lid += 1)
  {
    ...
    float LX_T8 = (0.10277830809354782f * LX_T7);
    float LX_T9 = (-0.05138915404677391f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
