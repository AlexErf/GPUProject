...
// lid: 256 1 1
// Original:
// X_T1369[n, x0, x1, g, gco : _T2150, _T2151, _T2152, _T2153, _T2154] = +(X_T1368[n, -1 + k0 + x0, -1 + k1 + x1, g + gci] * X_T1366[k0, k1, g, gco, gci])
// With Index Variables Made Integral:
// X_T1369[n, x0, x1, g, gco : _T2150, _T2151, _T2152, _T2153, _T2154] = +(X_T1368[n, -1 + k0 + x0, -1 + k1 + x1, g + gci] * X_T1366[k0, k1, g, gco, gci]), 500000000 + g < 1000000000, 500000000 + gci < 1000000000, 500000000 + gco < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
// Constraints:{ 0 <= n < 1, 0 <= gco < 1, 0 <= n < 1, 0 <= gco < 1, 0 <= gci < 1, 0 <= k0 < 3, 0 <= k1 < 3, 0 <= x0 < 14, 0 <= x1 < 14, 0 <= -1 + k0 + x0 < 14, 0 <= -1 + k1 + x1 < 14, 0 <= g < 88, 0 <= g + gci < 88, 0 <= g < 88, 0 <= 500000000 + g < 1000000000, 0 <= 500000000 + gci < 1000000000, 0 <= 500000000 + gco < 1000000000, 0 <= 500000000 + k0 < 1000000000, 0 <= 500000000 + k1 < 1000000000, 0 <= 500000000 + n < 1000000000, 0 <= 500000000 + x0 < 1000000000, 0 <= 500000000 + x1 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n < 1, 0 <= gco < 1, 0 <= gci < 1, 0 <= k0 < 3, 0 <= k1 < 3, 0 <= x0 < 14, 0 <= x1 < 14, 0 <= -1 + k0 + x0 < 14, 0 <= -1 + k1 + x1 < 14, 0 <= g < 88, 0 <= g + gci < 88 }
// Defracted:
// X_T1369[n, x0, x1, g, gco : _T2150, _T2151, _T2152, _T2153, _T2154] = +(X_T1368[n, -1 + k0 + x0, -1 + k1 + x1, g + gci] * X_T1366[k0, k1, g, gco, gci]), 500000000 + g < 1000000000, 500000000 + gci < 1000000000, 500000000 + gco < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
// Flattened:
//              Range   X_T1369   X_T1368   X_T1366  
//        g        88         1         1         1  
//       k0         3         0      1232       264  
//       k1         3         0        88        88  
//       x0        14      1232      1232         0  
...
// Computed shared mem: 9616
// Computed out regs: 4096
// Computed mem read: 9344
...
// lwork = 256, 1, 1
// gwork = 768, 7, 1
__kernel void kernel_c42_sdk_516(__global float* restrict  X_T1369, __global const float* restrict  in1, __global const float* restrict  in2)
{
  in1 = (in1 + -1320);
    ...
    {
      {
        ...
        for (int k0_x0_lid = 0; k0_x0_lid < 2; k0_x0_lid += 1)
        {
          ...
          {
            int lidx = ((g_tid + (33 * k0_x0)) + (529 * k1_x1_lid));
      ...
      {
        int gbase = ((g_gid + (k1_gid * 88)) + (k0_gid * 264));
        int g_tid = (tid % 32);
        ...
        for (int k1_k0_lid = 0; k1_k0_lid < 2; k1_k0_lid += 1)
        {
          ...
          if (k1_k0_cond)
          {
            ...
            in2_shared[lidx] = in2[clamp((int)gidx, (int)0, (int)791)];
          }
        }
      }
        ...
        for (int k0_lid = 0; k0_lid < 3; k0_lid += 1)
        {
          for (int k1_lid = 0; k1_lid < 3; k1_lid += 1)
          {
            ...
            for (int x0_lid = 0; x0_lid < 4; x0_lid += 1)
            {
              ...
              float val1 = in1_shared[((((g_tid + (529 * k1_lid)) + (529 * x1_tid)) + (33 * k0_lid)) + (33 * x0))];
