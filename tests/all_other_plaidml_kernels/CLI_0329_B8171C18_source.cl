...
// lid: 256 1 1
// Original:
// X_T796[n0, n1, n2, 512 + a : _T1088, _T1089, _T1090, _T1091] = =(X_T795[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T796[n0, n1, n2, 512 + a : _T1088, _T1089, _T1090, _T1091] = =(X_T795[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c108_sdk_259(__global float* restrict  X_T796, __global const float* restrict  in1)
{
  X_T796 = (X_T796 + 512);
