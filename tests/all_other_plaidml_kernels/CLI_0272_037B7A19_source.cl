...
// lid: 256 1 1
// Original:
// X_T2501[n0, n1, n2, 352 + a : _T3961, _T3962, _T3963, _T3964] = =(X_T2500[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2501[n0, n1, n2, 352 + a : _T3961, _T3962, _T3963, _T3964] = =(X_T2500[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 176, 0 <= 352 + a < 1056, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 768, 7, 1
__kernel void kernel_c42_sdk_957(__global float* restrict  X_T2501, __global const float* restrict  in1)
{
  X_T2501 = (X_T2501 + 352);
