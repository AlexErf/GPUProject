...
// lid: 256 1 1
// Original:
// X_T2041[n0, n1, n2, 1440 + a : _T2932, _T2933, _T2934, _T2935] = =(X_T2040[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2041[n0, n1, n2, 1440 + a : _T2932, _T2933, _T2934, _T2935] = =(X_T2040[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_706(__global float* restrict  X_T2041, __global const float* restrict  in1)
{
  X_T2041 = (X_T2041 + 1440);
  ...
  if (n2_cond)
  {
    float LX_T2041 = agg[0];
    int gout_idx = ((a_tid + (10304 * n1_gid)) + (1472 * n2_tid));
    X_T2041[gout_idx] = LX_T2041;
  }
}
