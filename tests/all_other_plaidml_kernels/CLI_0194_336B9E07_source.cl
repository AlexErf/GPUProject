...
// lid: 256 1 1
// Original:
// X_T1643[n0, n1, n2, 336 + a : _T2587, _T2588, _T2589, _T2590] = =(X_T1642[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1643[n0, n1, n2, 336 + a : _T2587, _T2588, _T2589, _T2590] = =(X_T1642[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= n1 < 21, 0 <= n2 < 21, 0 <= a < 336, 0 <= 336 + a < 1344, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 768, 11, 11
__kernel void kernel_c42_sdk_624(__global float* restrict  X_T1643, __global const float* restrict  in1)
{
  X_T1643 = (X_T1643 + 336);
