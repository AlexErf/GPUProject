...
// lid: 256 1 1
// Original:
// X_T264[n0, n1, n2, a : _T372, _T373, _T374, _T375] = =(X_T261[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T264[n0, n1, n2, a : _T372, _T373, _T374, _T375] = =(X_T261[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= a < 11, 0 <= a < 22, 0 <= n1 < 56, 0 <= n2 < 56, 0 <= n1 < 56, 0 <= n2 < 56, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1792, 28, 1
__kernel void kernel_c42_sdk_85(__global float* restrict  X_T264, __global const float* restrict  in1)
{
