...
// lid: 256 1 1
// Original:
// X_T522[n, x0, x1, co : _T669, _T670, _T671, _T672] = +(X_T521[n, k0 + x0, k1 + x1, ci] * X_I_188[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T522[n, x0, x1, co : _T669, _T670, _T671, _T672] = +(X_T521[n, k0 + x0, k1 + x1, ci] * X_I_188[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T523 = sub(X_T522, X_I_187)
// Elementwise op: [[pid(Mul)]] X_T524 = mul(X_T523, X_I_186)
...
// lwork = 256, 1, 1
// gwork = 1792, 2, 2
__kernel void kernel_c124_sdk_159(__global float* restrict  X_T524, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_187, __global const float* restrict  X_I_186)
{
