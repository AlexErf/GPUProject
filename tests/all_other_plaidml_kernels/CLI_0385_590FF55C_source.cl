...
// lid: 256 1 1
// Original:
// X_T931[n0, n1, n2, a : _T1278, _T1279, _T1280, _T1281] = =(X_T930[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T931[n0, n1, n2, a : _T1278, _T1279, _T1280, _T1281] = =(X_T930[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 11, 1
__kernel void kernel_c124_sdk_306(__global float* restrict  X_T931, __global const float* restrict  in1)
{
