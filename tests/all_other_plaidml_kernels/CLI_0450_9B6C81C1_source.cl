...
// lid: 256 1 1
// Original:
// X_T1583[x0, x3 : _T2281, _T2282] = +(X_T1582[x0, x1, x2, x3])
// With Index Variables Made Integral:
// X_T1583[x0, x3 : _T2281, _T2282] = +(X_T1582[x0, x1, x2, x3]), 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000, 500000000 + x2 < 1000000000, 500000000 + x3 < 1000000000
...
// Elementwise op: [[pid(Mean)]] X_T1585 = div(X_T1583, X_T1584)
// Tile size: { 7, 7, 32 }
...
// lwork = 256, 1, 1
// gwork = 8192, 1, 1
__kernel void kernel_c68_sdk_548(__global float* restrict  X_T1585, __global const float* restrict  in1)
{
  ...
  if ((tid < 32))
  {
    float LX_T1583 = agg[0];
    int gout_idx = (x3_gid + x3_tid);
    float LX_T1585 = (LX_T1583 / (float)49);
