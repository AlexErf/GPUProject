...
// lid: 256 1 1
// Original:
// X_T331[n0, n1, n2, 224 + a : _T428, _T429, _T430, _T431] = =(X_T330[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T331[n0, n1, n2, 224 + a : _T428, _T429, _T430, _T431] = =(X_T330[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c68_sdk_100(__global float* restrict  X_T331, __global const float* restrict  in1)
{
  X_T331 = (X_T331 + 224);
