...
// Ranges: { 294912 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(3, 3, 128, 256):(98304, 32768, 256, 1):1152 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 4096 }
// Contraction output var shape: fp32(3, 3, 128, 256):(98304, 32768, 256, 1):1152 KiB
// Computed true ops: 589824
// Computed work groups: 72
...
__kernel void kernel_c7_sdk_1(__global float* restrict  X_T9, __global const float* restrict  X_T7)
{
  ...
  for (int i1_i2_i3_i4_lid = 0; i1_i2_i3_i4_lid < 16; i1_i2_i3_i4_lid += 1)
  {
    ...
    float LX_T8 = (0.0833333358168602f * LX_T7);
    float LX_T9 = (-0.0416666679084301f + LX_T8);
    X_T9[gout_idx] = LX_T9;
  }
}
