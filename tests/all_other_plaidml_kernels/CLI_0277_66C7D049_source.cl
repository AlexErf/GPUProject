...
// lid: 256 1 1
// Original:
// X_T2542[n0, n1, n2, 880 + a : _T4043, _T4044, _T4045, _T4046] = =(X_T2541[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2542[n0, n1, n2, 880 + a : _T4043, _T4044, _T4045, _T4046] = =(X_T2541[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 176, 0 <= 880 + a < 1056, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 176 }
// Defracted:
// X_T2542[n0, n1, n2, 880 + a : _T4043, _T4044, _T4045, _T4046] = =(X_T2541[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T2542   X_T2541  
//        a       176         1         1  
//       n1         7      7392      1232  
//       n2         7      1056       176  
//      off                 880         0  
...
// lwork = 256, 1, 1
// gwork = 768, 7, 1
__kernel void kernel_c42_sdk_977(__global float* restrict  X_T2542, __global const float* restrict  in1)
{
  X_T2542 = (X_T2542 + 880);
  ...
  for (int a_lid = 0; a_lid < 2; a_lid += 1)
  {
    ...
    if (a_cond)
    {
      ...
      if (n1_cond)
      {
        float LX_T2542 = agg[a_lid];
        int gout_idx = (((a_gid + a) + (7392 * n1_tid)) + (1056 * n2_gid));
        X_T2542[gout_idx] = LX_T2542;
      }
    }
  }
}
