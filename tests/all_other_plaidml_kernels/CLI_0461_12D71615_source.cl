...
// lid: 256 1 1
// Original:
// X_T1254[n0, n1, n2, 1088 + a : _T1754, _T1755, _T1756, _T1757] = =(X_T1253[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1254[n0, n1, n2, 1088 + a : _T1754, _T1755, _T1756, _T1757] = =(X_T1253[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c124_sdk_421(__global float* restrict  X_T1254, __global const float* restrict  in1)
{
  X_T1254 = (X_T1254 + 1088);
