...
// lid: 256 1 1
// Original:
// X_T1874[n0, n1, n2, 960 + a : _T2673, _T2674, _T2675, _T2676] = =(X_T1873[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1874[n0, n1, n2, 960 + a : _T2673, _T2674, _T2675, _T2676] = =(X_T1873[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 960 + a < 992, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1874[n0, n1, n2, 960 + a : _T2673, _T2674, _T2675, _T2676] = =(X_T1873[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1874   X_T1873  
//        a        32         1         1  
//       n1         7      6944       224  
//       n2         7       992        32  
//      off                 960         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c124_sdk_643(__global float* restrict  X_T1874, __global const float* restrict  in1)
{
  X_T1874 = (X_T1874 + 960);
  ...
  if (n2_cond)
  {
    float LX_T1874 = agg[0];
    int gout_idx = ((a_tid + (6944 * n1_gid)) + (992 * n2_tid));
    X_T1874[gout_idx] = LX_T1874;
  }
}
