...
// lid: 256 1 1
// Original:
// X_T336[n0, n1, n2, a : _T396, _T397, _T398, _T399] = =(X_T335[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T336[n0, n1, n2, a : _T396, _T397, _T398, _T399] = =(X_T335[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 7, 1
__kernel void kernel_c124_sdk_93(__global float* restrict  X_T336, __global const float* restrict  in1)
{
  ...
  for (int n2_lid = 0; n2_lid < 7; n2_lid += 1)
  {
    ...
    {
      int n1 = ((2 * n1_lid) + n1_tid);
      float LX_T336 = agg[(n2_lid + (n1_lid * 7))];
