...
// Ranges: { 409600 }
// Out stride: { 1 }
// Elementwise input X_T7 shape: fp32(1, 1, 320, 1280):(409600, 409600, 1280, 1):1600 KiB
// Elementwise op: [[pid(RevMul)]] X_T8 = mul(X_T6, X_T7)
// Elementwise op: [[pid(Add)]] X_T9 = add(X_T5, X_T8)
// Tile size: { 4096 }
// Contraction output var shape: fp32(1, 1, 320, 1280):(409600, 409600, 1280, 1):1600 KiB
