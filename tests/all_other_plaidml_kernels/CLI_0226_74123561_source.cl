...
// lid: 256 1 1
// Original:
// X_T238[n0, n1, n2, 224 + a : _T248, _T249, _T250, _T251] = =(X_T237[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T238[n0, n1, n2, 224 + a : _T248, _T249, _T250, _T251] = =(X_T237[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 7168, 1, 1
__kernel void kernel_c124_sdk_58(__global float* restrict  X_T238, __global const float* restrict  in1)
{
  X_T238 = (X_T238 + 224);
  ...
  {
    int n1 = ((4 * n1_lid) + n1_tid);
    float LX_T238 = agg[n1_lid];
    int gout_idx = ((a_tid + (14336 * n1)) + (256 * (n2_gid + n2_tid)));
    X_T238[gout_idx] = LX_T238;
  }
}
