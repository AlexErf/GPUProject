...
// lid: 256 1 1
// Original:
// X_T1891[n0, n1, n2, 1248 + a : _T2710, _T2711, _T2712, _T2713] = =(X_T1890[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1891[n0, n1, n2, 1248 + a : _T2710, _T2711, _T2712, _T2713] = =(X_T1890[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1248 + a < 1280, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1891[n0, n1, n2, 1248 + a : _T2710, _T2711, _T2712, _T2713] = =(X_T1890[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1891   X_T1890  
//        a        32         1         1  
//       n1         7      8960       224  
//       n2         7      1280        32  
//      off                1248         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_652(__global float* restrict  X_T1891, __global const float* restrict  in1)
{
  X_T1891 = (X_T1891 + 1248);
  ...
  if (n2_cond)
  {
    float LX_T1891 = agg[0];
    int gout_idx = ((a_tid + (8960 * n1_gid)) + (1280 * n2_tid));
    X_T1891[gout_idx] = LX_T1891;
  }
}
