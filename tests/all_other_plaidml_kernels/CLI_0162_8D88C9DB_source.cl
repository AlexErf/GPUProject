...
// lid: 256 1 1
// Original:
// X_T57[n, d0, d1, c : _T2, _T3, _T4, _T5] = =(X_I_21[n, -3 + d0, -3 + d1, c])
// With Index Variables Made Integral:
// X_T57[n, d0, d1, c : _T2, _T3, _T4, _T5] = =(X_I_21[n, -3 + d0, -3 + d1, c]), 500000000 + c < 1000000000, 500000000 + d0 < 1000000000, 500000000 + d1 < 1000000000, 500000000 + n < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 21, 1
__kernel void kernel_c108_sdk_0(__global float* restrict  X_T57, __global const float* restrict  in1)
{
  X_T57 = (X_T57 + 2079);
