...
// lid: 256 1 1
// Original:
// X_T1416[n0, n1, n2, 640 + a : _T2007, _T2008, _T2009, _T2010] = =(X_T1415[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1416[n0, n1, n2, 640 + a : _T2007, _T2008, _T2009, _T2010] = =(X_T1415[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_481(__global float* restrict  X_T1416, __global const float* restrict  in1)
{
  X_T1416 = (X_T1416 + 640);
