...
// lid: 256 1 1
// Original:
// X_T942[n, x0, x1, co : _T1292, _T1293, _T1294, _T1295] = +(X_T941[n, k0 + x0, k1 + x1, ci] * X_I_349[k0, k1, ci, co])
// With Index Variables Made Integral:
// X_T942[n, x0, x1, co : _T1292, _T1293, _T1294, _T1295] = +(X_T941[n, k0 + x0, k1 + x1, ci] * X_I_349[k0, k1, ci, co]), 500000000 + ci < 1000000000, 500000000 + co < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// Elementwise op: [[pid(Sub)]] X_T943 = sub(X_T942, X_I_348)
// Elementwise op: [[pid(Mul)]] X_T944 = mul(X_T943, X_I_347)
...
// lwork = 256, 1, 1
// gwork = 1024, 4, 1
__kernel void kernel_c124_sdk_309(__global float* restrict  X_T944, __global const float* restrict  in1, __global const float* restrict  in2, __global const float* restrict  X_I_348, __global const float* restrict  X_I_347)
{
  ...
  if (x1_cond)
  {
    for (int x0_lid = 0; x0_lid < 7; x0_lid += 1)
    {
      ...
      float LX_T943 = (LX_T942 - LX_I_348);
      float LX_T944 = (LX_T943 * LX_I_347);
