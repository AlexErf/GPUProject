...
// lid: 256 1 1
// Original:
// X_T237[n0, n1, n2, 126 + a : _T318, _T319, _T320, _T321] = =(X_T236[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T237[n0, n1, n2, 126 + a : _T318, _T319, _T320, _T321] = =(X_T236[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= a < 42, 0 <= n1 < 83, 0 <= n2 < 83, 0 <= n1 < 83, 0 <= n2 < 83, 0 <= 126 + a < 168, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 5376, 83, 1
__kernel void kernel_c42_sdk_72(__global float* restrict  X_T237, __global const float* restrict  in1)
{
  X_T237 = (X_T237 + 126);
