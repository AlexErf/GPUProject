...
// lid: 256 1 1
// Original:
// X_T1246[n0, n1, n2, 576 + a : _T1785, _T1786, _T1787, _T1788] = =(X_T1245[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1246[n0, n1, n2, 576 + a : _T1785, _T1786, _T1787, _T1788] = =(X_T1245[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 576 + a < 608, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_427(__global float* restrict  X_T1246, __global const float* restrict  in1)
{
  X_T1246 = (X_T1246 + 576);
  ...
  if (n2_cond)
  {
    ...
    int gout_idx = ((a_tid + (4256 * n1_gid)) + (608 * n2_tid));
