...
// Ranges: { 80 }
// Out stride: { 1 }
// Elementwise input X_I_57 shape: fp32(80):(1):320 bytes
// Elementwise op: [[pid(Add)]] X_T65 = add(X_T33, X_I_57)
...
// lwork = 128, 1, 1
// gwork = 128, 1, 1
__kernel void kernel_c56_sdk_11(__global float* restrict  X_T68, __global const float* restrict  X_I_57)
{
  ...
  if (i1_cond)
  {
    float LX_I_57 = X_I_57[i1_tid];
    float LX_T65 = (0.0010000000474974513f + LX_I_57);
