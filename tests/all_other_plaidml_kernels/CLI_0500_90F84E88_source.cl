...
// lid: 256 1 1
// Original:
// X_T1516[n0, n1, n2, 768 + a : _T2155, _T2156, _T2157, _T2158] = =(X_T1515[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1516[n0, n1, n2, 768 + a : _T2155, _T2156, _T2157, _T2158] = =(X_T1515[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_517(__global float* restrict  X_T1516, __global const float* restrict  in1)
{
  X_T1516 = (X_T1516 + 768);
