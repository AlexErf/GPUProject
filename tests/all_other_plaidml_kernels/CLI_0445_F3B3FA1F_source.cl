...
// lid: 256 1 1
// Original:
// X_T1181[n0, n1, n2, a : _T1648, _T1649, _T1650, _T1651] = =(X_T1180[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1181[n0, n1, n2, a : _T1648, _T1649, _T1650, _T1651] = =(X_T1180[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 4, 1
__kernel void kernel_c124_sdk_396(__global float* restrict  X_T1181, __global const float* restrict  in1)
{
  ...
  for (int n1_lid = 0; n1_lid < 2; n1_lid += 1)
  {
    ...
    if (n1_cond)
    {
      ...
      {
        int a = ((32 * a_lid) + a_tid);
        float LX_T1181 = agg[(a_lid + (n1_lid * 8))];
        int gout_idx = (((a_gid + a) + (14784 * n1)) + (1056 * n2_gid));
        X_T1181[gout_idx] = LX_T1181;
      }
    }
  }
}
