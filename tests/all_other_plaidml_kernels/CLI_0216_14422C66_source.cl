...
// lid: 256 1 1
// Original:
// X_T190[n0, n1, n2, a : _T179, _T180, _T181, _T182] = =(X_T189[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T190[n0, n1, n2, a : _T179, _T180, _T181, _T182] = =(X_T189[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 3584, 14, 1
__kernel void kernel_c124_sdk_42(__global float* restrict  X_T190, __global const float* restrict  in1)
{
  ...
  for (int a_lid = 0; a_lid < 6; a_lid += 1)
  {
    ...
    {
      int n1 = ((2 * n1_lid) + n1_tid);
      float LX_T190 = agg[(a_lid + (n1_lid * 6))];
      int gout_idx = ((a + (12544 * (n1_gid + n1))) + (224 * (n2_gid + n2_tid)));
      X_T190[gout_idx] = LX_T190;
    }
  }
}
