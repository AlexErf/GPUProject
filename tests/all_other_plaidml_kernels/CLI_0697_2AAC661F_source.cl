...
// lid: 256 1 1
// Original:
// X_T2301[n0, n1, n2, a : _T3307, _T3308, _T3309, _T3310] = =(X_T2300[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T2301[n0, n1, n2, a : _T3307, _T3308, _T3309, _T3310] = =(X_T2300[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 12, 1
__kernel void kernel_c124_sdk_798(__global float* restrict  X_T2301, __global const float* restrict  in1)
{
  ...
  if (n2_cond)
  {
    ...
    {
      int a = ((32 * a_lid) + a_tid);
      float LX_T2301 = agg[a_lid];
      int gout_idx = (((a_gid + a) + (10976 * n1_gid)) + (1568 * n2_tid));
      X_T2301[gout_idx] = LX_T2301;
    }
  }
}
