...
// lid: 256 1 1
// Original:
// X_T1196[n0, n1, n2, 512 + a : _T1711, _T1712, _T1713, _T1714] = =(X_T1195[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1196[n0, n1, n2, 512 + a : _T1711, _T1712, _T1713, _T1714] = =(X_T1195[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 512 + a < 544, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c68_sdk_409(__global float* restrict  X_T1196, __global const float* restrict  in1)
{
  X_T1196 = (X_T1196 + 512);
  ...
  if (n2_cond)
  {
    ...
    int gout_idx = ((a_tid + (3808 * n1_gid)) + (544 * n2_tid));
