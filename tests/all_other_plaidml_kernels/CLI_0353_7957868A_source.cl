...
// lid: 256 1 1
// Original:
// X_T896[n0, n1, n2, 640 + a : _T1236, _T1237, _T1238, _T1239] = =(X_T895[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T896[n0, n1, n2, 640 + a : _T1236, _T1237, _T1238, _T1239] = =(X_T895[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 4, 1
__kernel void kernel_c108_sdk_295(__global float* restrict  X_T896, __global const float* restrict  in1)
{
  X_T896 = (X_T896 + 640);
