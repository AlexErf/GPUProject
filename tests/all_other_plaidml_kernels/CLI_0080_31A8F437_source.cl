...
// lid: 256 1 1
// Original:
// X_T99[n, x0, x1, c : _T97, _T98, _T99, _T100] = +(X_T59[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3
// With Index Variables Made Integral:
// X_T99[n, x0, x1, c : _T97, _T98, _T99, _T100] = +(X_T59[n, k0 + 2*x0, k1 + 2*x1, c]), k0 < 3, k1 < 3, 500000000 + c < 1000000000, 500000000 + k0 < 1000000000, 500000000 + k1 < 1000000000, 500000000 + n < 1000000000, 500000000 + x0 < 1000000000, 500000000 + x1 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 5376, 21, 1
__kernel void kernel_c42_sdk_20(__global float* restrict  X_T99, __global const float* restrict  in1)
{
      ...
      if (x0_cond)
      {
        ...
        for (int c_lid = 0; c_lid < 2; c_lid += 1)
        {
          ...
          if (c_cond)
          {
            ...
            float LX_T99 = agg[(c_lid + (x0_lid * 2))];
