...
// lid: 256 1 1
// Original:
// X_T1716[n0, n1, n2, 1024 + a : _T2451, _T2452, _T2453, _T2454] = =(X_T1715[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1716[n0, n1, n2, 1024 + a : _T2451, _T2452, _T2453, _T2454] = =(X_T1715[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_589(__global float* restrict  X_T1716, __global const float* restrict  in1)
{
  X_T1716 = (X_T1716 + 1024);
