...
// lid: 256 1 1
// Original:
// X_T1791[n0, n1, n2, 1120 + a : _T2562, _T2563, _T2564, _T2565] = =(X_T1790[n0, n1, n2, a])
// With Index Variables Made Integral:
// X_T1791[n0, n1, n2, 1120 + a : _T2562, _T2563, _T2564, _T2565] = =(X_T1790[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Constraints:{ 0 <= n0 < 1, 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32, 0 <= 1120 + a < 1152, 0 <= 500000000 + a < 1000000000, 0 <= 500000000 + n0 < 1000000000, 0 <= 500000000 + n1 < 1000000000, 0 <= 500000000 + n2 < 1000000000 }
// Merged Parallel Constraints:{ 0 <= n0 < 1, 0 <= n1 < 7, 0 <= n2 < 7, 0 <= a < 32 }
// Defracted:
// X_T1791[n0, n1, n2, 1120 + a : _T2562, _T2563, _T2564, _T2565] = =(X_T1790[n0, n1, n2, a]), 500000000 + a < 1000000000, 500000000 + n0 < 1000000000, 500000000 + n1 < 1000000000, 500000000 + n2 < 1000000000
// Flattened:
//              Range   X_T1791   X_T1790  
//        a        32         1         1  
//       n1         7      8064       224  
//       n2         7      1152        32  
//      off                1120         0  
...
// lwork = 256, 1, 1
// gwork = 1792, 1, 1
__kernel void kernel_c108_sdk_616(__global float* restrict  X_T1791, __global const float* restrict  in1)
{
  X_T1791 = (X_T1791 + 1120);
  ...
  if (n2_cond)
  {
    float LX_T1791 = agg[0];
    int gout_idx = ((a_tid + (8064 * n1_gid)) + (1152 * n2_tid));
